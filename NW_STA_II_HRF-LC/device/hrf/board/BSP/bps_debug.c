...
static u32 debug_mask = DEBUG_LOG_INFO|DEBUG_LOG_ERR|DEBUG_LOG_NET|DEBUG_LOG_APS|DEBUG_LOG_MAC|DEBUG_LOG_APP|DEBUG_LOG_UPDATA|DEBUG_LOG_ZONE|DEBUG_LOG_METER;//|DEBUG_LOG_ROUT;

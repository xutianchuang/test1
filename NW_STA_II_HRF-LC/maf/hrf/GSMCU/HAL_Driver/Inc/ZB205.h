...
/* ===========================================  ZB205 Specific Interrupt Numbers  ============================================ */
  ...
  HRF_DFE_IRQn              =  45,              /*!< 43 LVD interrupt                                                          */
} IRQn_Type;
...
#include "system_ZB205.h"                       /*!< ZB205 System                                                              */
...
/* ================                                            dfe ext regs                                   ================ */
/* =========================================================================================================================== */
typedef struct { /* dfe_regs */
  union {
    __IOM uint32_t DFE_CR0_ALL ;                 /*0x0 DFE Controll Register0 */
    struct {
      __IOM uint32_t tx_cfoc_mode_cali : 2;           /*[1:0] cfoc mode in calibration mode */
      __IOM uint32_t tx_cfoc_mode_tx : 2;           /*[3:2] cfoc mode in tx mode */
      __IOM uint32_t tx_cfoc_mode_rx : 2;           /*[5:4] cfoc mode in rx mode */
      __IOM uint32_t tx_cfoc_enable_cali : 1;           /*[6] cfoc enable in calibration mode */
      __IOM uint32_t tx_cfoc_enable_tx : 1;           /*[7] cfoc enable in tx mode */
      __IOM uint32_t tx_cfoc_enable_rx : 1;           /*[8] cfoc enable in rx mode */
      __IOM uint32_t dfe_tx_enable_cali : 1;           /*[9] dfe tx enable in calibration mode */
      __IOM uint32_t dfe_tx_enable_tx : 1;           /*[10] dfe tx enable in tx mode */
      __IOM uint32_t dfe_tx_enable_rx : 1;           /*[11] dfe tx enable in rx mode */
      __IOM uint32_t dfe_rx_enable_cali : 1;           /*[12] dfe rx enable in calibration mode */
      __IOM uint32_t dfe_rx_enable_tx : 1;           /*[13] dfe rx enable in tx mode */
      __IOM uint32_t dfe_rx_enable_rx : 1;           /*[14] dfe rx enable in rx mode */
      __IOM uint32_t agc_enable_cali : 1;           /*[15] agc enable in calibration mode */
      __IOM uint32_t agc_enable_tx : 1;           /*[16] agc enable in tx mode */
      __IOM uint32_t agc_enable_rx : 1;           /*[17] agc enable in rx mode */
      __IOM uint32_t              : 1;           /*[18] Reserved */
      __IOM uint32_t dfe_tx_iq_swap : 1;           /*[19] iq swap in tx mode */
      __IOM uint32_t dac_msb_opt : 1;           /*[20] invert dac msb option */
      __IOM uint32_t inv_dac_clk : 1;           /*[21] invert dac clk */
      __IOM uint32_t rx_diq_swap : 1;           /*[22] diq swap in rx mode */
      __IOM uint32_t dfe_rx_iq_swap : 1;           /*[23] iq swap in rx mode */
      __IOM uint32_t adc_msb_opt : 1;           /*[24] invert adc msb option */
      __IOM uint32_t inv_adc_clk : 1;           /*[25] invert adc clk */
      __IOM uint32_t rssi_msb_opt : 1;           /*[26] invert rssi adc msb option */
      __IOM uint32_t inv_rssi_clk : 1;           /*[27] invert rssi adc clk */
      __IOM uint32_t calibration_mode : 1;           /*[28] calibration mode enable */
      __IOM uint32_t dfe_soft_rst : 1;           /*[29] soft reset */
      __IOM uint32_t dac_clk_en : 1;           /*[30] dac clk enable */
      __IOM uint32_t adc_clk_en : 1;           /*[31] adc clk enable */
    } DFE_CR0_b;
  } ;
  union {
    __IOM uint32_t AGC_CFG0_ALL ;                 /*0x4 AGC configuration register0 */
    struct {
      __IOM uint32_t agc_gain_default : 6;           /*[5:0] default gain when agc is disabled */
      __IOM uint32_t rssi_rate : 3;           /*[8:6] integration length of rssi */
      __IOM uint32_t agc_rate : 3;           /*[11:9] integration length of agc */
      __IOM uint32_t agc_target : 2;           /*[13:12] agc target selection */
      __IOM uint32_t agc_tbost_6db : 2;           /*[15:14] agc tbost configuration */
      __IOM uint32_t agc_inc1 : 4;           /*[19:16] agc inc1 */
      __IOM uint32_t agc_inc2 : 4;           /*[23:20] agc inc2 */
      __IOM uint32_t agc_inc3 : 4;           /*[27:24] agc inc3 */
      __IOM uint32_t agc_inc4 : 4;           /*[31:28] agc inc4 */
    } AGC_CFG0_b;
  } ;
  union {
    __IOM uint32_t AGC_CFG1_ALL ;                 /*0x8 AGC configuration register1 */
    struct {
      __IOM uint32_t agc_fe_pd_thr0 : 8;           /*[7:0] rf front-end power detection threshold when pd flag is low */
      __IOM uint32_t agc_fe_pd_thr1 : 8;           /*[15:8] rf front-end power detection threshold when pd flag is high */
      __IOM uint32_t agc_pd_rate : 4;           /*[19:16] power detection flag integration length */
      __IOM uint32_t agc_fe_pd_enable : 1;           /*[20] rf front-end power detection enable */
      __IOM uint32_t              : 4;           /*[24:21] Reserved */
      __IOM uint32_t agc_max_levels : 6;           /*[30:25] agc max levels */
      __IOM uint32_t agc_rst_rms_opt : 1;           /*[31] agc rst rms option */
    } AGC_CFG1_b;
  } ;
  union {
    __IOM uint32_t AGC_CFG2_ALL ;                 /*0xC AGC configuration register2 */
    struct {
      __IOM uint32_t mask_thr : 6;           /*[5:0] agc mask thr */
      __IOM uint32_t              : 26;           /*[31:6] Reserved */
    } AGC_CFG2_b;
  } ;
  union {
    __IOM uint32_t AGC_STATUS_ALL ;                 /*0x10 agc status register */
    struct {
      __IOM uint32_t agc_locked_gain_idx : 6;           /*[5:0] agc locked gain index */
      __IOM uint32_t agc_cur_gain_idx : 6;           /*[11:6] agc current gain index */
      __IOM uint32_t cur_rms : 12;           /*[23:12] current rms */
      __IOM uint32_t cur_rssi : 8;           /*[31:24] current rssi */
    } AGC_STATUS_b;
  } ;
  union {
    __IOM uint32_t RX_CIC_CFG0_ALL ;                 /*0x14 rx cic module configuration register0 */
    struct {
      __IOM uint32_t cic_osr : 8;           /*[7:0] CIC over sample rate */
      __IOM uint32_t rx_diq_offset : 7;           /*[14:8] rx diq sample offset */
      __IOM uint32_t rx_cic_bps : 1;           /*[15] rx cic bypass */
      __IOM uint32_t rx_cic_rshft : 4;           /*[19:16] rx cic right shift bits */
      __IOM uint32_t rx_cic_enable : 1;           /*[20] rx cic enable */
      __IOM uint32_t              : 11;           /*[31:21] Reserved */
    } RX_CIC_CFG0_b;
  } ;
  union {
    __IOM uint32_t RX_MF_CFG0_ALL ;                 /*0x18 rx middle frequency remove configuration register0 */
    struct {
      __IOM uint32_t rx_dcr_const_q : 12;           /*[11:0] rx q path adc dc constance value */
      __IOM uint32_t rx_dcr_const_i : 12;           /*[23:12] rx i path adc dc constance value */
      __IOM uint32_t rx_dcr_const : 1;           /*[24] rx adc use constance value */
      __IOM uint32_t rx_dcr_en : 1;           /*[25] rx adc dc remove enable */
      __IOM uint32_t rx_dcr_alph : 4;           /*[29:26] rx dc remover alpha data */
      __IOM uint32_t              : 2;           /*[31:30] Reserved */
    } RX_MF_CFG0_b;
  } ;
  union {
    __IOM uint32_t RX_MF_CFG1_ALL ;                 /*0x1C rx middle frequency remove configuration register1 */
    struct {
      __IOM uint32_t rx_demod_fcw : 30;           /*[29:0] rx middle frequency. Fcw = (mf/25)*2^30 */
      __IOM uint32_t rx_demod_cj : 1;           /*[30] conj option of rx middle frequency remove */
      __IOM uint32_t rx_demod_en : 1;           /*[31] rx middle frequency remover enable */
    } RX_MF_CFG1_b;
  } ;
  union {
    __IOM uint32_t RX_TONE_RM_CFG0_ALL ;                 /*0x20 rx tone remover configuration register0 */
    struct {
      __IOM uint32_t tone_rm_enable : 4;           /*[3:0] tone remover enable */
      __IOM uint32_t              : 12;           /*[15:4] Reserved */
      __IOM uint32_t tone_rm_lshft : 4;           /*[19:16] din left shift option of tone remover */
      __IOM uint32_t              : 12;           /*[31:20] Reserved */
    } RX_TONE_RM_CFG0_b;
  } ;
  union {
    __IOM uint32_t RX_TONE_RM_CFG1_ALL ;                 /*0x24 rx tone remover configuration register1 */
    struct {
      __IOM uint32_t tone_rm0_a1 : 16;           /*[15:0] a1 value of tone remover0 */
      __IOM uint32_t tone_rm1_a1 : 16;           /*[31:16] a1 value of tone remover1 */
    } RX_TONE_RM_CFG1_b;
  } ;
  union {
    __IOM uint32_t RX_TONE_RM_CFG2_ALL ;                 /*0x28 rx tone remover configuration register2 */
    struct {
      __IOM uint32_t tone_rm2_a1 : 16;           /*[15:0] a1 value of tone remover2 */
      __IOM uint32_t tone_rm3_a1 : 16;           /*[31:16] a1 value of tone remover3 */
    } RX_TONE_RM_CFG2_b;
  } ;
  union {
    __IOM uint32_t RX_TONE_RM_CFG3_ALL ;                 /*0x2C rx tone remover configuration register3 */
    struct {
      __IOM uint32_t tone_rm0_b1 : 16;           /*[15:0] b1 value of tone remover0 */
      __IOM uint32_t tone_rm1_b1 : 16;           /*[31:16] b1 value of tone remover1 */
    } RX_TONE_RM_CFG3_b;
  } ;
  union {
    __IOM uint32_t RX_TONE_RM_CFG4_ALL ;                 /*0x30 rx tone remover configuration register4 */
    struct {
      __IOM uint32_t tone_rm2_b1 : 16;           /*[15:0] b1 value of tone remover2 */
      __IOM uint32_t tone_rm3_b1 : 16;           /*[31:16] b1 value of tone remover3 */
    } RX_TONE_RM_CFG4_b;
  } ;
  union {
    __IOM uint32_t RX_TONE_RM_CFG5_ALL ;                 /*0x34 rx tone remover configuration register5 */
    struct {
      __IOM uint32_t tone_rm0_b2 : 16;           /*[15:0] b2 value of tone remover0 */
      __IOM uint32_t tone_rm1_b2 : 16;           /*[31:16] b2 value of tone remover1 */
    } RX_TONE_RM_CFG5_b;
  } ;
  union {
    __IOM uint32_t RX_TONE_RM_CFG6_ALL ;                 /*0x38 rx tone remover configuration register6 */
    struct {
      __IOM uint32_t tone_rm2_b2 : 16;           /*[15:0] b2 value of tone remover2 */
      __IOM uint32_t tone_rm3_b2 : 16;           /*[31:16] b2 value of tone remover3 */
    } RX_TONE_RM_CFG6_b;
  } ;
  union {
    __IOM uint32_t RX_ADC_DC_ALL ;                 /*0x3C rx adc dc value */
    struct {
      __IOM uint32_t adc_dc_q : 12;           /*[11:0] adc dc value of q path */
      __IOM uint32_t adc_dc_i : 12;           /*[23:12] adc dc value of i path */
      __IOM uint32_t              : 8;           /*[31:24] Reserved */
    } RX_ADC_DC_b;
  } ;
  union {
    __IOM uint32_t TX_CFOC_CFG0_ALL ;                 /*0x40 tx cfoc configuration register0 */
    struct {
      __IOM uint32_t tx_cfoc_fcw0 : 30;           /*[29:0] tx cfoc tone0 fcw */
      __IOM uint32_t              : 2;           /*[31:30] Reserved */
    } TX_CFOC_CFG0_b;
  } ;
  union {
    __IOM uint32_t TX_CFOC_CFG1_ALL ;                 /*0x44 tx cfoc configuration register1 */
    struct {
      __IOM uint32_t tx_cfoc_fcw1 : 30;           /*[29:0] tx cfoc tone1 fcw */
      __IOM uint32_t              : 2;           /*[31:30] Reserved */
    } TX_CFOC_CFG1_b;
  } ;
  union {
    __IOM uint32_t TX_CFOC_CFG2_ALL ;                 /*0x48 tx cfoc configuration register2 */
    struct {
      __IOM uint32_t tx_cfoc_const_q : 12;           /*[11:0] tx cfoc const value of q path */
      __IOM uint32_t tx_cfoc_const_i : 12;           /*[23:12] tx cfoc const value of i path */
      __IOM uint32_t              : 8;           /*[31:24] Reserved */
    } TX_CFOC_CFG2_b;
  } ;
  union {
    __IOM uint32_t TX_CFOC_CFG3_ALL ;                 /*0x4C tx cfoc configuration register3 */
    struct {
      __IOM uint32_t tx_cfoc_tone0_amp : 11;           /*[10:0] tx cfoc tone0 ampitude */
      __IOM uint32_t tx_cfoc_tone1_amp : 11;           /*[21:11] tx cfoc tone1 ampitude */
      __IOM uint32_t              : 10;           /*[31:22] Reserved */
    } TX_CFOC_CFG3_b;
  } ;
  union {
    __IOM uint32_t TX_QEC_CFG0_ALL ;                 /*0x50 tx qec configuration register0 */
    struct {
      __IOM uint32_t tx_qec_gain : 11;           /*[10:0] tx qec gain */
      __IOM uint32_t tx_qec_conj : 1;           /*[11] tx qec conj */
      __IOM uint32_t tx_qec_lshft : 2;           /*[13:12] tx qec lshft */
      __IOM uint32_t tx_qec_enable : 1;           /*[14] tx qec enable */
      __IOM uint32_t              : 17;           /*[31:15] Reserved */
    } TX_QEC_CFG0_b;
  } ;
  union {
    __IOM uint32_t TX_QEC_CFG1_ALL ;                 /*0x54 tx qec configuration register1 */
    struct {
      __IOM uint32_t tx_qec_g_mis : 11;           /*[10:0] tx qec gain mismatch */
      __IOM uint32_t tx_qec_ph_mis : 11;           /*[21:11] tx qec phase mismatch */
      __IOM uint32_t              : 10;           /*[31:22] Reserved */
    } TX_QEC_CFG1_b;
  } ;
  union {
    __IOM uint32_t TX_QEC_CFG2_ALL ;                 /*0x58 tx qec configuration register2 */
    struct {
      __IOM uint32_t tx_qec_dc_q : 12;           /*[11:0] tx qec dc q */
      __IOM uint32_t tx_qec_dc_i : 12;           /*[23:12] tx qec dc i */
      __IOM uint32_t              : 8;           /*[31:24] Reserved */
    } TX_QEC_CFG2_b;
  } ;
  union {
    __IOM uint32_t TX_CIC_CFG0_ALL ;                 /*0x5C tx cic configuration register0 */
    struct {
      __IOM uint32_t tx_cic_rshft : 4;           /*[3:0] tx cic rshft */
      __IOM uint32_t tx_cic_bps : 1;           /*[4] tx cic bypass */
      __IOM uint32_t tx_cic_enable : 1;           /*[5] tx cic enable */
      __IOM uint32_t              : 26;           /*[31:6] Reserved */
    } TX_CIC_CFG0_b;
  } ;
  union {
    __IOM uint32_t CH_MON_CFG0_ALL ;                 /*0x60 channel monitor_configuration_register0 */
    struct {
      __IOM uint32_t ch_mon_fcw0 : 30;           /*[29:0] channel monitor frequency0 configure */
      __IOM uint32_t ch_mon_iq_swap : 1;           /*[30] channel monitor iq swap */
      __IOM uint32_t ch_mon_enable : 1;           /*[31] channel monitor enable */
    } CH_MON_CFG0_b;
  } ;
  union {
    __IOM uint32_t CH_MON_CFG1_ALL ;                 /*0x64 channel monitor_configuration_register1 */
    struct {
      __IOM uint32_t ch_mon_fcw1 : 30;           /*[29:0] channel monitor frequency1 configure */
      __IOM uint32_t              : 2;           /*[31:30] Reserved */
    } CH_MON_CFG1_b;
  } ;
  union {
    __IOM uint32_t CH_MON_CFG2_ALL ;                 /*0x68 channel monitor_configuration_register2 */
    struct {
      __IOM uint32_t ch_mon_fcw2 : 30;           /*[29:0] channel monitor frequency2 configure */
      __IOM uint32_t              : 2;           /*[31:30] Reserved */
    } CH_MON_CFG2_b;
  } ;
  union {
    __IOM uint32_t CH_MON_CFG3_ALL ;                 /*0x6C channel monitor_configuration_register3 */
    struct {
      __IOM uint32_t ch_mon_cic_osr : 8;           /*[7:0] cic over sample rate of channel monitor */
      __IOM uint32_t ch_mon_cic_rshft : 4;           /*[11:8] right shift bits of cic out of channel monitor */
      __IOM uint32_t              : 4;           /*[15:12] Reserved */
      __IOM uint32_t ch_mon_cic_smp_rate : 5;           /*[20:16] channel monitor sample rate configure of cic out */
      __IOM uint32_t              : 3;           /*[23:21] Reserved */
      __IOM uint32_t ch0to1_rise_flag : 1;           /*[24] rise flag is set when channel0 power increase to channel1 power * ch0to1_rise_thr/256 */
      __IOM uint32_t ch0to1_fall_flag : 1;           /*[25] fall flag is set when channel0 power decrease to channel1 power * ch0to1_fall_thr/256 */
      __IOM uint32_t ch2to1_rise_flag : 1;           /*[26] rise flag is set when channel2 power increase to channel1 power * ch2to1_rise_thr/256 */
      __IOM uint32_t ch2to1_fall_flag : 1;           /*[27] fall flag is set when channel2 power decrease to channel1 power * ch2to1_fall_thr/256 */
      __IOM uint32_t ch0to1_rise_int_en : 1;           /*[28] interrupt is asserted when ch0to1_rise_flag is set */
      __IOM uint32_t ch0to1_fall_int_en : 1;           /*[29] interrupt is asserted when ch0to1_fall_flag is set */
      __IOM uint32_t ch2to1_rise_int_en : 1;           /*[30] interrupt is asserted when ch2to1_rise_flag is set */
      __IOM uint32_t ch2to1_fall_int_en : 1;           /*[31] interrupt is asserted when ch2to1_fall_flag is set */
    } CH_MON_CFG3_b;
  } ;
  union {
    __IOM uint32_t CH_MON_CFG4_ALL ;                 /*0x70 channel monitor_configuration_register4 */
    struct {
      __IOM uint32_t ch0to1_rise_thr : 16;           /*[15:0] Threshold to set rise flag when channel0 pwr increase */
      __IOM uint32_t ch0to1_fall_thr : 16;           /*[31:16] Threshold to set fall flag when channel0 pwr decrease */
    } CH_MON_CFG4_b;
  } ;
  union {
    __IOM uint32_t CH_MON_CFG5_ALL ;                 /*0x74 channel monitor_configuration_register5 */
    struct {
      __IOM uint32_t ch2to1_rise_thr : 16;           /*[15:0] Threshold to set rise flag when channel2 pwr increase */
      __IOM uint32_t ch2to1_fall_thr : 16;           /*[31:16] Threshold to set fall flag when channel2 pwr decrease */
    } CH_MON_CFG5_b;
  } ;
  union {
    __IOM uint32_t CH_MON_CFG6_ALL ;                 /*0x78 channel monitor_configuration_register6 */
    struct {
      __IOM uint32_t ch_mon2_fcw3 : 30;           /*[29:0] channel monitor frequency3 configure */
      __IOM uint32_t ch_mon2_iq_swap : 1;           /*[30] channel monitor iq swap */
      __IOM uint32_t ch_mon2_enable : 1;           /*[31] channel monitor enable */
    } CH_MON_CFG6_b;
  } ;
  union {
    __IOM uint32_t CH_MON_CFG7_ALL ;                 /*0x7C channel monitor_configuration_register7 */
    struct {
      __IOM uint32_t ch_mon2_fcw4 : 30;           /*[29:0] channel monitor frequency4 configure */
      __IOM uint32_t              : 2;           /*[31:30] Reserved */
    } CH_MON_CFG7_b;
  } ;
  union {
    __IOM uint32_t CH_MON_CFG8_ALL ;                 /*0x80 channel monitor_configuration_register8 */
    struct {
      __IOM uint32_t ch_mon2_fcw5 : 30;           /*[29:0] channel monitor frequency5 configure */
      __IOM uint32_t              : 2;           /*[31:30] Reserved */
    } CH_MON_CFG8_b;
  } ;
  union {
    __IOM uint32_t CH_MON_CFG9_ALL ;                 /*0x84 channel monitor_configuration_register9 */
    struct {
      __IOM uint32_t ch_mon2_cic_osr : 8;           /*[7:0] cic over sample rate of channel monitor */
      __IOM uint32_t ch_mon2_cic_rshft : 4;           /*[11:8] right shift bits of cic out of channel monitor */
      __IOM uint32_t              : 4;           /*[15:12] Reserved */
      __IOM uint32_t ch_mon2_cic_smp_rate : 5;           /*[20:16] channel monitor sample rate configure of cic out */
      __IOM uint32_t              : 3;           /*[23:21] Reserved */
      __IOM uint32_t ch3to4_rise_flag : 1;           /*[24] rise flag is set when channel3 power increase to channel4 power * ch3to4_rise_thr/256 */
      __IOM uint32_t ch3to4_fall_flag : 1;           /*[25] fall flag is set when channel3 power decrease to channel4 power * ch3to4_fall_thr/256 */
      __IOM uint32_t ch5to4_rise_flag : 1;           /*[26] rise flag is set when channel5 power increase to channel4 power * ch5to4_rise_thr/256 */
      __IOM uint32_t ch5to4_fall_flag : 1;           /*[27] fall flag is set when channel5 power decrease to channel4 power * ch5to4_fall_thr/256 */
      __IOM uint32_t ch3to4_rise_int_en : 1;           /*[28] interrupt is asserted when ch3to4_rise_flag is set */
      __IOM uint32_t ch3to4_fall_int_en : 1;           /*[29] interrupt is asserted when ch3to4_fall_flag is set */
      __IOM uint32_t ch5to4_rise_int_en : 1;           /*[30] interrupt is asserted when ch5to4_rise_flag is set */
      __IOM uint32_t ch5to4_fall_int_en : 1;           /*[31] interrupt is asserted when ch5to4_fall_flag is set */
    } CH_MON_CFG9_b;
  } ;
  union {
    __IOM uint32_t CH_MON_CFG10_ALL ;                 /*0x88 channel monitor_configuration_register10 */
    struct {
      __IOM uint32_t ch3to4_rise_thr : 16;           /*[15:0] Threshold to set rise flag when channel3 pwr increase */
      __IOM uint32_t ch3to4_fall_thr : 16;           /*[31:16] Threshold to set fall flag when channel3 pwr decrease */
    } CH_MON_CFG10_b;
  } ;
  union {
    __IOM uint32_t CH_MON_CFG11_ALL ;                 /*0x8C channel monitor_configuration_register11 */
    struct {
      __IOM uint32_t ch5to4_rise_thr : 16;           /*[15:0] Threshold to set rise flag when channel5 pwr increase */
      __IOM uint32_t ch5to4_fall_thr : 16;           /*[31:16] Threshold to set fall flag when channel5 pwr decrease */
    } CH_MON_CFG11_b;
  } ;
  union {
    __IOM uint32_t CH_MON_F0_IQ_ALL ;                 /*0x90 channel monitor_freq0_iq_value_register */
    struct {
      __IOM uint32_t ch_mon_f0_cic_out_i : 16;           /*[15:0] I path of channel0 cic out */
      __IOM uint32_t ch_mon_f0_cic_out_q : 16;           /*[31:16] Q path of channel0 cic out */
    } CH_MON_F0_IQ_b;
  } ;
  union {
    __IOM uint32_t CH_MON_F1_IQ_ALL ;                 /*0x94 channel monitor_freq1_iq_value_register */
    struct {
      __IOM uint32_t ch_mon_f1_cic_out_i : 16;           /*[15:0] I path of channel1 cic out */
      __IOM uint32_t ch_mon_f1_cic_out_q : 16;           /*[31:16] Q path of channel1 cic out */
    } CH_MON_F1_IQ_b;
  } ;
  union {
    __IOM uint32_t CH_MON_F2_IQ_ALL ;                 /*0x98 channel monitor_freq2_iq_value_register */
    struct {
      __IOM uint32_t ch_mon_f2_cic_out_i : 16;           /*[15:0] I path of channel2 cic out */
      __IOM uint32_t ch_mon_f2_cic_out_q : 16;           /*[31:16] Q path of channel2 cic out */
    } CH_MON_F2_IQ_b;
  } ;
  union {
    __IOM uint32_t CH_MON_F01_RMS_ALL ;                 /*0x9C channel monitor_f0_and_f1_rms_value_register */
    struct {
      __IOM uint32_t ch_mon_f0_cic_out_rms : 16;           /*[15:0] rms of channel0 cic out */
      __IOM uint32_t ch_mon_f1_cic_out_rms : 16;           /*[31:16] rms of channel1 cic out */
    } CH_MON_F01_RMS_b;
  } ;
  union {
    __IOM uint32_t CH_MON_F2_RMS_ALL ;                 /*0xA0 channel monitor_f2_rms_value_register */
    struct {
      __IOM uint32_t ch_mon_f2_cic_out_rms : 16;           /*[15:0] rms of channel0 cic out */
      __IOM uint32_t              : 16;           /*[31:16] Reserved */
    } CH_MON_F2_RMS_b;
  } ;
  union {
    __IOM uint32_t CH_MON_F3_IQ_ALL ;                 /*0xA4 channel monitor_freq3_iq_value_register */
    struct {
      __IOM uint32_t ch_mon_f3_cic_out_i : 16;           /*[15:0] I path of channel3 cic out */
      __IOM uint32_t ch_mon_f3_cic_out_q : 16;           /*[31:16] Q path of channel3 cic out */
    } CH_MON_F3_IQ_b;
  } ;
  union {
    __IOM uint32_t CH_MON_F4_IQ_ALL ;                 /*0xA8 channel monitor_freq4_iq_value_register */
    struct {
      __IOM uint32_t ch_mon_f4_cic_out_i : 16;           /*[15:0] I path of channel4 cic out */
      __IOM uint32_t ch_mon_f4_cic_out_q : 16;           /*[31:16] Q path of channel4 cic out */
    } CH_MON_F4_IQ_b;
  } ;
  union {
    __IOM uint32_t CH_MON_F5_IQ_ALL ;                 /*0xAC channel monitor_freq5_iq_value_register */
    struct {
      __IOM uint32_t ch_mon_f5_cic_out_i : 16;           /*[15:0] I path of channel5 cic out */
      __IOM uint32_t ch_mon_f5_cic_out_q : 16;           /*[31:16] Q path of channel5 cic out */
    } CH_MON_F5_IQ_b;
  } ;
  union {
    __IOM uint32_t CH_MON_F34_RMS_ALL ;                 /*0xB0 channel monitor_f3_and_f4_rms_value_register */
    struct {
      __IOM uint32_t ch_mon_f3_cic_out_rms : 16;           /*[15:0] rms of channel3 cic out */
      __IOM uint32_t ch_mon_f4_cic_out_rms : 16;           /*[31:16] rms of channel4 cic out */
    } CH_MON_F34_RMS_b;
  } ;
  union {
    __IOM uint32_t CH_MON_F5_RMS_ALL ;                 /*0xB4 channel monitor_f5_rms_value_register */
    struct {
      __IOM uint32_t ch_mon_f5_cic_out_rms : 16;           /*[15:0] rms of channel5 cic out */
      __IOM uint32_t              : 16;           /*[31:16] Reserved */
    } CH_MON_F5_RMS_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB0_CFG0_ALL ;                 /*0xB8 RF front-end GAIN TAB0 Configuration Register0 */
    struct {
      __IOM uint32_t tab0_lna_gain0 : 5;           /*[4:0] tab0_lna_gain value when gain index is 0 */
      __IOM uint32_t tab0_tia_gain0 : 2;           /*[6:5] tab0_tia_gain value when gain index is 0 */
      __IOM uint32_t tab0_lna_en0 : 1;           /*[7] tab0_lna_enable value when gain index is 0 */
      __IOM uint32_t tab0_gm_gain0 : 5;           /*[12:8] tab0_gm_gain value when gain index is 0 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab0_lna_gain1 : 5;           /*[20:16] tab0_lna_gain value when gain index is 1 */
      __IOM uint32_t tab0_tia_gain1 : 2;           /*[22:21] tab0_tia_gain value when gain index is 1 */
      __IOM uint32_t tab0_lna_en1 : 1;           /*[23] tab0_lna_enable value when gain index is 1 */
      __IOM uint32_t tab0_gm_gain1 : 5;           /*[28:24] tab0_gm_gain value when gain index is 1 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB0_CFG0_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB0_CFG1_ALL ;                 /*0xBC RF front-end GAIN TAB0 Configuration Register1 */
    struct {
      __IOM uint32_t tab0_lna_gain2 : 5;           /*[4:0] tab0_lna_gain value when gain index is 2 */
      __IOM uint32_t tab0_tia_gain2 : 2;           /*[6:5] tab0_tia_gain value when gain index is 2 */
      __IOM uint32_t tab0_lna_en2 : 1;           /*[7] tab0_lna_enable value when gain index is 2 */
      __IOM uint32_t tab0_gm_gain2 : 5;           /*[12:8] tab0_gm_gain value when gain index is 2 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab0_lna_gain3 : 5;           /*[20:16] tab0_lna_gain value when gain index is 3 */
      __IOM uint32_t tab0_tia_gain3 : 2;           /*[22:21] tab0_tia_gain value when gain index is 3 */
      __IOM uint32_t tab0_lna_en3 : 1;           /*[23] tab0_lna_enable value when gain index is 3 */
      __IOM uint32_t tab0_gm_gain3 : 5;           /*[28:24] tab0_gm_gain value when gain index is 3 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB0_CFG1_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB0_CFG2_ALL ;                 /*0xC0 RF front-end GAIN TAB0 Configuration Register2 */
    struct {
      __IOM uint32_t tab0_lna_gain4 : 5;           /*[4:0] tab0_lna_gain value when gain index is 4 */
      __IOM uint32_t tab0_tia_gain4 : 2;           /*[6:5] tab0_tia_gain value when gain index is 4 */
      __IOM uint32_t tab0_lna_en4 : 1;           /*[7] tab0_lna_enable value when gain index is 4 */
      __IOM uint32_t tab0_gm_gain4 : 5;           /*[12:8] tab0_gm_gain value when gain index is 4 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab0_lna_gain5 : 5;           /*[20:16] tab0_lna_gain value when gain index is 5 */
      __IOM uint32_t tab0_tia_gain5 : 2;           /*[22:21] tab0_tia_gain value when gain index is 5 */
      __IOM uint32_t tab0_lna_en5 : 1;           /*[23] tab0_lna_enable value when gain index is 5 */
      __IOM uint32_t tab0_gm_gain5 : 5;           /*[28:24] tab0_gm_gain value when gain index is 5 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB0_CFG2_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB0_CFG3_ALL ;                 /*0xC4 RF front-end GAIN TAB0 Configuration Register3 */
    struct {
      __IOM uint32_t tab0_lna_gain6 : 5;           /*[4:0] tab0_lna_gain value when gain index is 6 */
      __IOM uint32_t tab0_tia_gain6 : 2;           /*[6:5] tab0_tia_gain value when gain index is 6 */
      __IOM uint32_t tab0_lna_en6 : 1;           /*[7] tab0_lna_enable value when gain index is 6 */
      __IOM uint32_t tab0_gm_gain6 : 5;           /*[12:8] tab0_gm_gain value when gain index is 6 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab0_lna_gain7 : 5;           /*[20:16] tab0_lna_gain value when gain index is 7 */
      __IOM uint32_t tab0_tia_gain7 : 2;           /*[22:21] tab0_tia_gain value when gain index is 7 */
      __IOM uint32_t tab0_lna_en7 : 1;           /*[23] tab0_lna_enable value when gain index is 7 */
      __IOM uint32_t tab0_gm_gain7 : 5;           /*[28:24] tab0_gm_gain value when gain index is 7 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB0_CFG3_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB0_CFG4_ALL ;                 /*0xC8 RF front-end GAIN TAB0 Configuration Register4 */
    struct {
      __IOM uint32_t tab0_lna_gain8 : 5;           /*[4:0] tab0_lna_gain value when gain index is 8 */
      __IOM uint32_t tab0_tia_gain8 : 2;           /*[6:5] tab0_tia_gain value when gain index is 8 */
      __IOM uint32_t tab0_lna_en8 : 1;           /*[7] tab0_lna_enable value when gain index is 8 */
      __IOM uint32_t tab0_gm_gain8 : 5;           /*[12:8] tab0_gm_gain value when gain index is 8 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab0_lna_gain9 : 5;           /*[20:16] tab0_lna_gain value when gain index is 9 */
      __IOM uint32_t tab0_tia_gain9 : 2;           /*[22:21] tab0_tia_gain value when gain index is 9 */
      __IOM uint32_t tab0_lna_en9 : 1;           /*[23] tab0_lna_enable value when gain index is 9 */
      __IOM uint32_t tab0_gm_gain9 : 5;           /*[28:24] tab0_gm_gain value when gain index is 9 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB0_CFG4_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB0_CFG5_ALL ;                 /*0xCC RF front-end GAIN TAB0 Configuration Register5 */
    struct {
      __IOM uint32_t tab0_lna_gain10 : 5;           /*[4:0] tab0_lna_gain value when gain index is 10 */
      __IOM uint32_t tab0_tia_gain10 : 2;           /*[6:5] tab0_tia_gain value when gain index is 10 */
      __IOM uint32_t tab0_lna_en10 : 1;           /*[7] tab0_lna_enable value when gain index is 10 */
      __IOM uint32_t tab0_gm_gain10 : 5;           /*[12:8] tab0_gm_gain value when gain index is 10 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab0_lna_gain11 : 5;           /*[20:16] tab0_lna_gain value when gain index is 11 */
      __IOM uint32_t tab0_tia_gain11 : 2;           /*[22:21] tab0_tia_gain value when gain index is 11 */
      __IOM uint32_t tab0_lna_en11 : 1;           /*[23] tab0_lna_enable value when gain index is 11 */
      __IOM uint32_t tab0_gm_gain11 : 5;           /*[28:24] tab0_gm_gain value when gain index is 11 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB0_CFG5_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB0_CFG6_ALL ;                 /*0xD0 RF front-end GAIN TAB0 Configuration Register6 */
    struct {
      __IOM uint32_t tab0_lna_gain12 : 5;           /*[4:0] tab0_lna_gain value when gain index is 12 */
      __IOM uint32_t tab0_tia_gain12 : 2;           /*[6:5] tab0_tia_gain value when gain index is 12 */
      __IOM uint32_t tab0_lna_en12 : 1;           /*[7] tab0_lna_enable value when gain index is 12 */
      __IOM uint32_t tab0_gm_gain12 : 5;           /*[12:8] tab0_gm_gain value when gain index is 12 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab0_lna_gain13 : 5;           /*[20:16] tab0_lna_gain value when gain index is 13 */
      __IOM uint32_t tab0_tia_gain13 : 2;           /*[22:21] tab0_tia_gain value when gain index is 13 */
      __IOM uint32_t tab0_lna_en13 : 1;           /*[23] tab0_lna_enable value when gain index is 13 */
      __IOM uint32_t tab0_gm_gain13 : 5;           /*[28:24] tab0_gm_gain value when gain index is 13 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB0_CFG6_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB0_CFG7_ALL ;                 /*0xD4 RF front-end GAIN TAB0 Configuration Register7 */
    struct {
      __IOM uint32_t tab0_lna_gain14 : 5;           /*[4:0] tab0_lna_gain value when gain index is 14 */
      __IOM uint32_t tab0_tia_gain14 : 2;           /*[6:5] tab0_tia_gain value when gain index is 14 */
      __IOM uint32_t tab0_lna_en14 : 1;           /*[7] tab0_lna_enable value when gain index is 14 */
      __IOM uint32_t tab0_gm_gain14 : 5;           /*[12:8] tab0_gm_gain value when gain index is 14 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab0_lna_gain15 : 5;           /*[20:16] tab0_lna_gain value when gain index is 15 */
      __IOM uint32_t tab0_tia_gain15 : 2;           /*[22:21] tab0_tia_gain value when gain index is 15 */
      __IOM uint32_t tab0_lna_en15 : 1;           /*[23] tab0_lna_enable value when gain index is 15 */
      __IOM uint32_t tab0_gm_gain15 : 5;           /*[28:24] tab0_gm_gain value when gain index is 15 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB0_CFG7_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB0_CFG8_ALL ;                 /*0xD8 RF front-end GAIN TAB0 Configuration Register8 */
    struct {
      __IOM uint32_t tab0_lna_gain16 : 5;           /*[4:0] tab0_lna_gain value when gain index is 16 */
      __IOM uint32_t tab0_tia_gain16 : 2;           /*[6:5] tab0_tia_gain value when gain index is 16 */
      __IOM uint32_t tab0_lna_en16 : 1;           /*[7] tab0_lna_enable value when gain index is 16 */
      __IOM uint32_t tab0_gm_gain16 : 5;           /*[12:8] tab0_gm_gain value when gain index is 16 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab0_lna_gain17 : 5;           /*[20:16] tab0_lna_gain value when gain index is 17 */
      __IOM uint32_t tab0_tia_gain17 : 2;           /*[22:21] tab0_tia_gain value when gain index is 17 */
      __IOM uint32_t tab0_lna_en17 : 1;           /*[23] tab0_lna_enable value when gain index is 17 */
      __IOM uint32_t tab0_gm_gain17 : 5;           /*[28:24] tab0_gm_gain value when gain index is 17 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB0_CFG8_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB0_CFG9_ALL ;                 /*0xDC RF front-end GAIN TAB0 Configuration Register9 */
    struct {
      __IOM uint32_t tab0_lna_gain18 : 5;           /*[4:0] tab0_lna_gain value when gain index is 18 */
      __IOM uint32_t tab0_tia_gain18 : 2;           /*[6:5] tab0_tia_gain value when gain index is 18 */
      __IOM uint32_t tab0_lna_en18 : 1;           /*[7] tab0_lna_enable value when gain index is 18 */
      __IOM uint32_t tab0_gm_gain18 : 5;           /*[12:8] tab0_gm_gain value when gain index is 18 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab0_lna_gain19 : 5;           /*[20:16] tab0_lna_gain value when gain index is 19 */
      __IOM uint32_t tab0_tia_gain19 : 2;           /*[22:21] tab0_tia_gain value when gain index is 19 */
      __IOM uint32_t tab0_lna_en19 : 1;           /*[23] tab0_lna_enable value when gain index is 19 */
      __IOM uint32_t tab0_gm_gain19 : 5;           /*[28:24] tab0_gm_gain value when gain index is 19 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB0_CFG9_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB0_CFG10_ALL ;                 /*0xE0 RF front-end GAIN TAB0 Configuration Register10 */
    struct {
      __IOM uint32_t tab0_lna_gain20 : 5;           /*[4:0] tab0_lna_gain value when gain index is 20 */
      __IOM uint32_t tab0_tia_gain20 : 2;           /*[6:5] tab0_tia_gain value when gain index is 20 */
      __IOM uint32_t tab0_lna_en20 : 1;           /*[7] tab0_lna_enable value when gain index is 20 */
      __IOM uint32_t tab0_gm_gain20 : 5;           /*[12:8] tab0_gm_gain value when gain index is 20 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab0_lna_gain21 : 5;           /*[20:16] tab0_lna_gain value when gain index is 21 */
      __IOM uint32_t tab0_tia_gain21 : 2;           /*[22:21] tab0_tia_gain value when gain index is 21 */
      __IOM uint32_t tab0_lna_en21 : 1;           /*[23] tab0_lna_enable value when gain index is 21 */
      __IOM uint32_t tab0_gm_gain21 : 5;           /*[28:24] tab0_gm_gain value when gain index is 21 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB0_CFG10_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB0_CFG11_ALL ;                 /*0xE4 RF front-end GAIN TAB0 Configuration Register11 */
    struct {
      __IOM uint32_t tab0_lna_gain22 : 5;           /*[4:0] tab0_lna_gain value when gain index is 22 */
      __IOM uint32_t tab0_tia_gain22 : 2;           /*[6:5] tab0_tia_gain value when gain index is 22 */
      __IOM uint32_t tab0_lna_en22 : 1;           /*[7] tab0_lna_enable value when gain index is 22 */
      __IOM uint32_t tab0_gm_gain22 : 5;           /*[12:8] tab0_gm_gain value when gain index is 22 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab0_lna_gain23 : 5;           /*[20:16] tab0_lna_gain value when gain index is 23 */
      __IOM uint32_t tab0_tia_gain23 : 2;           /*[22:21] tab0_tia_gain value when gain index is 23 */
      __IOM uint32_t tab0_lna_en23 : 1;           /*[23] tab0_lna_enable value when gain index is 23 */
      __IOM uint32_t tab0_gm_gain23 : 5;           /*[28:24] tab0_gm_gain value when gain index is 23 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB0_CFG11_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB0_CFG12_ALL ;                 /*0xE8 RF front-end GAIN TAB0 Configuration Register12 */
    struct {
      __IOM uint32_t tab0_lna_gain24 : 5;           /*[4:0] tab0_lna_gain value when gain index is 24 */
      __IOM uint32_t tab0_tia_gain24 : 2;           /*[6:5] tab0_tia_gain value when gain index is 24 */
      __IOM uint32_t tab0_lna_en24 : 1;           /*[7] tab0_lna_enable value when gain index is 24 */
      __IOM uint32_t tab0_gm_gain24 : 5;           /*[12:8] tab0_gm_gain value when gain index is 24 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab0_lna_gain25 : 5;           /*[20:16] tab0_lna_gain value when gain index is 25 */
      __IOM uint32_t tab0_tia_gain25 : 2;           /*[22:21] tab0_tia_gain value when gain index is 25 */
      __IOM uint32_t tab0_lna_en25 : 1;           /*[23] tab0_lna_enable value when gain index is 25 */
      __IOM uint32_t tab0_gm_gain25 : 5;           /*[28:24] tab0_gm_gain value when gain index is 25 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB0_CFG12_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB0_CFG13_ALL ;                 /*0xEC RF front-end GAIN TAB0 Configuration Register13 */
    struct {
      __IOM uint32_t tab0_lna_gain26 : 5;           /*[4:0] tab0_lna_gain value when gain index is 26 */
      __IOM uint32_t tab0_tia_gain26 : 2;           /*[6:5] tab0_tia_gain value when gain index is 26 */
      __IOM uint32_t tab0_lna_en26 : 1;           /*[7] tab0_lna_enable value when gain index is 26 */
      __IOM uint32_t tab0_gm_gain26 : 5;           /*[12:8] tab0_gm_gain value when gain index is 26 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab0_lna_gain27 : 5;           /*[20:16] tab0_lna_gain value when gain index is 27 */
      __IOM uint32_t tab0_tia_gain27 : 2;           /*[22:21] tab0_tia_gain value when gain index is 27 */
      __IOM uint32_t tab0_lna_en27 : 1;           /*[23] tab0_lna_enable value when gain index is 27 */
      __IOM uint32_t tab0_gm_gain27 : 5;           /*[28:24] tab0_gm_gain value when gain index is 27 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB0_CFG13_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB0_CFG14_ALL ;                 /*0xF0 RF front-end GAIN TAB0 Configuration Register14 */
    struct {
      __IOM uint32_t tab0_lna_gain28 : 5;           /*[4:0] tab0_lna_gain value when gain index is 28 */
      __IOM uint32_t tab0_tia_gain28 : 2;           /*[6:5] tab0_tia_gain value when gain index is 28 */
      __IOM uint32_t tab0_lna_en28 : 1;           /*[7] tab0_lna_enable value when gain index is 28 */
      __IOM uint32_t tab0_gm_gain28 : 5;           /*[12:8] tab0_gm_gain value when gain index is 28 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab0_lna_gain29 : 5;           /*[20:16] tab0_lna_gain value when gain index is 29 */
      __IOM uint32_t tab0_tia_gain29 : 2;           /*[22:21] tab0_tia_gain value when gain index is 29 */
      __IOM uint32_t tab0_lna_en29 : 1;           /*[23] tab0_lna_enable value when gain index is 29 */
      __IOM uint32_t tab0_gm_gain29 : 5;           /*[28:24] tab0_gm_gain value when gain index is 29 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB0_CFG14_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB0_CFG15_ALL ;                 /*0xF4 RF front-end GAIN TAB0 Configuration Register15 */
    struct {
      __IOM uint32_t tab0_lna_gain30 : 5;           /*[4:0] tab0_lna_gain value when gain index is 30 */
      __IOM uint32_t tab0_tia_gain30 : 2;           /*[6:5] tab0_tia_gain value when gain index is 30 */
      __IOM uint32_t tab0_lna_en30 : 1;           /*[7] tab0_lna_enable value when gain index is 30 */
      __IOM uint32_t tab0_gm_gain30 : 5;           /*[12:8] tab0_gm_gain value when gain index is 30 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab0_lna_gain31 : 5;           /*[20:16] tab0_lna_gain value when gain index is 31 */
      __IOM uint32_t tab0_tia_gain31 : 2;           /*[22:21] tab0_tia_gain value when gain index is 31 */
      __IOM uint32_t tab0_lna_en31 : 1;           /*[23] tab0_lna_enable value when gain index is 31 */
      __IOM uint32_t tab0_gm_gain31 : 5;           /*[28:24] tab0_gm_gain value when gain index is 31 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB0_CFG15_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB0_CFG16_ALL ;                 /*0xF8 RF front-end GAIN TAB0 Configuration Register16 */
    struct {
      __IOM uint32_t tab0_lna_gain32 : 5;           /*[4:0] tab0_lna_gain value when gain index is 32 */
      __IOM uint32_t tab0_tia_gain32 : 2;           /*[6:5] tab0_tia_gain value when gain index is 32 */
      __IOM uint32_t tab0_lna_en32 : 1;           /*[7] tab0_lna_enable value when gain index is 32 */
      __IOM uint32_t tab0_gm_gain32 : 5;           /*[12:8] tab0_gm_gain value when gain index is 32 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab0_lna_gain33 : 5;           /*[20:16] tab0_lna_gain value when gain index is 33 */
      __IOM uint32_t tab0_tia_gain33 : 2;           /*[22:21] tab0_tia_gain value when gain index is 33 */
      __IOM uint32_t tab0_lna_en33 : 1;           /*[23] tab0_lna_enable value when gain index is 33 */
      __IOM uint32_t tab0_gm_gain33 : 5;           /*[28:24] tab0_gm_gain value when gain index is 33 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB0_CFG16_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB0_CFG17_ALL ;                 /*0xFC RF front-end GAIN TAB0 Configuration Register17 */
    struct {
      __IOM uint32_t tab0_lna_gain34 : 5;           /*[4:0] tab0_lna_gain value when gain index is 34 */
      __IOM uint32_t tab0_tia_gain34 : 2;           /*[6:5] tab0_tia_gain value when gain index is 34 */
      __IOM uint32_t tab0_lna_en34 : 1;           /*[7] tab0_lna_enable value when gain index is 34 */
      __IOM uint32_t tab0_gm_gain34 : 5;           /*[12:8] tab0_gm_gain value when gain index is 34 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab0_lna_gain35 : 5;           /*[20:16] tab0_lna_gain value when gain index is 35 */
      __IOM uint32_t tab0_tia_gain35 : 2;           /*[22:21] tab0_tia_gain value when gain index is 35 */
      __IOM uint32_t tab0_lna_en35 : 1;           /*[23] tab0_lna_enable value when gain index is 35 */
      __IOM uint32_t tab0_gm_gain35 : 5;           /*[28:24] tab0_gm_gain value when gain index is 35 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB0_CFG17_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB0_CFG18_ALL ;                 /*0x100 RF front-end GAIN TAB0 Configuration Register18 */
    struct {
      __IOM uint32_t tab0_lna_gain36 : 5;           /*[4:0] tab0_lna_gain value when gain index is 36 */
      __IOM uint32_t tab0_tia_gain36 : 2;           /*[6:5] tab0_tia_gain value when gain index is 36 */
      __IOM uint32_t tab0_lna_en36 : 1;           /*[7] tab0_lna_enable value when gain index is 36 */
      __IOM uint32_t tab0_gm_gain36 : 5;           /*[12:8] tab0_gm_gain value when gain index is 36 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab0_lna_gain37 : 5;           /*[20:16] tab0_lna_gain value when gain index is 37 */
      __IOM uint32_t tab0_tia_gain37 : 2;           /*[22:21] tab0_tia_gain value when gain index is 37 */
      __IOM uint32_t tab0_lna_en37 : 1;           /*[23] tab0_lna_enable value when gain index is 37 */
      __IOM uint32_t tab0_gm_gain37 : 5;           /*[28:24] tab0_gm_gain value when gain index is 37 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB0_CFG18_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB0_CFG19_ALL ;                 /*0x104 RF front-end GAIN TAB0 Configuration Register19 */
    struct {
      __IOM uint32_t tab0_lna_gain38 : 5;           /*[4:0] tab0_lna_gain value when gain index is 38 */
      __IOM uint32_t tab0_tia_gain38 : 2;           /*[6:5] tab0_tia_gain value when gain index is 38 */
      __IOM uint32_t tab0_lna_en38 : 1;           /*[7] tab0_lna_enable value when gain index is 38 */
      __IOM uint32_t tab0_gm_gain38 : 5;           /*[12:8] tab0_gm_gain value when gain index is 38 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab0_lna_gain39 : 5;           /*[20:16] tab0_lna_gain value when gain index is 39 */
      __IOM uint32_t tab0_tia_gain39 : 2;           /*[22:21] tab0_tia_gain value when gain index is 39 */
      __IOM uint32_t tab0_lna_en39 : 1;           /*[23] tab0_lna_enable value when gain index is 39 */
      __IOM uint32_t tab0_gm_gain39 : 5;           /*[28:24] tab0_gm_gain value when gain index is 39 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB0_CFG19_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB0_CFG20_ALL ;                 /*0x108 RF front-end GAIN TAB0 Configuration Register20 */
    struct {
      __IOM uint32_t tab0_lna_gain40 : 5;           /*[4:0] tab0_lna_gain value when gain index is 40 */
      __IOM uint32_t tab0_tia_gain40 : 2;           /*[6:5] tab0_tia_gain value when gain index is 40 */
      __IOM uint32_t tab0_lna_en40 : 1;           /*[7] tab0_lna_enable value when gain index is 40 */
      __IOM uint32_t tab0_gm_gain40 : 5;           /*[12:8] tab0_gm_gain value when gain index is 40 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab0_lna_gain41 : 5;           /*[20:16] tab0_lna_gain value when gain index is 41 */
      __IOM uint32_t tab0_tia_gain41 : 2;           /*[22:21] tab0_tia_gain value when gain index is 41 */
      __IOM uint32_t tab0_lna_en41 : 1;           /*[23] tab0_lna_enable value when gain index is 41 */
      __IOM uint32_t tab0_gm_gain41 : 5;           /*[28:24] tab0_gm_gain value when gain index is 41 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB0_CFG20_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB1_CFG0_ALL ;                 /*0x10C RF front-end GAIN TAB1 Configuration Register0 */
    struct {
      __IOM uint32_t tab1_lna_gain0 : 5;           /*[4:0] tab1_lna_gain value when gain index is 0 */
      __IOM uint32_t tab1_tia_gain0 : 2;           /*[6:5] tab1_tia_gain value when gain index is 0 */
      __IOM uint32_t tab1_lna_en0 : 1;           /*[7] tab1_lna_enable value when gain index is 0 */
      __IOM uint32_t tab1_gm_gain0 : 5;           /*[12:8] tab1_gm_gain value when gain index is 0 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab1_lna_gain1 : 5;           /*[20:16] tab1_lna_gain value when gain index is 1 */
      __IOM uint32_t tab1_tia_gain1 : 2;           /*[22:21] tab1_tia_gain value when gain index is 1 */
      __IOM uint32_t tab1_lna_en1 : 1;           /*[23] tab1_lna_enable value when gain index is 1 */
      __IOM uint32_t tab1_gm_gain1 : 5;           /*[28:24] tab1_gm_gain value when gain index is 1 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB1_CFG0_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB1_CFG1_ALL ;                 /*0x110 RF front-end GAIN TAB1 Configuration Register1 */
    struct {
      __IOM uint32_t tab1_lna_gain2 : 5;           /*[4:0] tab1_lna_gain value when gain index is 2 */
      __IOM uint32_t tab1_tia_gain2 : 2;           /*[6:5] tab1_tia_gain value when gain index is 2 */
      __IOM uint32_t tab1_lna_en2 : 1;           /*[7] tab1_lna_enable value when gain index is 2 */
      __IOM uint32_t tab1_gm_gain2 : 5;           /*[12:8] tab1_gm_gain value when gain index is 2 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab1_lna_gain3 : 5;           /*[20:16] tab1_lna_gain value when gain index is 3 */
      __IOM uint32_t tab1_tia_gain3 : 2;           /*[22:21] tab1_tia_gain value when gain index is 3 */
      __IOM uint32_t tab1_lna_en3 : 1;           /*[23] tab1_lna_enable value when gain index is 3 */
      __IOM uint32_t tab1_gm_gain3 : 5;           /*[28:24] tab1_gm_gain value when gain index is 3 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB1_CFG1_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB1_CFG2_ALL ;                 /*0x114 RF front-end GAIN TAB1 Configuration Register2 */
    struct {
      __IOM uint32_t tab1_lna_gain4 : 5;           /*[4:0] tab1_lna_gain value when gain index is 4 */
      __IOM uint32_t tab1_tia_gain4 : 2;           /*[6:5] tab1_tia_gain value when gain index is 4 */
      __IOM uint32_t tab1_lna_en4 : 1;           /*[7] tab1_lna_enable value when gain index is 4 */
      __IOM uint32_t tab1_gm_gain4 : 5;           /*[12:8] tab1_gm_gain value when gain index is 4 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab1_lna_gain5 : 5;           /*[20:16] tab1_lna_gain value when gain index is 5 */
      __IOM uint32_t tab1_tia_gain5 : 2;           /*[22:21] tab1_tia_gain value when gain index is 5 */
      __IOM uint32_t tab1_lna_en5 : 1;           /*[23] tab1_lna_enable value when gain index is 5 */
      __IOM uint32_t tab1_gm_gain5 : 5;           /*[28:24] tab1_gm_gain value when gain index is 5 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB1_CFG2_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB1_CFG3_ALL ;                 /*0x118 RF front-end GAIN TAB1 Configuration Register3 */
    struct {
      __IOM uint32_t tab1_lna_gain6 : 5;           /*[4:0] tab1_lna_gain value when gain index is 6 */
      __IOM uint32_t tab1_tia_gain6 : 2;           /*[6:5] tab1_tia_gain value when gain index is 6 */
      __IOM uint32_t tab1_lna_en6 : 1;           /*[7] tab1_lna_enable value when gain index is 6 */
      __IOM uint32_t tab1_gm_gain6 : 5;           /*[12:8] tab1_gm_gain value when gain index is 6 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab1_lna_gain7 : 5;           /*[20:16] tab1_lna_gain value when gain index is 7 */
      __IOM uint32_t tab1_tia_gain7 : 2;           /*[22:21] tab1_tia_gain value when gain index is 7 */
      __IOM uint32_t tab1_lna_en7 : 1;           /*[23] tab1_lna_enable value when gain index is 7 */
      __IOM uint32_t tab1_gm_gain7 : 5;           /*[28:24] tab1_gm_gain value when gain index is 7 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB1_CFG3_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB1_CFG4_ALL ;                 /*0x11C RF front-end GAIN TAB1 Configuration Register4 */
    struct {
      __IOM uint32_t tab1_lna_gain8 : 5;           /*[4:0] tab1_lna_gain value when gain index is 8 */
      __IOM uint32_t tab1_tia_gain8 : 2;           /*[6:5] tab1_tia_gain value when gain index is 8 */
      __IOM uint32_t tab1_lna_en8 : 1;           /*[7] tab1_lna_enable value when gain index is 8 */
      __IOM uint32_t tab1_gm_gain8 : 5;           /*[12:8] tab1_gm_gain value when gain index is 8 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab1_lna_gain9 : 5;           /*[20:16] tab1_lna_gain value when gain index is 9 */
      __IOM uint32_t tab1_tia_gain9 : 2;           /*[22:21] tab1_tia_gain value when gain index is 9 */
      __IOM uint32_t tab1_lna_en9 : 1;           /*[23] tab1_lna_enable value when gain index is 9 */
      __IOM uint32_t tab1_gm_gain9 : 5;           /*[28:24] tab1_gm_gain value when gain index is 9 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB1_CFG4_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB1_CFG5_ALL ;                 /*0x120 RF front-end GAIN TAB1 Configuration Register5 */
    struct {
      __IOM uint32_t tab1_lna_gain10 : 5;           /*[4:0] tab1_lna_gain value when gain index is 10 */
      __IOM uint32_t tab1_tia_gain10 : 2;           /*[6:5] tab1_tia_gain value when gain index is 10 */
      __IOM uint32_t tab1_lna_en10 : 1;           /*[7] tab1_lna_enable value when gain index is 10 */
      __IOM uint32_t tab1_gm_gain10 : 5;           /*[12:8] tab1_gm_gain value when gain index is 10 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab1_lna_gain11 : 5;           /*[20:16] tab1_lna_gain value when gain index is 11 */
      __IOM uint32_t tab1_tia_gain11 : 2;           /*[22:21] tab1_tia_gain value when gain index is 11 */
      __IOM uint32_t tab1_lna_en11 : 1;           /*[23] tab1_lna_enable value when gain index is 11 */
      __IOM uint32_t tab1_gm_gain11 : 5;           /*[28:24] tab1_gm_gain value when gain index is 11 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB1_CFG5_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB1_CFG6_ALL ;                 /*0x124 RF front-end GAIN TAB1 Configuration Register6 */
    struct {
      __IOM uint32_t tab1_lna_gain12 : 5;           /*[4:0] tab1_lna_gain value when gain index is 12 */
      __IOM uint32_t tab1_tia_gain12 : 2;           /*[6:5] tab1_tia_gain value when gain index is 12 */
      __IOM uint32_t tab1_lna_en12 : 1;           /*[7] tab1_lna_enable value when gain index is 12 */
      __IOM uint32_t tab1_gm_gain12 : 5;           /*[12:8] tab1_gm_gain value when gain index is 12 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab1_lna_gain13 : 5;           /*[20:16] tab1_lna_gain value when gain index is 13 */
      __IOM uint32_t tab1_tia_gain13 : 2;           /*[22:21] tab1_tia_gain value when gain index is 13 */
      __IOM uint32_t tab1_lna_en13 : 1;           /*[23] tab1_lna_enable value when gain index is 13 */
      __IOM uint32_t tab1_gm_gain13 : 5;           /*[28:24] tab1_gm_gain value when gain index is 13 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB1_CFG6_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB1_CFG7_ALL ;                 /*0x128 RF front-end GAIN TAB1 Configuration Register7 */
    struct {
      __IOM uint32_t tab1_lna_gain14 : 5;           /*[4:0] tab1_lna_gain value when gain index is 14 */
      __IOM uint32_t tab1_tia_gain14 : 2;           /*[6:5] tab1_tia_gain value when gain index is 14 */
      __IOM uint32_t tab1_lna_en14 : 1;           /*[7] tab1_lna_enable value when gain index is 14 */
      __IOM uint32_t tab1_gm_gain14 : 5;           /*[12:8] tab1_gm_gain value when gain index is 14 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab1_lna_gain15 : 5;           /*[20:16] tab1_lna_gain value when gain index is 15 */
      __IOM uint32_t tab1_tia_gain15 : 2;           /*[22:21] tab1_tia_gain value when gain index is 15 */
      __IOM uint32_t tab1_lna_en15 : 1;           /*[23] tab1_lna_enable value when gain index is 15 */
      __IOM uint32_t tab1_gm_gain15 : 5;           /*[28:24] tab1_gm_gain value when gain index is 15 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB1_CFG7_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB1_CFG8_ALL ;                 /*0x12C RF front-end GAIN TAB1 Configuration Register8 */
    struct {
      __IOM uint32_t tab1_lna_gain16 : 5;           /*[4:0] tab1_lna_gain value when gain index is 16 */
      __IOM uint32_t tab1_tia_gain16 : 2;           /*[6:5] tab1_tia_gain value when gain index is 16 */
      __IOM uint32_t tab1_lna_en16 : 1;           /*[7] tab1_lna_enable value when gain index is 16 */
      __IOM uint32_t tab1_gm_gain16 : 5;           /*[12:8] tab1_gm_gain value when gain index is 16 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab1_lna_gain17 : 5;           /*[20:16] tab1_lna_gain value when gain index is 17 */
      __IOM uint32_t tab1_tia_gain17 : 2;           /*[22:21] tab1_tia_gain value when gain index is 17 */
      __IOM uint32_t tab1_lna_en17 : 1;           /*[23] tab1_lna_enable value when gain index is 17 */
      __IOM uint32_t tab1_gm_gain17 : 5;           /*[28:24] tab1_gm_gain value when gain index is 17 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB1_CFG8_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB1_CFG9_ALL ;                 /*0x130 RF front-end GAIN TAB1 Configuration Register9 */
    struct {
      __IOM uint32_t tab1_lna_gain18 : 5;           /*[4:0] tab1_lna_gain value when gain index is 18 */
      __IOM uint32_t tab1_tia_gain18 : 2;           /*[6:5] tab1_tia_gain value when gain index is 18 */
      __IOM uint32_t tab1_lna_en18 : 1;           /*[7] tab1_lna_enable value when gain index is 18 */
      __IOM uint32_t tab1_gm_gain18 : 5;           /*[12:8] tab1_gm_gain value when gain index is 18 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab1_lna_gain19 : 5;           /*[20:16] tab1_lna_gain value when gain index is 19 */
      __IOM uint32_t tab1_tia_gain19 : 2;           /*[22:21] tab1_tia_gain value when gain index is 19 */
      __IOM uint32_t tab1_lna_en19 : 1;           /*[23] tab1_lna_enable value when gain index is 19 */
      __IOM uint32_t tab1_gm_gain19 : 5;           /*[28:24] tab1_gm_gain value when gain index is 19 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB1_CFG9_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB1_CFG10_ALL ;                 /*0x134 RF front-end GAIN TAB1 Configuration Register10 */
    struct {
      __IOM uint32_t tab1_lna_gain20 : 5;           /*[4:0] tab1_lna_gain value when gain index is 20 */
      __IOM uint32_t tab1_tia_gain20 : 2;           /*[6:5] tab1_tia_gain value when gain index is 20 */
      __IOM uint32_t tab1_lna_en20 : 1;           /*[7] tab1_lna_enable value when gain index is 20 */
      __IOM uint32_t tab1_gm_gain20 : 5;           /*[12:8] tab1_gm_gain value when gain index is 20 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab1_lna_gain21 : 5;           /*[20:16] tab1_lna_gain value when gain index is 21 */
      __IOM uint32_t tab1_tia_gain21 : 2;           /*[22:21] tab1_tia_gain value when gain index is 21 */
      __IOM uint32_t tab1_lna_en21 : 1;           /*[23] tab1_lna_enable value when gain index is 21 */
      __IOM uint32_t tab1_gm_gain21 : 5;           /*[28:24] tab1_gm_gain value when gain index is 21 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB1_CFG10_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB1_CFG11_ALL ;                 /*0x138 RF front-end GAIN TAB1 Configuration Register11 */
    struct {
      __IOM uint32_t tab1_lna_gain22 : 5;           /*[4:0] tab1_lna_gain value when gain index is 22 */
      __IOM uint32_t tab1_tia_gain22 : 2;           /*[6:5] tab1_tia_gain value when gain index is 22 */
      __IOM uint32_t tab1_lna_en22 : 1;           /*[7] tab1_lna_enable value when gain index is 22 */
      __IOM uint32_t tab1_gm_gain22 : 5;           /*[12:8] tab1_gm_gain value when gain index is 22 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab1_lna_gain23 : 5;           /*[20:16] tab1_lna_gain value when gain index is 23 */
      __IOM uint32_t tab1_tia_gain23 : 2;           /*[22:21] tab1_tia_gain value when gain index is 23 */
      __IOM uint32_t tab1_lna_en23 : 1;           /*[23] tab1_lna_enable value when gain index is 23 */
      __IOM uint32_t tab1_gm_gain23 : 5;           /*[28:24] tab1_gm_gain value when gain index is 23 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB1_CFG11_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB1_CFG12_ALL ;                 /*0x13C RF front-end GAIN TAB1 Configuration Register12 */
    struct {
      __IOM uint32_t tab1_lna_gain24 : 5;           /*[4:0] tab1_lna_gain value when gain index is 24 */
      __IOM uint32_t tab1_tia_gain24 : 2;           /*[6:5] tab1_tia_gain value when gain index is 24 */
      __IOM uint32_t tab1_lna_en24 : 1;           /*[7] tab1_lna_enable value when gain index is 24 */
      __IOM uint32_t tab1_gm_gain24 : 5;           /*[12:8] tab1_gm_gain value when gain index is 24 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab1_lna_gain25 : 5;           /*[20:16] tab1_lna_gain value when gain index is 25 */
      __IOM uint32_t tab1_tia_gain25 : 2;           /*[22:21] tab1_tia_gain value when gain index is 25 */
      __IOM uint32_t tab1_lna_en25 : 1;           /*[23] tab1_lna_enable value when gain index is 25 */
      __IOM uint32_t tab1_gm_gain25 : 5;           /*[28:24] tab1_gm_gain value when gain index is 25 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB1_CFG12_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB1_CFG13_ALL ;                 /*0x140 RF front-end GAIN TAB1 Configuration Register13 */
    struct {
      __IOM uint32_t tab1_lna_gain26 : 5;           /*[4:0] tab1_lna_gain value when gain index is 26 */
      __IOM uint32_t tab1_tia_gain26 : 2;           /*[6:5] tab1_tia_gain value when gain index is 26 */
      __IOM uint32_t tab1_lna_en26 : 1;           /*[7] tab1_lna_enable value when gain index is 26 */
      __IOM uint32_t tab1_gm_gain26 : 5;           /*[12:8] tab1_gm_gain value when gain index is 26 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab1_lna_gain27 : 5;           /*[20:16] tab1_lna_gain value when gain index is 27 */
      __IOM uint32_t tab1_tia_gain27 : 2;           /*[22:21] tab1_tia_gain value when gain index is 27 */
      __IOM uint32_t tab1_lna_en27 : 1;           /*[23] tab1_lna_enable value when gain index is 27 */
      __IOM uint32_t tab1_gm_gain27 : 5;           /*[28:24] tab1_gm_gain value when gain index is 27 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB1_CFG13_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB1_CFG14_ALL ;                 /*0x144 RF front-end GAIN TAB1 Configuration Register14 */
    struct {
      __IOM uint32_t tab1_lna_gain28 : 5;           /*[4:0] tab1_lna_gain value when gain index is 28 */
      __IOM uint32_t tab1_tia_gain28 : 2;           /*[6:5] tab1_tia_gain value when gain index is 28 */
      __IOM uint32_t tab1_lna_en28 : 1;           /*[7] tab1_lna_enable value when gain index is 28 */
      __IOM uint32_t tab1_gm_gain28 : 5;           /*[12:8] tab1_gm_gain value when gain index is 28 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab1_lna_gain29 : 5;           /*[20:16] tab1_lna_gain value when gain index is 29 */
      __IOM uint32_t tab1_tia_gain29 : 2;           /*[22:21] tab1_tia_gain value when gain index is 29 */
      __IOM uint32_t tab1_lna_en29 : 1;           /*[23] tab1_lna_enable value when gain index is 29 */
      __IOM uint32_t tab1_gm_gain29 : 5;           /*[28:24] tab1_gm_gain value when gain index is 29 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB1_CFG14_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB1_CFG15_ALL ;                 /*0x148 RF front-end GAIN TAB1 Configuration Register15 */
    struct {
      __IOM uint32_t tab1_lna_gain30 : 5;           /*[4:0] tab1_lna_gain value when gain index is 30 */
      __IOM uint32_t tab1_tia_gain30 : 2;           /*[6:5] tab1_tia_gain value when gain index is 30 */
      __IOM uint32_t tab1_lna_en30 : 1;           /*[7] tab1_lna_enable value when gain index is 30 */
      __IOM uint32_t tab1_gm_gain30 : 5;           /*[12:8] tab1_gm_gain value when gain index is 30 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab1_lna_gain31 : 5;           /*[20:16] tab1_lna_gain value when gain index is 31 */
      __IOM uint32_t tab1_tia_gain31 : 2;           /*[22:21] tab1_tia_gain value when gain index is 31 */
      __IOM uint32_t tab1_lna_en31 : 1;           /*[23] tab1_lna_enable value when gain index is 31 */
      __IOM uint32_t tab1_gm_gain31 : 5;           /*[28:24] tab1_gm_gain value when gain index is 31 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB1_CFG15_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB1_CFG16_ALL ;                 /*0x14C RF front-end GAIN TAB1 Configuration Register16 */
    struct {
      __IOM uint32_t tab1_lna_gain32 : 5;           /*[4:0] tab1_lna_gain value when gain index is 32 */
      __IOM uint32_t tab1_tia_gain32 : 2;           /*[6:5] tab1_tia_gain value when gain index is 32 */
      __IOM uint32_t tab1_lna_en32 : 1;           /*[7] tab1_lna_enable value when gain index is 32 */
      __IOM uint32_t tab1_gm_gain32 : 5;           /*[12:8] tab1_gm_gain value when gain index is 32 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab1_lna_gain33 : 5;           /*[20:16] tab1_lna_gain value when gain index is 33 */
      __IOM uint32_t tab1_tia_gain33 : 2;           /*[22:21] tab1_tia_gain value when gain index is 33 */
      __IOM uint32_t tab1_lna_en33 : 1;           /*[23] tab1_lna_enable value when gain index is 33 */
      __IOM uint32_t tab1_gm_gain33 : 5;           /*[28:24] tab1_gm_gain value when gain index is 33 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB1_CFG16_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB1_CFG17_ALL ;                 /*0x150 RF front-end GAIN TAB1 Configuration Register17 */
    struct {
      __IOM uint32_t tab1_lna_gain34 : 5;           /*[4:0] tab1_lna_gain value when gain index is 34 */
      __IOM uint32_t tab1_tia_gain34 : 2;           /*[6:5] tab1_tia_gain value when gain index is 34 */
      __IOM uint32_t tab1_lna_en34 : 1;           /*[7] tab1_lna_enable value when gain index is 34 */
      __IOM uint32_t tab1_gm_gain34 : 5;           /*[12:8] tab1_gm_gain value when gain index is 34 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab1_lna_gain35 : 5;           /*[20:16] tab1_lna_gain value when gain index is 35 */
      __IOM uint32_t tab1_tia_gain35 : 2;           /*[22:21] tab1_tia_gain value when gain index is 35 */
      __IOM uint32_t tab1_lna_en35 : 1;           /*[23] tab1_lna_enable value when gain index is 35 */
      __IOM uint32_t tab1_gm_gain35 : 5;           /*[28:24] tab1_gm_gain value when gain index is 35 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB1_CFG17_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB1_CFG18_ALL ;                 /*0x154 RF front-end GAIN TAB1 Configuration Register18 */
    struct {
      __IOM uint32_t tab1_lna_gain36 : 5;           /*[4:0] tab1_lna_gain value when gain index is 36 */
      __IOM uint32_t tab1_tia_gain36 : 2;           /*[6:5] tab1_tia_gain value when gain index is 36 */
      __IOM uint32_t tab1_lna_en36 : 1;           /*[7] tab1_lna_enable value when gain index is 36 */
      __IOM uint32_t tab1_gm_gain36 : 5;           /*[12:8] tab1_gm_gain value when gain index is 36 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab1_lna_gain37 : 5;           /*[20:16] tab1_lna_gain value when gain index is 37 */
      __IOM uint32_t tab1_tia_gain37 : 2;           /*[22:21] tab1_tia_gain value when gain index is 37 */
      __IOM uint32_t tab1_lna_en37 : 1;           /*[23] tab1_lna_enable value when gain index is 37 */
      __IOM uint32_t tab1_gm_gain37 : 5;           /*[28:24] tab1_gm_gain value when gain index is 37 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB1_CFG18_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB1_CFG19_ALL ;                 /*0x158 RF front-end GAIN TAB1 Configuration Register19 */
    struct {
      __IOM uint32_t tab1_lna_gain38 : 5;           /*[4:0] tab1_lna_gain value when gain index is 38 */
      __IOM uint32_t tab1_tia_gain38 : 2;           /*[6:5] tab1_tia_gain value when gain index is 38 */
      __IOM uint32_t tab1_lna_en38 : 1;           /*[7] tab1_lna_enable value when gain index is 38 */
      __IOM uint32_t tab1_gm_gain38 : 5;           /*[12:8] tab1_gm_gain value when gain index is 38 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab1_lna_gain39 : 5;           /*[20:16] tab1_lna_gain value when gain index is 39 */
      __IOM uint32_t tab1_tia_gain39 : 2;           /*[22:21] tab1_tia_gain value when gain index is 39 */
      __IOM uint32_t tab1_lna_en39 : 1;           /*[23] tab1_lna_enable value when gain index is 39 */
      __IOM uint32_t tab1_gm_gain39 : 5;           /*[28:24] tab1_gm_gain value when gain index is 39 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB1_CFG19_b;
  } ;
  union {
    __IOM uint32_t FE_GAINTAB1_CFG20_ALL ;                 /*0x15C RF front-end GAIN TAB1 Configuration Register20 */
    struct {
      __IOM uint32_t tab1_lna_gain40 : 5;           /*[4:0] tab1_lna_gain value when gain index is 40 */
      __IOM uint32_t tab1_tia_gain40 : 2;           /*[6:5] tab1_tia_gain value when gain index is 40 */
      __IOM uint32_t tab1_lna_en40 : 1;           /*[7] tab1_lna_enable value when gain index is 40 */
      __IOM uint32_t tab1_gm_gain40 : 5;           /*[12:8] tab1_gm_gain value when gain index is 40 */
      __IOM uint32_t              : 3;           /*[15:13] Reserved */
      __IOM uint32_t tab1_lna_gain41 : 5;           /*[20:16] tab1_lna_gain value when gain index is 41 */
      __IOM uint32_t tab1_tia_gain41 : 2;           /*[22:21] tab1_tia_gain value when gain index is 41 */
      __IOM uint32_t tab1_lna_en41 : 1;           /*[23] tab1_lna_enable value when gain index is 41 */
      __IOM uint32_t tab1_gm_gain41 : 5;           /*[28:24] tab1_gm_gain value when gain index is 41 */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } FE_GAINTAB1_CFG20_b;
  } ;
  union {
    __IOM uint32_t BPF_GAINTAB0_CFG0_ALL ;                 /*0x160 BPF GAIN TAB0 Configuration Register0 */
    struct {
      __IOM uint32_t tab0_bpf0_gain0 : 3;           /*[2:0] tab0_bpf0_gain value when gain index is 0 */
      __IOM uint32_t              : 1;           /*[3] Reserved */
      __IOM uint32_t tab0_bpf1_gain0 : 3;           /*[6:4] tab0_bpf1_gain value when gain index is 0 */
      __IOM uint32_t              : 1;           /*[7] Reserved */
      __IOM uint32_t tab0_bpf0_gain1 : 3;           /*[10:8] tab0_bpf0_gain value when gain index is 1 */
      __IOM uint32_t              : 1;           /*[11] Reserved */
      __IOM uint32_t tab0_bpf1_gain1 : 3;           /*[14:12] tab0_bpf1_gain value when gain index is 1 */
      __IOM uint32_t              : 1;           /*[15] Reserved */
      __IOM uint32_t tab0_bpf0_gain2 : 3;           /*[18:16] tab0_bpf0_gain value when gain index is 2 */
      __IOM uint32_t              : 1;           /*[19] Reserved */
      __IOM uint32_t tab0_bpf1_gain2 : 3;           /*[22:20] tab0_bpf1_gain value when gain index is 2 */
      __IOM uint32_t              : 1;           /*[23] Reserved */
      __IOM uint32_t tab0_bpf0_gain3 : 3;           /*[26:24] tab0_bpf0_gain value when gain index is 3 */
      __IOM uint32_t              : 1;           /*[27] Reserved */
      __IOM uint32_t tab0_bpf1_gain3 : 3;           /*[30:28] tab0_bpf1_gain value when gain index is 3 */
      __IOM uint32_t              : 1;           /*[31] Reserved */
    } BPF_GAINTAB0_CFG0_b;
  } ;
  union {
    __IOM uint32_t BPF_GAINTAB0_CFG1_ALL ;                 /*0x164 BPF GAIN TAB0 Configuration Register1 */
    struct {
      __IOM uint32_t tab0_bpf0_gain4 : 3;           /*[2:0] tab0_bpf0_gain value when gain index is 4 */
      __IOM uint32_t              : 1;           /*[3] Reserved */
      __IOM uint32_t tab0_bpf1_gain4 : 3;           /*[6:4] tab0_bpf1_gain value when gain index is 4 */
      __IOM uint32_t              : 1;           /*[7] Reserved */
      __IOM uint32_t tab0_bpf0_gain5 : 3;           /*[10:8] tab0_bpf0_gain value when gain index is 5 */
      __IOM uint32_t              : 1;           /*[11] Reserved */
      __IOM uint32_t tab0_bpf1_gain5 : 3;           /*[14:12] tab0_bpf1_gain value when gain index is 5 */
      __IOM uint32_t              : 1;           /*[15] Reserved */
      __IOM uint32_t tab0_bpf0_gain6 : 3;           /*[18:16] tab0_bpf0_gain value when gain index is 6 */
      __IOM uint32_t              : 1;           /*[19] Reserved */
      __IOM uint32_t tab0_bpf1_gain6 : 3;           /*[22:20] tab0_bpf1_gain value when gain index is 6 */
      __IOM uint32_t              : 1;           /*[23] Reserved */
      __IOM uint32_t tab0_bpf0_gain7 : 3;           /*[26:24] tab0_bpf0_gain value when gain index is 7 */
      __IOM uint32_t              : 1;           /*[27] Reserved */
      __IOM uint32_t tab0_bpf1_gain7 : 3;           /*[30:28] tab0_bpf1_gain value when gain index is 7 */
      __IOM uint32_t              : 1;           /*[31] Reserved */
    } BPF_GAINTAB0_CFG1_b;
  } ;
  union {
    __IOM uint32_t BPF_GAINTAB0_CFG2_ALL ;                 /*0x168 BPF GAIN TAB0 Configuration Register2 */
    struct {
      __IOM uint32_t tab0_bpf0_gain8 : 3;           /*[2:0] tab0_bpf0_gain value when gain index is 8 */
      __IOM uint32_t              : 1;           /*[3] Reserved */
      __IOM uint32_t tab0_bpf1_gain8 : 3;           /*[6:4] tab0_bpf1_gain value when gain index is 8 */
      __IOM uint32_t              : 1;           /*[7] Reserved */
      __IOM uint32_t tab0_bpf0_gain9 : 3;           /*[10:8] tab0_bpf0_gain value when gain index is 9 */
      __IOM uint32_t              : 1;           /*[11] Reserved */
      __IOM uint32_t tab0_bpf1_gain9 : 3;           /*[14:12] tab0_bpf1_gain value when gain index is 9 */
      __IOM uint32_t              : 1;           /*[15] Reserved */
      __IOM uint32_t tab0_bpf0_gain10 : 3;           /*[18:16] tab0_bpf0_gain value when gain index is 10 */
      __IOM uint32_t              : 1;           /*[19] Reserved */
      __IOM uint32_t tab0_bpf1_gain10 : 3;           /*[22:20] tab0_bpf1_gain value when gain index is 10 */
      __IOM uint32_t              : 1;           /*[23] Reserved */
      __IOM uint32_t tab0_bpf0_gain11 : 3;           /*[26:24] tab0_bpf0_gain value when gain index is 11 */
      __IOM uint32_t              : 1;           /*[27] Reserved */
      __IOM uint32_t tab0_bpf1_gain11 : 3;           /*[30:28] tab0_bpf1_gain value when gain index is 11 */
      __IOM uint32_t              : 1;           /*[31] Reserved */
    } BPF_GAINTAB0_CFG2_b;
  } ;
  union {
    __IOM uint32_t BPF_GAINTAB0_CFG3_ALL ;                 /*0x16C BPF GAIN TAB0 Configuration Register3 */
    struct {
      __IOM uint32_t tab0_bpf0_gain12 : 3;           /*[2:0] tab0_bpf0_gain value when gain index is 12 */
      __IOM uint32_t              : 1;           /*[3] Reserved */
      __IOM uint32_t tab0_bpf1_gain12 : 3;           /*[6:4] tab0_bpf1_gain value when gain index is 12 */
      __IOM uint32_t              : 1;           /*[7] Reserved */
      __IOM uint32_t tab0_bpf0_gain13 : 3;           /*[10:8] tab0_bpf0_gain value when gain index is 13 */
      __IOM uint32_t              : 1;           /*[11] Reserved */
      __IOM uint32_t tab0_bpf1_gain13 : 3;           /*[14:12] tab0_bpf1_gain value when gain index is 13 */
      __IOM uint32_t              : 1;           /*[15] Reserved */
      __IOM uint32_t tab0_bpf0_gain14 : 3;           /*[18:16] tab0_bpf0_gain value when gain index is 14 */
      __IOM uint32_t              : 1;           /*[19] Reserved */
      __IOM uint32_t tab0_bpf1_gain14 : 3;           /*[22:20] tab0_bpf1_gain value when gain index is 14 */
      __IOM uint32_t              : 1;           /*[23] Reserved */
      __IOM uint32_t tab0_bpf0_gain15 : 3;           /*[26:24] tab0_bpf0_gain value when gain index is 15 */
      __IOM uint32_t              : 1;           /*[27] Reserved */
      __IOM uint32_t tab0_bpf1_gain15 : 3;           /*[30:28] tab0_bpf1_gain value when gain index is 15 */
      __IOM uint32_t              : 1;           /*[31] Reserved */
    } BPF_GAINTAB0_CFG3_b;
  } ;
  union {
    __IOM uint32_t BPF_GAINTAB0_CFG4_ALL ;                 /*0x170 BPF GAIN TAB0 Configuration Register4 */
    struct {
      __IOM uint32_t tab0_bpf0_gain16 : 3;           /*[2:0] tab0_bpf0_gain value when gain index is 16 */
      __IOM uint32_t              : 1;           /*[3] Reserved */
      __IOM uint32_t tab0_bpf1_gain16 : 3;           /*[6:4] tab0_bpf1_gain value when gain index is 16 */
      __IOM uint32_t              : 1;           /*[7] Reserved */
      __IOM uint32_t tab0_bpf0_gain17 : 3;           /*[10:8] tab0_bpf0_gain value when gain index is 17 */
      __IOM uint32_t              : 1;           /*[11] Reserved */
      __IOM uint32_t tab0_bpf1_gain17 : 3;           /*[14:12] tab0_bpf1_gain value when gain index is 17 */
      __IOM uint32_t              : 1;           /*[15] Reserved */
      __IOM uint32_t tab0_bpf0_gain18 : 3;           /*[18:16] tab0_bpf0_gain value when gain index is 18 */
      __IOM uint32_t              : 1;           /*[19] Reserved */
      __IOM uint32_t tab0_bpf1_gain18 : 3;           /*[22:20] tab0_bpf1_gain value when gain index is 18 */
      __IOM uint32_t              : 1;           /*[23] Reserved */
      __IOM uint32_t tab0_bpf0_gain19 : 3;           /*[26:24] tab0_bpf0_gain value when gain index is 19 */
      __IOM uint32_t              : 1;           /*[27] Reserved */
      __IOM uint32_t tab0_bpf1_gain19 : 3;           /*[30:28] tab0_bpf1_gain value when gain index is 19 */
      __IOM uint32_t              : 1;           /*[31] Reserved */
    } BPF_GAINTAB0_CFG4_b;
  } ;
  union {
    __IOM uint32_t BPF_GAINTAB0_CFG5_ALL ;                 /*0x174 BPF GAIN TAB0 Configuration Register5 */
    struct {
      __IOM uint32_t tab0_bpf0_gain20 : 3;           /*[2:0] tab0_bpf0_gain value when gain index is 20 */
      __IOM uint32_t              : 1;           /*[3] Reserved */
      __IOM uint32_t tab0_bpf1_gain20 : 3;           /*[6:4] tab0_bpf1_gain value when gain index is 20 */
      __IOM uint32_t              : 1;           /*[7] Reserved */
      __IOM uint32_t tab0_bpf0_gain21 : 3;           /*[10:8] tab0_bpf0_gain value when gain index is 21 */
      __IOM uint32_t              : 1;           /*[11] Reserved */
      __IOM uint32_t tab0_bpf1_gain21 : 3;           /*[14:12] tab0_bpf1_gain value when gain index is 21 */
      __IOM uint32_t              : 1;           /*[15] Reserved */
      __IOM uint32_t tab0_bpf0_gain22 : 3;           /*[18:16] tab0_bpf0_gain value when gain index is 22 */
      __IOM uint32_t              : 1;           /*[19] Reserved */
      __IOM uint32_t tab0_bpf1_gain22 : 3;           /*[22:20] tab0_bpf1_gain value when gain index is 22 */
      __IOM uint32_t              : 1;           /*[23] Reserved */
      __IOM uint32_t tab0_bpf0_gain23 : 3;           /*[26:24] tab0_bpf0_gain value when gain index is 23 */
      __IOM uint32_t              : 1;           /*[27] Reserved */
      __IOM uint32_t tab0_bpf1_gain23 : 3;           /*[30:28] tab0_bpf1_gain value when gain index is 23 */
      __IOM uint32_t              : 1;           /*[31] Reserved */
    } BPF_GAINTAB0_CFG5_b;
  } ;
  union {
    __IOM uint32_t BPF_GAINTAB0_CFG6_ALL ;                 /*0x178 BPF GAIN TAB0 Configuration Register6 */
    struct {
      __IOM uint32_t tab0_bpf0_gain24 : 3;           /*[2:0] tab0_bpf0_gain value when gain index is 24 */
      __IOM uint32_t              : 1;           /*[3] Reserved */
      __IOM uint32_t tab0_bpf1_gain24 : 3;           /*[6:4] tab0_bpf1_gain value when gain index is 24 */
      __IOM uint32_t              : 1;           /*[7] Reserved */
      __IOM uint32_t tab0_bpf0_gain25 : 3;           /*[10:8] tab0_bpf0_gain value when gain index is 25 */
      __IOM uint32_t              : 1;           /*[11] Reserved */
      __IOM uint32_t tab0_bpf1_gain25 : 3;           /*[14:12] tab0_bpf1_gain value when gain index is 25 */
      __IOM uint32_t              : 1;           /*[15] Reserved */
      __IOM uint32_t tab0_bpf0_gain26 : 3;           /*[18:16] tab0_bpf0_gain value when gain index is 26 */
      __IOM uint32_t              : 1;           /*[19] Reserved */
      __IOM uint32_t tab0_bpf1_gain26 : 3;           /*[22:20] tab0_bpf1_gain value when gain index is 26 */
      __IOM uint32_t              : 1;           /*[23] Reserved */
      __IOM uint32_t tab0_bpf0_gain27 : 3;           /*[26:24] tab0_bpf0_gain value when gain index is 27 */
      __IOM uint32_t              : 1;           /*[27] Reserved */
      __IOM uint32_t tab0_bpf1_gain27 : 3;           /*[30:28] tab0_bpf1_gain value when gain index is 27 */
      __IOM uint32_t              : 1;           /*[31] Reserved */
    } BPF_GAINTAB0_CFG6_b;
  } ;
  union {
    __IOM uint32_t BPF_GAINTAB0_CFG7_ALL ;                 /*0x17C BPF GAIN TAB0 Configuration Register7 */
    struct {
      __IOM uint32_t tab0_bpf0_gain28 : 3;           /*[2:0] tab0_bpf0_gain value when gain index is 28 */
      __IOM uint32_t              : 1;           /*[3] Reserved */
      __IOM uint32_t tab0_bpf1_gain28 : 3;           /*[6:4] tab0_bpf1_gain value when gain index is 28 */
      __IOM uint32_t              : 1;           /*[7] Reserved */
      __IOM uint32_t tab0_bpf0_gain29 : 3;           /*[10:8] tab0_bpf0_gain value when gain index is 29 */
      __IOM uint32_t              : 1;           /*[11] Reserved */
      __IOM uint32_t tab0_bpf1_gain29 : 3;           /*[14:12] tab0_bpf1_gain value when gain index is 29 */
      __IOM uint32_t              : 1;           /*[15] Reserved */
      __IOM uint32_t tab0_bpf0_gain30 : 3;           /*[18:16] tab0_bpf0_gain value when gain index is 30 */
      __IOM uint32_t              : 1;           /*[19] Reserved */
      __IOM uint32_t tab0_bpf1_gain30 : 3;           /*[22:20] tab0_bpf1_gain value when gain index is 30 */
      __IOM uint32_t              : 1;           /*[23] Reserved */
      __IOM uint32_t tab0_bpf0_gain31 : 3;           /*[26:24] tab0_bpf0_gain value when gain index is 31 */
      __IOM uint32_t              : 1;           /*[27] Reserved */
      __IOM uint32_t tab0_bpf1_gain31 : 3;           /*[30:28] tab0_bpf1_gain value when gain index is 31 */
      __IOM uint32_t              : 1;           /*[31] Reserved */
    } BPF_GAINTAB0_CFG7_b;
  } ;
  union {
    __IOM uint32_t BPF_GAINTAB0_CFG8_ALL ;                 /*0x180 BPF GAIN TAB0 Configuration Register8 */
    struct {
      __IOM uint32_t tab0_bpf0_gain32 : 3;           /*[2:0] tab0_bpf0_gain value when gain index is 32 */
      __IOM uint32_t              : 1;           /*[3] Reserved */
      __IOM uint32_t tab0_bpf1_gain32 : 3;           /*[6:4] tab0_bpf1_gain value when gain index is 32 */
      __IOM uint32_t              : 1;           /*[7] Reserved */
      __IOM uint32_t tab0_bpf0_gain33 : 3;           /*[10:8] tab0_bpf0_gain value when gain index is 33 */
      __IOM uint32_t              : 1;           /*[11] Reserved */
      __IOM uint32_t tab0_bpf1_gain33 : 3;           /*[14:12] tab0_bpf1_gain value when gain index is 33 */
      __IOM uint32_t              : 1;           /*[15] Reserved */
      __IOM uint32_t tab0_bpf0_gain34 : 3;           /*[18:16] tab0_bpf0_gain value when gain index is 34 */
      __IOM uint32_t              : 1;           /*[19] Reserved */
      __IOM uint32_t tab0_bpf1_gain34 : 3;           /*[22:20] tab0_bpf1_gain value when gain index is 34 */
      __IOM uint32_t              : 1;           /*[23] Reserved */
      __IOM uint32_t tab0_bpf0_gain35 : 3;           /*[26:24] tab0_bpf0_gain value when gain index is 35 */
      __IOM uint32_t              : 1;           /*[27] Reserved */
      __IOM uint32_t tab0_bpf1_gain35 : 3;           /*[30:28] tab0_bpf1_gain value when gain index is 35 */
      __IOM uint32_t              : 1;           /*[31] Reserved */
    } BPF_GAINTAB0_CFG8_b;
  } ;
  union {
    __IOM uint32_t BPF_GAINTAB0_CFG9_ALL ;                 /*0x184 BPF GAIN TAB0 Configuration Register9 */
    struct {
      __IOM uint32_t tab0_bpf0_gain36 : 3;           /*[2:0] tab0_bpf0_gain value when gain index is 36 */
      __IOM uint32_t              : 1;           /*[3] Reserved */
      __IOM uint32_t tab0_bpf1_gain36 : 3;           /*[6:4] tab0_bpf1_gain value when gain index is 36 */
      __IOM uint32_t              : 1;           /*[7] Reserved */
      __IOM uint32_t tab0_bpf0_gain37 : 3;           /*[10:8] tab0_bpf0_gain value when gain index is 37 */
      __IOM uint32_t              : 1;           /*[11] Reserved */
      __IOM uint32_t tab0_bpf1_gain37 : 3;           /*[14:12] tab0_bpf1_gain value when gain index is 37 */
      __IOM uint32_t              : 1;           /*[15] Reserved */
      __IOM uint32_t tab0_bpf0_gain38 : 3;           /*[18:16] tab0_bpf0_gain value when gain index is 38 */
      __IOM uint32_t              : 1;           /*[19] Reserved */
      __IOM uint32_t tab0_bpf1_gain38 : 3;           /*[22:20] tab0_bpf1_gain value when gain index is 38 */
      __IOM uint32_t              : 1;           /*[23] Reserved */
      __IOM uint32_t tab0_bpf0_gain39 : 3;           /*[26:24] tab0_bpf0_gain value when gain index is 39 */
      __IOM uint32_t              : 1;           /*[27] Reserved */
      __IOM uint32_t tab0_bpf1_gain39 : 3;           /*[30:28] tab0_bpf1_gain value when gain index is 39 */
      __IOM uint32_t              : 1;           /*[31] Reserved */
    } BPF_GAINTAB0_CFG9_b;
  } ;
  union {
    __IOM uint32_t BPF_GAINTAB0_CFG10_ALL ;                 /*0x188 BPF GAIN TAB0 Configuration Register10 */
    struct {
      __IOM uint32_t tab0_bpf0_gain40 : 3;           /*[2:0] tab0_bpf0_gain value when gain index is 40 */
      __IOM uint32_t              : 1;           /*[3] Reserved */
      __IOM uint32_t tab0_bpf1_gain40 : 3;           /*[6:4] tab0_bpf1_gain value when gain index is 40 */
      __IOM uint32_t              : 1;           /*[7] Reserved */
      __IOM uint32_t tab0_bpf0_gain41 : 3;           /*[10:8] tab0_bpf0_gain value when gain index is 41 */
      __IOM uint32_t              : 1;           /*[11] Reserved */
      __IOM uint32_t tab0_bpf1_gain41 : 3;           /*[14:12] tab0_bpf1_gain value when gain index is 41 */
      __IOM uint32_t              : 17;           /*[31:15] Reserved */
    } BPF_GAINTAB0_CFG10_b;
  } ;
  union {
    __IOM uint32_t BPF_GAINTAB1_CFG0_ALL ;                 /*0x18C BPF GAIN TAB1 Configuration Register0 */
    struct {
      __IOM uint32_t tab1_bpf0_gain0 : 3;           /*[2:0] tab1_bpf0_gain value when gain index is 0 */
      __IOM uint32_t              : 1;           /*[3] Reserved */
      __IOM uint32_t tab1_bpf1_gain0 : 3;           /*[6:4] tab1_bpf1_gain value when gain index is 0 */
      __IOM uint32_t              : 1;           /*[7] Reserved */
      __IOM uint32_t tab1_bpf0_gain1 : 3;           /*[10:8] tab1_bpf0_gain value when gain index is 1 */
      __IOM uint32_t              : 1;           /*[11] Reserved */
      __IOM uint32_t tab1_bpf1_gain1 : 3;           /*[14:12] tab1_bpf1_gain value when gain index is 1 */
      __IOM uint32_t              : 1;           /*[15] Reserved */
      __IOM uint32_t tab1_bpf0_gain2 : 3;           /*[18:16] tab1_bpf0_gain value when gain index is 2 */
      __IOM uint32_t              : 1;           /*[19] Reserved */
      __IOM uint32_t tab1_bpf1_gain2 : 3;           /*[22:20] tab1_bpf1_gain value when gain index is 2 */
      __IOM uint32_t              : 1;           /*[23] Reserved */
      __IOM uint32_t tab1_bpf0_gain3 : 3;           /*[26:24] tab1_bpf0_gain value when gain index is 3 */
      __IOM uint32_t              : 1;           /*[27] Reserved */
      __IOM uint32_t tab1_bpf1_gain3 : 3;           /*[30:28] tab1_bpf1_gain value when gain index is 3 */
      __IOM uint32_t              : 1;           /*[31] Reserved */
    } BPF_GAINTAB1_CFG0_b;
  } ;
  union {
    __IOM uint32_t BPF_GAINTAB1_CFG1_ALL ;                 /*0x190 BPF GAIN TAB1 Configuration Register1 */
    struct {
      __IOM uint32_t tab1_bpf0_gain4 : 3;           /*[2:0] tab1_bpf0_gain value when gain index is 4 */
      __IOM uint32_t              : 1;           /*[3] Reserved */
      __IOM uint32_t tab1_bpf1_gain4 : 3;           /*[6:4] tab1_bpf1_gain value when gain index is 4 */
      __IOM uint32_t              : 1;           /*[7] Reserved */
      __IOM uint32_t tab1_bpf0_gain5 : 3;           /*[10:8] tab1_bpf0_gain value when gain index is 5 */
      __IOM uint32_t              : 1;           /*[11] Reserved */
      __IOM uint32_t tab1_bpf1_gain5 : 3;           /*[14:12] tab1_bpf1_gain value when gain index is 5 */
      __IOM uint32_t              : 1;           /*[15] Reserved */
      __IOM uint32_t tab1_bpf0_gain6 : 3;           /*[18:16] tab1_bpf0_gain value when gain index is 6 */
      __IOM uint32_t              : 1;           /*[19] Reserved */
      __IOM uint32_t tab1_bpf1_gain6 : 3;           /*[22:20] tab1_bpf1_gain value when gain index is 6 */
      __IOM uint32_t              : 1;           /*[23] Reserved */
      __IOM uint32_t tab1_bpf0_gain7 : 3;           /*[26:24] tab1_bpf0_gain value when gain index is 7 */
      __IOM uint32_t              : 1;           /*[27] Reserved */
      __IOM uint32_t tab1_bpf1_gain7 : 3;           /*[30:28] tab1_bpf1_gain value when gain index is 7 */
      __IOM uint32_t              : 1;           /*[31] Reserved */
    } BPF_GAINTAB1_CFG1_b;
  } ;
  union {
    __IOM uint32_t BPF_GAINTAB1_CFG2_ALL ;                 /*0x194 BPF GAIN TAB1 Configuration Register2 */
    struct {
      __IOM uint32_t tab1_bpf0_gain8 : 3;           /*[2:0] tab1_bpf0_gain value when gain index is 8 */
      __IOM uint32_t              : 1;           /*[3] Reserved */
      __IOM uint32_t tab1_bpf1_gain8 : 3;           /*[6:4] tab1_bpf1_gain value when gain index is 8 */
      __IOM uint32_t              : 1;           /*[7] Reserved */
      __IOM uint32_t tab1_bpf0_gain9 : 3;           /*[10:8] tab1_bpf0_gain value when gain index is 9 */
      __IOM uint32_t              : 1;           /*[11] Reserved */
      __IOM uint32_t tab1_bpf1_gain9 : 3;           /*[14:12] tab1_bpf1_gain value when gain index is 9 */
      __IOM uint32_t              : 1;           /*[15] Reserved */
      __IOM uint32_t tab1_bpf0_gain10 : 3;           /*[18:16] tab1_bpf0_gain value when gain index is 10 */
      __IOM uint32_t              : 1;           /*[19] Reserved */
      __IOM uint32_t tab1_bpf1_gain10 : 3;           /*[22:20] tab1_bpf1_gain value when gain index is 10 */
      __IOM uint32_t              : 1;           /*[23] Reserved */
      __IOM uint32_t tab1_bpf0_gain11 : 3;           /*[26:24] tab1_bpf0_gain value when gain index is 11 */
      __IOM uint32_t              : 1;           /*[27] Reserved */
      __IOM uint32_t tab1_bpf1_gain11 : 3;           /*[30:28] tab1_bpf1_gain value when gain index is 11 */
      __IOM uint32_t              : 1;           /*[31] Reserved */
    } BPF_GAINTAB1_CFG2_b;
  } ;
  union {
    __IOM uint32_t BPF_GAINTAB1_CFG3_ALL ;                 /*0x198 BPF GAIN TAB1 Configuration Register3 */
    struct {
      __IOM uint32_t tab1_bpf0_gain12 : 3;           /*[2:0] tab1_bpf0_gain value when gain index is 12 */
      __IOM uint32_t              : 1;           /*[3] Reserved */
      __IOM uint32_t tab1_bpf1_gain12 : 3;           /*[6:4] tab1_bpf1_gain value when gain index is 12 */
      __IOM uint32_t              : 1;           /*[7] Reserved */
      __IOM uint32_t tab1_bpf0_gain13 : 3;           /*[10:8] tab1_bpf0_gain value when gain index is 13 */
      __IOM uint32_t              : 1;           /*[11] Reserved */
      __IOM uint32_t tab1_bpf1_gain13 : 3;           /*[14:12] tab1_bpf1_gain value when gain index is 13 */
      __IOM uint32_t              : 1;           /*[15] Reserved */
      __IOM uint32_t tab1_bpf0_gain14 : 3;           /*[18:16] tab1_bpf0_gain value when gain index is 14 */
      __IOM uint32_t              : 1;           /*[19] Reserved */
      __IOM uint32_t tab1_bpf1_gain14 : 3;           /*[22:20] tab1_bpf1_gain value when gain index is 14 */
      __IOM uint32_t              : 1;           /*[23] Reserved */
      __IOM uint32_t tab1_bpf0_gain15 : 3;           /*[26:24] tab1_bpf0_gain value when gain index is 15 */
      __IOM uint32_t              : 1;           /*[27] Reserved */
      __IOM uint32_t tab1_bpf1_gain15 : 3;           /*[30:28] tab1_bpf1_gain value when gain index is 15 */
      __IOM uint32_t              : 1;           /*[31] Reserved */
    } BPF_GAINTAB1_CFG3_b;
  } ;
  union {
    __IOM uint32_t BPF_GAINTAB1_CFG4_ALL ;                 /*0x19C BPF GAIN TAB1 Configuration Register4 */
    struct {
      __IOM uint32_t tab1_bpf0_gain16 : 3;           /*[2:0] tab1_bpf0_gain value when gain index is 16 */
      __IOM uint32_t              : 1;           /*[3] Reserved */
      __IOM uint32_t tab1_bpf1_gain16 : 3;           /*[6:4] tab1_bpf1_gain value when gain index is 16 */
      __IOM uint32_t              : 1;           /*[7] Reserved */
      __IOM uint32_t tab1_bpf0_gain17 : 3;           /*[10:8] tab1_bpf0_gain value when gain index is 17 */
      __IOM uint32_t              : 1;           /*[11] Reserved */
      __IOM uint32_t tab1_bpf1_gain17 : 3;           /*[14:12] tab1_bpf1_gain value when gain index is 17 */
      __IOM uint32_t              : 1;           /*[15] Reserved */
      __IOM uint32_t tab1_bpf0_gain18 : 3;           /*[18:16] tab1_bpf0_gain value when gain index is 18 */
      __IOM uint32_t              : 1;           /*[19] Reserved */
      __IOM uint32_t tab1_bpf1_gain18 : 3;           /*[22:20] tab1_bpf1_gain value when gain index is 18 */
      __IOM uint32_t              : 1;           /*[23] Reserved */
      __IOM uint32_t tab1_bpf0_gain19 : 3;           /*[26:24] tab1_bpf0_gain value when gain index is 19 */
      __IOM uint32_t              : 1;           /*[27] Reserved */
      __IOM uint32_t tab1_bpf1_gain19 : 3;           /*[30:28] tab1_bpf1_gain value when gain index is 19 */
      __IOM uint32_t              : 1;           /*[31] Reserved */
    } BPF_GAINTAB1_CFG4_b;
  } ;
  union {
    __IOM uint32_t BPF_GAINTAB1_CFG5_ALL ;                 /*0x1A0 BPF GAIN TAB1 Configuration Register5 */
    struct {
      __IOM uint32_t tab1_bpf0_gain20 : 3;           /*[2:0] tab1_bpf0_gain value when gain index is 20 */
      __IOM uint32_t              : 1;           /*[3] Reserved */
      __IOM uint32_t tab1_bpf1_gain20 : 3;           /*[6:4] tab1_bpf1_gain value when gain index is 20 */
      __IOM uint32_t              : 1;           /*[7] Reserved */
      __IOM uint32_t tab1_bpf0_gain21 : 3;           /*[10:8] tab1_bpf0_gain value when gain index is 21 */
      __IOM uint32_t              : 1;           /*[11] Reserved */
      __IOM uint32_t tab1_bpf1_gain21 : 3;           /*[14:12] tab1_bpf1_gain value when gain index is 21 */
      __IOM uint32_t              : 1;           /*[15] Reserved */
      __IOM uint32_t tab1_bpf0_gain22 : 3;           /*[18:16] tab1_bpf0_gain value when gain index is 22 */
      __IOM uint32_t              : 1;           /*[19] Reserved */
      __IOM uint32_t tab1_bpf1_gain22 : 3;           /*[22:20] tab1_bpf1_gain value when gain index is 22 */
      __IOM uint32_t              : 1;           /*[23] Reserved */
      __IOM uint32_t tab1_bpf0_gain23 : 3;           /*[26:24] tab1_bpf0_gain value when gain index is 23 */
      __IOM uint32_t              : 1;           /*[27] Reserved */
      __IOM uint32_t tab1_bpf1_gain23 : 3;           /*[30:28] tab1_bpf1_gain value when gain index is 23 */
      __IOM uint32_t              : 1;           /*[31] Reserved */
    } BPF_GAINTAB1_CFG5_b;
  } ;
  union {
    __IOM uint32_t BPF_GAINTAB1_CFG6_ALL ;                 /*0x1A4 BPF GAIN TAB1 Configuration Register6 */
    struct {
      __IOM uint32_t tab1_bpf0_gain24 : 3;           /*[2:0] tab1_bpf0_gain value when gain index is 24 */
      __IOM uint32_t              : 1;           /*[3] Reserved */
      __IOM uint32_t tab1_bpf1_gain24 : 3;           /*[6:4] tab1_bpf1_gain value when gain index is 24 */
      __IOM uint32_t              : 1;           /*[7] Reserved */
      __IOM uint32_t tab1_bpf0_gain25 : 3;           /*[10:8] tab1_bpf0_gain value when gain index is 25 */
      __IOM uint32_t              : 1;           /*[11] Reserved */
      __IOM uint32_t tab1_bpf1_gain25 : 3;           /*[14:12] tab1_bpf1_gain value when gain index is 25 */
      __IOM uint32_t              : 1;           /*[15] Reserved */
      __IOM uint32_t tab1_bpf0_gain26 : 3;           /*[18:16] tab1_bpf0_gain value when gain index is 26 */
      __IOM uint32_t              : 1;           /*[19] Reserved */
      __IOM uint32_t tab1_bpf1_gain26 : 3;           /*[22:20] tab1_bpf1_gain value when gain index is 26 */
      __IOM uint32_t              : 1;           /*[23] Reserved */
      __IOM uint32_t tab1_bpf0_gain27 : 3;           /*[26:24] tab1_bpf0_gain value when gain index is 27 */
      __IOM uint32_t              : 1;           /*[27] Reserved */
      __IOM uint32_t tab1_bpf1_gain27 : 3;           /*[30:28] tab1_bpf1_gain value when gain index is 27 */
      __IOM uint32_t              : 1;           /*[31] Reserved */
    } BPF_GAINTAB1_CFG6_b;
  } ;
  union {
    __IOM uint32_t BPF_GAINTAB1_CFG7_ALL ;                 /*0x1A8 BPF GAIN TAB1 Configuration Register7 */
    struct {
      __IOM uint32_t tab1_bpf0_gain28 : 3;           /*[2:0] tab1_bpf0_gain value when gain index is 28 */
      __IOM uint32_t              : 1;           /*[3] Reserved */
      __IOM uint32_t tab1_bpf1_gain28 : 3;           /*[6:4] tab1_bpf1_gain value when gain index is 28 */
      __IOM uint32_t              : 1;           /*[7] Reserved */
      __IOM uint32_t tab1_bpf0_gain29 : 3;           /*[10:8] tab1_bpf0_gain value when gain index is 29 */
      __IOM uint32_t              : 1;           /*[11] Reserved */
      __IOM uint32_t tab1_bpf1_gain29 : 3;           /*[14:12] tab1_bpf1_gain value when gain index is 29 */
      __IOM uint32_t              : 1;           /*[15] Reserved */
      __IOM uint32_t tab1_bpf0_gain30 : 3;           /*[18:16] tab1_bpf0_gain value when gain index is 30 */
      __IOM uint32_t              : 1;           /*[19] Reserved */
      __IOM uint32_t tab1_bpf1_gain30 : 3;           /*[22:20] tab1_bpf1_gain value when gain index is 30 */
      __IOM uint32_t              : 1;           /*[23] Reserved */
      __IOM uint32_t tab1_bpf0_gain31 : 3;           /*[26:24] tab1_bpf0_gain value when gain index is 31 */
      __IOM uint32_t              : 1;           /*[27] Reserved */
      __IOM uint32_t tab1_bpf1_gain31 : 3;           /*[30:28] tab1_bpf1_gain value when gain index is 31 */
      __IOM uint32_t              : 1;           /*[31] Reserved */
    } BPF_GAINTAB1_CFG7_b;
  } ;
  union {
    __IOM uint32_t BPF_GAINTAB1_CFG8_ALL ;                 /*0x1AC BPF GAIN TAB1 Configuration Register8 */
    struct {
      __IOM uint32_t tab1_bpf0_gain32 : 3;           /*[2:0] tab1_bpf0_gain value when gain index is 32 */
      __IOM uint32_t              : 1;           /*[3] Reserved */
      __IOM uint32_t tab1_bpf1_gain32 : 3;           /*[6:4] tab1_bpf1_gain value when gain index is 32 */
      __IOM uint32_t              : 1;           /*[7] Reserved */
      __IOM uint32_t tab1_bpf0_gain33 : 3;           /*[10:8] tab1_bpf0_gain value when gain index is 33 */
      __IOM uint32_t              : 1;           /*[11] Reserved */
      __IOM uint32_t tab1_bpf1_gain33 : 3;           /*[14:12] tab1_bpf1_gain value when gain index is 33 */
      __IOM uint32_t              : 1;           /*[15] Reserved */
      __IOM uint32_t tab1_bpf0_gain34 : 3;           /*[18:16] tab1_bpf0_gain value when gain index is 34 */
      __IOM uint32_t              : 1;           /*[19] Reserved */
      __IOM uint32_t tab1_bpf1_gain34 : 3;           /*[22:20] tab1_bpf1_gain value when gain index is 34 */
      __IOM uint32_t              : 1;           /*[23] Reserved */
      __IOM uint32_t tab1_bpf0_gain35 : 3;           /*[26:24] tab1_bpf0_gain value when gain index is 35 */
      __IOM uint32_t              : 1;           /*[27] Reserved */
      __IOM uint32_t tab1_bpf1_gain35 : 3;           /*[30:28] tab1_bpf1_gain value when gain index is 35 */
      __IOM uint32_t              : 1;           /*[31] Reserved */
    } BPF_GAINTAB1_CFG8_b;
  } ;
  union {
    __IOM uint32_t BPF_GAINTAB1_CFG9_ALL ;                 /*0x1B0 BPF GAIN TAB1 Configuration Register9 */
    struct {
      __IOM uint32_t tab1_bpf0_gain36 : 3;           /*[2:0] tab1_bpf0_gain value when gain index is 36 */
      __IOM uint32_t              : 1;           /*[3] Reserved */
      __IOM uint32_t tab1_bpf1_gain36 : 3;           /*[6:4] tab1_bpf1_gain value when gain index is 36 */
      __IOM uint32_t              : 1;           /*[7] Reserved */
      __IOM uint32_t tab1_bpf0_gain37 : 3;           /*[10:8] tab1_bpf0_gain value when gain index is 37 */
      __IOM uint32_t              : 1;           /*[11] Reserved */
      __IOM uint32_t tab1_bpf1_gain37 : 3;           /*[14:12] tab1_bpf1_gain value when gain index is 37 */
      __IOM uint32_t              : 1;           /*[15] Reserved */
      __IOM uint32_t tab1_bpf0_gain38 : 3;           /*[18:16] tab1_bpf0_gain value when gain index is 38 */
      __IOM uint32_t              : 1;           /*[19] Reserved */
      __IOM uint32_t tab1_bpf1_gain38 : 3;           /*[22:20] tab1_bpf1_gain value when gain index is 38 */
      __IOM uint32_t              : 1;           /*[23] Reserved */
      __IOM uint32_t tab1_bpf0_gain39 : 3;           /*[26:24] tab1_bpf0_gain value when gain index is 39 */
      __IOM uint32_t              : 1;           /*[27] Reserved */
      __IOM uint32_t tab1_bpf1_gain39 : 3;           /*[30:28] tab1_bpf1_gain value when gain index is 39 */
      __IOM uint32_t              : 1;           /*[31] Reserved */
    } BPF_GAINTAB1_CFG9_b;
  } ;
  union {
    __IOM uint32_t BPF_GAINTAB1_CFG10_ALL ;                 /*0x1B4 BPF GAIN TAB1 Configuration Register10 */
    struct {
      __IOM uint32_t tab1_bpf0_gain40 : 3;           /*[2:0] tab1_bpf0_gain value when gain index is 40 */
      __IOM uint32_t              : 1;           /*[3] Reserved */
      __IOM uint32_t tab1_bpf1_gain40 : 3;           /*[6:4] tab1_bpf1_gain value when gain index is 40 */
      __IOM uint32_t              : 1;           /*[7] Reserved */
      __IOM uint32_t tab1_bpf0_gain41 : 3;           /*[10:8] tab1_bpf0_gain value when gain index is 41 */
      __IOM uint32_t              : 1;           /*[11] Reserved */
      __IOM uint32_t tab1_bpf1_gain41 : 3;           /*[14:12] tab1_bpf1_gain value when gain index is 41 */
      __IOM uint32_t              : 17;           /*[31:15] Reserved */
    } BPF_GAINTAB1_CFG10_b;
  } ;
  union {
    __IOM uint32_t TGT_P_CFG0_ALL ;                 /*0x1B8 AGC_TGT_P configuration register0 */
    struct {
      __IOM uint32_t agc_target_p0 : 16;           /*[15:0] agc target_p0 value */
      __IOM uint32_t agc_target_p1 : 16;           /*[31:16] agc target_p1 value */
    } TGT_P_CFG0_b;
  } ;
  union {
    __IOM uint32_t TGT_P_CFG1_ALL ;                 /*0x1BC AGC_TGT_P configuration register1 */
    struct {
      __IOM uint32_t agc_target_p2 : 16;           /*[15:0] agc target_p2 value */
      __IOM uint32_t agc_target_p3 : 16;           /*[31:16] agc target_p3 value */
    } TGT_P_CFG1_b;
  } ;
  union {
    __IOM uint32_t TGT_P_CFG2_ALL ;                 /*0x1C0 AGC_TGT_P configuration register2 */
    struct {
      __IOM uint32_t agc_target_p4 : 16;           /*[15:0] agc target_p4 value */
      __IOM uint32_t              : 16;           /*[31:16] Reserved */
    } TGT_P_CFG2_b;
  } ;
  union {
    __IOM uint32_t TGT_N_CFG0_ALL ;                 /*0x1C4 AGC_TGT_N configuration register0 */
    struct {
      __IOM uint32_t agc_target_n0 : 16;           /*[15:0] agc target_n0 value */
      __IOM uint32_t agc_target_n1 : 16;           /*[31:16] agc target_n1 value */
    } TGT_N_CFG0_b;
  } ;
  union {
    __IOM uint32_t TGT_N_CFG1_ALL ;                 /*0x1C8 AGC_TGT_N configuration register1 */
    struct {
      __IOM uint32_t agc_target_n2 : 16;           /*[15:0] agc target_n2 value */
      __IOM uint32_t agc_target_n3 : 16;           /*[31:16] agc target_n3 value */
    } TGT_N_CFG1_b;
  } ;
  union {
    __IOM uint32_t TGT_N_CFG2_ALL ;                 /*0x1CC AGC_TGT_N configuration register2 */
    struct {
      __IOM uint32_t agc_target_n4 : 16;           /*[15:0] agc target_n4 value */
      __IOM uint32_t              : 16;           /*[31:16] Reserved */
    } TGT_N_CFG2_b;
  } ;
} dfe_ext_Type; 

typedef struct { /* hrf_afe_regs */
  union {
    __IOM uint32_t RFTOPCR0_ALL ;                 /*0x0 RF Top Controll Register 0 */
    struct {
      __IOM uint32_t DA_BG_ZT_CAL_I : 7;           /*[6:0] TBD */
      __IOM uint32_t DA_BG_RCAL_EN : 1;           /*[7] TBD */
      __IOM uint32_t DA_BG_PTAT_CAL_I : 7;           /*[14:8] TBD */
      __IOM uint32_t DA_BG_EN : 1;           /*[15] TBD */
      __IOM uint32_t RG_BG_TR : 4;           /*[19:16] TBD */
      __IOM uint32_t RG_BG_IOUT_SEL : 1;           /*[20] TBD */
      __IOM uint32_t              : 11;           /*[31:21] Reserved */
    } RFTOPCR0_b;
  } ;
  union {
    __IOM uint32_t RFTOPCR1_ALL ;                 /*0x4 RF Top Controll Register 1 */
    struct {
      __IOM uint32_t RG_TOP_TX_AC_TEST_I_EN : 1;           /*[0] TBD */
      __IOM uint32_t RG_TOP_RX_AC_TEST_Q_EN : 1;           /*[1] TBD */
      __IOM uint32_t RG_TOP_RX_AC_TEST_I_EN : 1;           /*[2] TBD */
      __IOM uint32_t RG_TOP_DC_TEST : 3;           /*[5:3] TBD */
      __IOM uint32_t RG_DVDD_LDO_EN : 1;           /*[6] TBD */
      __IOM uint32_t DA_RF_LDO_RST : 1;           /*[7] TBD */
      __IOM uint32_t AD_BG_RCAL_CMP_OUT : 1;           /*[8] TBD */
      __IOM uint32_t              : 23;           /*[31:9] Reserved */
    } RFTOPCR1_b;
  } ;
  union {
    __IOM uint32_t SXCR0_ALL ;                 /*0x8 SX Controll Register 0 */
    struct {
      __IOM uint32_t RG_SX_FCAL_TARGET : 16;           /*[15:0] "vco calibration target calue */
      __IOM uint32_t RG_SX_FCAL_SEL_T : 1;           /*[16] 0 manual Tcode / 1 calibration output */
      __IOM uint32_t RG_SX_FCAL_SEL_P : 1;           /*[17] 0 manual Pcode / 1 calibration output */
      __IOM uint32_t RG_SX_FCAL_MODE_SEL : 1;           /*[18] 0 Pcode cal mode / 1 Tcode cal mode */
      __IOM uint32_t RG_SX_FCAL_EN : 1;           /*[19] vco calibration trigger enable */
      __IOM uint32_t RG_SX_FCAL_DIV : 1;           /*[20] 0 DIV/8 ; 1 DIV/4 */
      __IOM uint32_t RG_SX_CP_EN : 1;           /*[21] SX CP enable */
      __IOM uint32_t DA_SX_VCO_CAL_RST_N : 1;           /*[22] SX VCO reset signal */
      __IOM uint32_t DA_SX_RST_N : 1;           /*[23] SX reset signal */
      __IOM uint32_t RG_SX_CP_UP : 4;           /*[27:24] RG_SX_CP_UP:default?0010 down?current?select?I?=?50uA+RG_SX_CP_UP*25uA */
      __IOM uint32_t RG_SX_CP_DOWN : 4;           /*[31:28] RG_SX_CP_DOWN:default 0010?down?current?select?I?=?50uA+RG_SX_CP_DOWN*25uA */
    } SXCR0_b;
  } ;
  union {
    __IOM uint32_t SXCR1_ALL ;                 /*0xC SX Controll Register 1 */
    struct {
      __IOM uint32_t RG_SX_FCAL_WINDOWTIME : 8;           /*[7:0] VCO / FCLK counting window */
      __IOM uint32_t RG_SX_FCAL_WAITIME : 8;           /*[15:8] VCO Settleing time */
      __IOM uint32_t RG_SX_FCAL_WAI4US : 8;           /*[23:16] Settling time */
      __IOM uint32_t RG_SX_FCAL_WAI1US : 8;           /*[31:24] Settling time */
    } SXCR1_b;
  } ;
  union {
    __IOM uint32_t SXCR2_ALL ;                 /*0x10 SX Controll Register 2 */
    struct {
      __IOM uint32_t RG_SX_LOG_TX_EN : 1;           /*[0] LOG TX trace enable */
      __IOM uint32_t RG_SX_LOG_RX_EN : 1;           /*[1] LOG TX trace enable */
      __IOM uint32_t RG_SX_LF_LDO_EN : 1;           /*[2] SX LF ldo enable(PFD+CP+LPF+MMD) */
      __IOM uint32_t RG_SX_LDO_FC_MAN : 1;           /*[3] LDO fast charge manual/auto */
      __IOM uint32_t RG_SX_LOG_PREDIV_PWC : 4;           /*[7:4] LOG buffer power control */
      __IOM uint32_t RG_SX_LOG_POSTDIV_PWC : 4;           /*[11:8] LOG divider power control */
      __IOM uint32_t RG_SX_LDO_VDD : 4;           /*[15:12] HF LDO VDD crtl */
      __IOM uint32_t RG_SX_LDO_FC_EN : 1;           /*[16] LDO fast charge enable  */
      __IOM uint32_t RG_SX_LDO_FC : 1;           /*[17] Ldo fast charge enable */
      __IOM uint32_t RG_SX_KVCO_SEL : 2;           /*[19:18] KVCO select sigal;  00: 30MHz/V  ;01 & 10 :40MHz/V;11:50MHz/V */
      __IOM uint32_t RG_SX_HF_LDO_EN : 1;           /*[20] SX HF ldo enable(VCO+LOG) */
      __IOM uint32_t RG_SX_FCFINISH : 1;           /*[21] VCO calibration finish signal */
      __IOM uint32_t RG_SX_CP_OFFSET : 4;           /*[25:22] RG_SX_CP_OFFSET:default?0001 down?current?select?I?=?5uA+RG_SX_CP_OFFSET*5uA */
      __IOM uint32_t              : 6;           /*[31:26] Reserved */
    } SXCR2_b;
  } ;
  union {
    __IOM uint32_t SXCR3_ALL ;                 /*0x14 SX Controll Register 3 */
    struct {
      __IOM uint32_t RG_SX_PFD_UP_SEL : 1;           /*[0] RG_SX_PFD_UP_SEL:default?0?0;?up?signal?contorl?by?timing?logic?1?,up?signal?always?off. */
      __IOM uint32_t RG_SX_PFD_PD_FLAG_SWAP : 1;           /*[1] RG_SX_PFD_FLAG_SWAP:default?0, 0:?compare?timing?of?up&dn?finished，?1?swap?the?flag?finished?signal； */
      __IOM uint32_t RG_SX_PFD_DLY_CTRL : 2;           /*[3:2] PFD dead time control  */
      __IOM uint32_t RG_SX_PD_MMD : 1;           /*[4] MMD POWER DOWN enable */
      __IOM uint32_t RG_SX_LPF_RESAMPLE_MODE : 1;           /*[5] SX lpf resample mode control */
      __IOM uint32_t RG_SX_LPF_FREF_SEL : 1;           /*[6] LPF sample clock select; 0 clock sync from cp;0 clock sync from reference clock; */
      __IOM uint32_t RG_SX_LPF_COMP_EN : 1;           /*[7] SX VCO vtune detect comparator enable */
      __IOM uint32_t RG_SX_LPF_RANGE_CTRL : 3;           /*[10:8] "SX VCO vtune voltage detect range */
      __IOM uint32_t RG_SX_LPF_R3_CTRL : 3;           /*[13:11] LPF R3 select */
      __IOM uint32_t              : 2;           /*[15:14] Reserved */
      __IOM uint32_t RG_SX_LPF_R1_CTRL : 3;           /*[18:16] LPF R1 select */
      __IOM uint32_t RG_SX_LPF_C3_CTRL : 3;           /*[21:19] LPF C2 select */
      __IOM uint32_t              : 2;           /*[23:22] Reserved */
      __IOM uint32_t RG_SX_LPF_C2_CTRL : 3;           /*[26:24] LPF C2 select */
      __IOM uint32_t RG_SX_LPF_C1_CTRL : 3;           /*[29:27] LPF C1 select */
      __IOM uint32_t              : 2;           /*[31:30] Reserved */
    } SXCR3_b;
  } ;
  union {
    __IOM uint32_t SXCR4_ALL ;                 /*0x18 SX Controll Register 4 */
    struct {
      __IOM uint32_t RG_SX_SDM_INT : 11;           /*[10:0] MMD divider ration (fvco=25M*(INT+FRAC)) */
      __IOM uint32_t RG_SX_VAR_DC : 2;           /*[12:11] "SX VCO var commen dc voltage control */
      __IOM uint32_t RG_SX_SDM_FRAC_SEL : 2;           /*[14:13] 00 1mode */
      __IOM uint32_t RG_SX_SDM_FRAC_EN : 1;           /*[15] SDM frac enable */
      __IOM uint32_t RG_SX_RSV : 16;           /*[31:16] resevert bit */
    } SXCR4_b;
  } ;
  union {
    __IOM uint32_t SXCR5_ALL ;                 /*0x1C SX Controll Register 5 */
    struct {
      __IOM uint32_t RG_SX_SDM_FRAC : 28;           /*[27:0] MMD divider ratio frac part */
      __IOM uint32_t RG_SX_SDM_EN : 1;           /*[28] SDM ENABLE */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } SXCR5_b;
  } ;
  union {
    __IOM uint32_t SXCR6_ALL ;                 /*0x20 SX Controll Register 6 */
    struct {
      __IOM uint32_t RG_SX_VCOC_T : 5;           /*[4:0] vco Tcode manual inout */
      __IOM uint32_t RG_SX_VCO_EN : 1;           /*[5] SX_VCO enable */
      __IOM uint32_t RG_SX_VCO_CAL_SCANMODE : 1;           /*[6] calibration scanmode */
      __IOM uint32_t RG_SX_VCO_BUFFER_EN : 1;           /*[7] SX VCO BUFFER enable */
      __IOM uint32_t RG_SX_VCOC_P : 7;           /*[14:8] vco Pcode manual inout */
      __IOM uint32_t RG_SX_VAR_EN : 1;           /*[15] SX vco var enable */
      __IOM uint32_t RG_SX_VCO_PWC : 4;           /*[19:16] SX VCO vdd control */
      __IOM uint32_t RG_SX_VCO_BUFFER_PWC : 4;           /*[23:20] SX VCO BUFFER vdd control */
      __IOM uint32_t              : 8;           /*[31:24] Reserved */
    } SXCR6_b;
  } ;
  union {
    __IOM uint32_t SXCR7_ALL ;                 /*0x24 SX Controll Register 7 */
    struct {
      __IOM uint32_t RO_VCO_CAL_ST : 3;           /*[2:0] VCO calibration state signal */
      __IOM uint32_t RO_DA_SX_VCOC_T : 5;           /*[7:3] Tcode read out */
      __IOM uint32_t RO_DA_SX_VCOC_P : 7;           /*[14:8] Pcode Read out */
      __IOM uint32_t RO_SX_LPF_RANGE_STATE : 1;           /*[15] Vctrl voltage flag, 0:out range of work section; 1: in range of work section */
      __IOM uint32_t RO_SX_LPF_RANGE_L : 1;           /*[16] Vctrl voltage flag, 0:down to low voltage; 1: high to low voltage */
      __IOM uint32_t RO_SX_LPF_RANGE_H : 1;           /*[17] Vctrl voltage flag, 0:up to high voltage; 1: low to high voltage */
      __IOM uint32_t              : 14;           /*[31:18] Reserved */
    } SXCR7_b;
  } ;
  union {
    __IOM uint32_t TXCR0_ALL ;                 /*0x28 TX Controll Register 0 */
    struct {
      __IOM uint32_t RG_TX_CAL_EN : 1;           /*[0] TX Cal Enable */
      __IOM uint32_t RG_TX_LDO18_EN : 1;           /*[1] TX LDO18 EN */
      __IOM uint32_t RG_TX_LDO_VSEL : 2;           /*[3:2] TX LDO12 VOUT Control */
      __IOM uint32_t RG_TX_IQDECT_GAIN : 4;           /*[7:4] TX IQDECT gain control */
      __IOM uint32_t RG_TX_IQDECT_EN : 1;           /*[8] TX IQDECT enable signal，1：open；0：closed */
      __IOM uint32_t RG_TX_IBIAS_MIX_VCM_EN : 1;           /*[9] TX MIX BIAS enable signal，1：open；0：closed */
      __IOM uint32_t RG_TX_HPPA_VCM : 6;           /*[15:10] TX HPPA VCM voltage control */
      __IOM uint32_t RG_TX_HPPA_CTANK : 3;           /*[18:16] TX HPPA Cap control */
      __IOM uint32_t DA_TX_HPPA_GAIN : 5;           /*[23:19] TX HPPA  gain control,1dB per step */
      __IOM uint32_t RG_TX_LDO_EN : 1;           /*[24] TX LDO12 EN */
      __IOM uint32_t DA_TX_MIX_EN : 1;           /*[25] TX MIXER enable signal，1：open；0：closed */
      __IOM uint32_t DA_TX_IBIAS_EN : 1;           /*[26] TX BIAS enable signal，1：open；0：closed */
      __IOM uint32_t DA_TX_HPPA_EN : 1;           /*[27] TX HPPA enable control，1：open；0：closed */
      __IOM uint32_t DA_TX_EN : 1;           /*[28] TX TOP EN，1：open；0：closed */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } TXCR0_b;
  } ;
  union {
    __IOM uint32_t TXCR1_ALL ;                 /*0x2C TX Controll Register 1 */
    struct {
      __IOM uint32_t DA_TX_MIX_GAIN : 4;           /*[3:0] TX MIXER  gain control,1dB per step */
      __IOM uint32_t RG_TX_MIX_VCM : 6;           /*[9:4] TX MIXER VCM control */
      __IOM uint32_t RG_TX_MIX_VBLO : 3;           /*[12:10] TX MIXER LO VBIAS control */
      __IOM uint32_t RG_TX_MIX_LODRV_GAIN : 3;           /*[15:13] TX MIXER LO driver control */
      __IOM uint32_t RG_TX_MIX_CTANK : 5;           /*[20:16] TX MIXER cap control */
      __IOM uint32_t              : 11;           /*[31:21] Reserved */
    } TXCR1_b;
  } ;
  union {
    __IOM uint32_t TXCR2_ALL ;                 /*0x30 TX Controll Register 2 */
    struct {
      __IOM uint32_t RG_TX_TP_EN : 1;           /*[0] TX test module enable signal ,1：open；0：closed */
      __IOM uint32_t RG_TX_TP : 3;           /*[3:1] TX test point select,0,HPA VCM TEST 1:MIX VCM TEST */
      __IOM uint32_t              : 4;           /*[7:4] Reserved */
      __IOM uint32_t RG_TX_REV : 16;           /*[23:8] TX Resvered Bits */
      __IOM uint32_t              : 8;           /*[31:24] Reserved */
    } TXCR2_b;
  } ;
  union {
    __IOM uint32_t RXCR0_ALL ;                 /*0x34 RX Controll Register 0 */
    struct {
      __IOM uint32_t RG_RX_CBPF_BIQUAD_POLE_SEL : 3;           /*[2:0] CBPF中频选择 */
      __IOM uint32_t RG_RX_MIX_LOBIAS_TRIM : 4;           /*[6:3] MXR bias控制 */
      __IOM uint32_t RG_RX_IFLDO_EN : 1;           /*[7] 中频LDO开关 */
      __IOM uint32_t RG_RX_GM_ITRIM : 4;           /*[11:8] GM电流控制 */
      __IOM uint32_t RG_RX_CBPF_R4_QTRIM_2M_1M : 4;           /*[15:12] CBPF调2M_1M中频Q值 */
      __IOM uint32_t RG_RX_MIXER_TIA_C : 4;           /*[19:16] TIA BW select */
      __IOM uint32_t RG_RX_CBPF_OPA_TRIM0 : 3;           /*[22:20] CBPF OP电流trim */
      __IOM uint32_t              : 1;           /*[23] Reserved */
      __IOM uint32_t RG_RX_CBPF_OPA_TRIM1 : 3;           /*[26:24] CBPF OP电流trim */
      __IOM uint32_t RG_RX_CBPF_OPA_TRIM2 : 3;           /*[29:27] CBPF OP电流trim */
      __IOM uint32_t              : 2;           /*[31:30] Reserved */
    } RXCR0_b;
  } ;
  union {
    __IOM uint32_t RXCR1_ALL ;                 /*0x38 RX Controll Register 1 */
    struct {
      __IOM uint32_t RG_RX_CBPF_OPA_TRIM3 : 3;           /*[2:0] CBPF OP电流trim */
      __IOM uint32_t RG_RX_CBPF_OPA_TRIM4 : 3;           /*[5:3] CBPF OP电流trim */
      __IOM uint32_t RG_RX_IBIAS_FE_SW : 2;           /*[7:6] RX FE bias开关 */
      __IOM uint32_t RG_RX_CBPF_OPA_TRIM5 : 3;           /*[10:8] CBPF OP电流trim */
      __IOM uint32_t RG_RX_CBPF_DRIVER : 4;           /*[14:11] CBPF OP零点补偿及驱动 */
      __IOM uint32_t              : 9;           /*[23:15] Reserved */
      __IOM uint32_t DA_RX_CBPF_GAIN_SEL : 4;           /*[27:24] floating */
      __IOM uint32_t RG_RX_CLK_DIV : 3;           /*[30:28] TBD */
      __IOM uint32_t              : 1;           /*[31] Reserved */
    } RXCR1_b;
  } ;
  union {
    __IOM uint32_t RXCR2_ALL ;                 /*0x3C RX Controll Register 2 */
    struct {
      __IOM uint32_t RG_RX_LNA_OUTTUNE : 4;           /*[3:0] LNA输出电容调节 */
      __IOM uint32_t RG_RX_TIA_VCM_TRIM : 4;           /*[7:4] TIA VCM trim调节 */
      __IOM uint32_t RG_RX_CBPF_R4_QTRIM_500K : 4;           /*[11:8] CBPF调500K中频Q值 */
      __IOM uint32_t              : 3;           /*[14:12] Reserved */
      __IOM uint32_t RG_RX_LNA_PD_EN : 1;           /*[15] RX PEDT开关 */
      __IOM uint32_t RG_RX_IZTAT_FE_TRIM : 4;           /*[19:16] RX IZIAT校准电流trim */
      __IOM uint32_t RG_RX_MIXER_OPDGAIN : 4;           /*[23:20] MXR OPD Gain设置 */
      __IOM uint32_t RG_RX_LNA_PD_GAIN : 2;           /*[25:24] PEDT gain select */
      __IOM uint32_t RG_RX_RFLDO_EN : 1;           /*[26] 中频LDO开关 */
      __IOM uint32_t RG_RX_CBPF_BW : 3;           /*[29:27] CBPF带宽 */
      __IOM uint32_t              : 2;           /*[31:30] Reserved */
    } RXCR2_b;
  } ;
  union {
    __IOM uint32_t RXCR3_ALL ;                 /*0x40 RX Controll Register 3 */
    struct {
      __IOM uint32_t RG_RX_IPTAT_FE_TRIM : 4;           /*[3:0] RX IPTAT校准电流trim */
      __IOM uint32_t RG_RX_CBPF_RZ1_TRIM : 4;           /*[7:4] CBPF前级中频频率trim */
      __IOM uint32_t RG_RX_CBPF_ZIF_LIF : 2;           /*[9:8] CBPF带通输出开关 */
      __IOM uint32_t RG_RX_CBPF_RZ3_TRIM : 4;           /*[13:10] CBPF后级中频频率trim */
      __IOM uint32_t              : 1;           /*[14] Reserved */
      __IOM uint32_t DA_RX_EN : 1;           /*[15] TBD */
      __IOM uint32_t DA_RX_GM_EN : 1;           /*[16] TBD */
      __IOM uint32_t DA_RX_TIA_EN : 1;           /*[17] TBD */
      __IOM uint32_t DA_RX_CBPF_EN : 1;           /*[18] TBD */
      __IOM uint32_t DA_RX_IBIAS_FE_EN : 1;           /*[19] TBD */
      __IOM uint32_t DA_RX_MIXER_EN : 1;           /*[20] MXR开关 */
      __IOM uint32_t RG_RX_MANNUAMODEL_BIQUAD_C : 1;           /*[21] CBPF选择RCK or CBPF电容 */
      __IOM uint32_t AD_RX_LNA_PD_OUT : 1;           /*[22] TBD */
      __IOM uint32_t              : 9;           /*[31:23] Reserved */
    } RXCR3_b;
  } ;
  union {
    __IOM uint32_t RXCR4_ALL ;                 /*0x44 RX Controll Register 4 */
    struct {
      __IOM uint32_t RG_RX_CBPF_BIQUAD_C1 : 8;           /*[7:0] CBPF电容 */
      __IOM uint32_t RG_RX_CBPF_RZ2_TRIM : 4;           /*[11:8] CBPF二级中频频率trim */
      __IOM uint32_t RG_RX_LNA_ITRIM : 4;           /*[15:12] LNA电流调节 */
      __IOM uint32_t RG_RX_CBPF_IFSEL : 1;           /*[16] CBPF带通开关 */
      __IOM uint32_t RG_RX_CBPF_IF_SEL : 3;           /*[19:17] CBPF带通开关，1带通，0低通 */
      __IOM uint32_t RG_RX_LDO_TRIM : 4;           /*[23:20] LDO trim */
      __IOM uint32_t RG_RX_LNA_INTUNE : 3;           /*[26:24] LNA输入电容调节 */
      __IOM uint32_t RG_RX_LNA_FB_TUNE : 4;           /*[30:27] LNA反馈电阻调节 */
      __IOM uint32_t              : 1;           /*[31] Reserved */
    } RXCR4_b;
  } ;
  union {
    __IOM uint32_t RXCR5_ALL ;                 /*0x48 RX Controll Register 5 */
    struct {
      __IOM uint32_t RG_RX_RESERVE0 : 32;           /*[31:0] Reserved Bit0 */
    } RXCR5_b;
  } ;
  union {
    __IOM uint32_t ADDACR0_ALL ;                 /*0x4C ADDA Controll Register 0 */
    struct {
      __IOM uint32_t RG_DC_TIA_EN : 1;           /*[0] TBD */
      __IOM uint32_t DA_DC_DAC_EN : 1;           /*[1] TBD */
      __IOM uint32_t DA_DC_ADDA_LDO_EN : 1;           /*[2] TBD */
      __IOM uint32_t DA_DC_ADC_EN : 1;           /*[3] TBD */
      __IOM uint32_t              : 28;           /*[31:4] Reserved */
    } ADDACR0_b;
  } ;
  union {
    __IOM uint32_t ADDACR1_ALL ;                 /*0x50 ADDA Controll Register 1 */
    struct {
      __IOM uint32_t RG_DC_TIA_MUX_EN : 1;           /*[0] TBD */
      __IOM uint32_t RG_DC_TIA_DRIVER : 4;           /*[4:1] TBD */
      __IOM uint32_t RG_DC_TIA_BIAS : 2;           /*[6:5] TBD */
      __IOM uint32_t RG_DC_DEM_RSR : 1;           /*[7] TBD */
      __IOM uint32_t RG_DC_DCOCQ : 4;           /*[11:8] TBD */
      __IOM uint32_t RG_DC_DCOCI : 4;           /*[15:12] TBD */
      __IOM uint32_t RG_DC_DEM_EN : 1;           /*[16] TBD */
      __IOM uint32_t RG_DC_DCOC_EN : 1;           /*[17] TBD */
      __IOM uint32_t RG_DC_DAC_TEST_MUXQ_EN : 1;           /*[18] TBD */
      __IOM uint32_t RG_DC_DAC_TEST_MUXI_EN : 1;           /*[19] TBD */
      __IOM uint32_t RG_DC_DAC_RST : 1;           /*[20] TBD */
      __IOM uint32_t RG_DC_DAC_DELAY : 3;           /*[23:21] TBD */
      __IOM uint32_t RG_DC_DAC_LPF : 5;           /*[28:24] TBD */
      __IOM uint32_t RG_DC_DAC_GAIN_SEL : 3;           /*[31:29] TBD */
    } ADDACR1_b;
  } ;
  union {
    __IOM uint32_t ADDACR2_ALL ;                 /*0x54 ADDA Controll Register 2 */
    struct {
      __IOM uint32_t RG_DC_ADC_TEST_MUXQ_EN : 1;           /*[0] TBD */
      __IOM uint32_t RG_DC_ADC_TEST_MUXI_EN : 1;           /*[1] TBD */
      __IOM uint32_t RG_DC_ADC_LATCH_PHASE : 1;           /*[2] TBD */
      __IOM uint32_t RG_DC_ADC_LATCH_CLK_PHASE : 1;           /*[3] TBD */
      __IOM uint32_t RG_DC_ADC_DATA_SEL : 1;           /*[4] TBD */
      __IOM uint32_t RG_DC_ADC_CLKS_PHASE_SEL : 1;           /*[5] TBD */
      __IOM uint32_t RG_DC_ADC_CAL_CLK_PHASE : 1;           /*[6] TBD */
      __IOM uint32_t RG_DC_ADDA_LDO_FC : 1;           /*[7] TBD */
      __IOM uint32_t RG_DC_ADDA_RSV : 16;           /*[23:8] TBD */
      __IOM uint32_t RG_DC_ADDA_LDO_ADJ : 5;           /*[28:24] TBD */
      __IOM uint32_t RG_DC_ADDA_DC_TEST : 3;           /*[31:29] TBD */
    } ADDACR2_b;
  } ;
  union {
    __IOM uint32_t RCCALCR_ALL ;                 /*0x58 RC Calibration Controll Register */
    struct {
      __IOM uint32_t AD_RCK_OUT_DATA : 8;           /*[7:0] RCK OUTPUT CODE */
      __IOM uint32_t RCK_CAL_START : 1;           /*[8] RC Calibration Start */
      __IOM uint32_t              : 23;           /*[31:9] Reserved */
    } RCCALCR_b;
  } ;
} HRF_AFE_Type;
...
typedef struct {                                /*!< (@ 0x40500000) BPLC Structure                                             */
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t DAC_CLK_EN : 1;            /*!< [9..9] dac_clk_en                                                         */
      __IOM uint32_t ADC_CLK_EN : 1;            /*!< [10..10] adc_clk_en                                                       */
      __IM  uint32_t            : 19;
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t FSK_PHASE_UPDATE_FLAG : 1; /*!< [23..23] fsk_phase_update_flag                                            */
      __IM  uint32_t            : 1;
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t FSK_PHASE_UPDATE_INT_EN : 1;/*!< [23..23] fsk_phase_update_int_en                                         */
    } BBP_INT_EN_b;
  } ;
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t NBI_IN_OPT : 1;            /*!< [24..24] nbi_in_opt                                                       */
    } NBI_CONTROL_b;
  } ;
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t AGC_RMS_FLT_ALPH : 3;      /*!< [14..12] agc_rms_flt_alph                                                 */
      __IM  uint32_t            : 1;
  ...
  union {
    __IOM uint32_t RSV0;                        /*!< (@ 0x00000138) RSV0                                                       */
    
    struct {
      __IOM uint32_t RESERVED0  : 32;           /*!< [31..0] reserved0                                                         */
    } RSV0_b;
  } ;
  ...
  union {
    ...
    struct {
      ...
      __IM  uint32_t            : 14;
      __IOM uint32_t RX_BYPASS_1ST_STAGE : 1;   /*!< [30..30] rx_bypass_1st_stage                                              */
  ...
  union {
    __IOM uint32_t RSV1;                        /*!< (@ 0x0000019C) RSV1                                                       */
  ...
  union {
    __IOM uint32_t RSV2;                        /*!< (@ 0x000001A0) RSV2                                                       */
    
    struct {
      __IOM uint32_t RESERVED2  : 32;           /*!< [31..0] reserved2                                                         */
    } RSV2_b;
  } ;
  ...
  union {
    ...
    struct {
      __IOM uint32_t AFE_GAIN_TAB0 : 9;         /*!< [8..0] afe_gain_tab0                                                      */
      __IOM uint32_t AFE_GAIN_TAB1 : 9;         /*!< [17..9] afe_gain_tab1                                                     */
      __IOM uint32_t AFE_GAIN_TAB2 : 9;         /*!< [26..18] afe_gain_tab2                                                    */
    } AGC_TAB_CFG0_b;
  } ;
  ...
  union {
    ...
    struct {
      __IOM uint32_t AFE_GAIN_TAB3 : 9;         /*!< [8..0] afe_gain_tab3                                                      */
      __IOM uint32_t AFE_GAIN_TAB4 : 9;         /*!< [17..9] afe_gain_tab4                                                     */
      __IOM uint32_t AFE_GAIN_TAB5 : 9;         /*!< [26..18] afe_gain_tab5                                                    */
    } AGC_TAB_CFG1_b;
  } ;
  ...
  union {
    ...
    struct {
      __IOM uint32_t AFE_GAIN_TAB6 : 9;         /*!< [8..0] afe_gain_tab6                                                      */
      __IOM uint32_t AFE_GAIN_TAB7 : 9;         /*!< [17..9] afe_gain_tab7                                                     */
      __IOM uint32_t AFE_GAIN_TAB8 : 9;         /*!< [26..18] afe_gain_tab8                                                    */
    } AGC_TAB_CFG2_b;
  } ;
  ...
  union {
    ...
    struct {
      __IOM uint32_t AFE_GAIN_TAB9 : 9;         /*!< [8..0] afe_gain_tab9                                                      */
      __IOM uint32_t AFE_GAIN_TAB10 : 9;        /*!< [17..9] afe_gain_tab10                                                    */
      __IOM uint32_t AFE_GAIN_TAB11 : 9;        /*!< [26..18] afe_gain_tab11                                                   */
    } AGC_TAB_CFG3_b;
  } ;
  ...
  union {
    ...
    struct {
      __IOM uint32_t AFE_GAIN_TAB12 : 9;        /*!< [8..0] afe_gain_tab12                                                     */
      __IOM uint32_t AFE_GAIN_TAB13 : 9;        /*!< [17..9] afe_gain_tab13                                                    */
      __IOM uint32_t AFE_GAIN_TAB14 : 9;        /*!< [26..18] afe_gain_tab14                                                   */
    } AGC_TAB_CFG4_b;
  } ;
  ...
  union {
    ...
    struct {
      __IOM uint32_t AFE_GAIN_TAB15 : 9;        /*!< [8..0] afe_gain_tab15                                                     */
      __IOM uint32_t AFE_GAIN_TAB16 : 9;        /*!< [17..9] afe_gain_tab16                                                    */
      __IOM uint32_t AFE_GAIN_TAB17 : 9;        /*!< [26..18] afe_gain_tab17                                                   */
    } AGC_TAB_CFG5_b;
  } ;
  ...
  union {
    ...
    struct {
      __IOM uint32_t AFE_GAIN_TAB18 : 9;        /*!< [8..0] afe_gain_tab18                                                     */
      __IOM uint32_t AFE_GAIN_TAB19 : 9;        /*!< [17..9] afe_gain_tab19                                                    */
      __IOM uint32_t AFE_GAIN_TAB20 : 9;        /*!< [26..18] afe_gain_tab20                                                   */
    } AGC_TAB_CFG6_b;
  } ;
  ...
  union {
    ...
    struct {
      __IOM uint32_t AFE_GAIN_TAB21 : 9;        /*!< [8..0] afe_gain_tab21                                                     */
      __IOM uint32_t AFE_GAIN_TAB22 : 9;        /*!< [17..9] afe_gain_tab22                                                    */
      __IOM uint32_t AFE_GAIN_TAB23 : 9;        /*!< [26..18] afe_gain_tab23                                                   */
    } AGC_TAB_CFG7_b;
  } ;
  
  union {
    __IOM uint32_t AGC_TAB_CFG8;                /*!< (@ 0x000001CC) AGC_TAB_CFG8                                               */
    
    struct {
      __IOM uint32_t AFE_GAIN_TAB24 : 9;        /*!< [8..0] afe_gain_tab24                                                     */
      __IOM uint32_t AFE_GAIN_TAB25 : 9;        /*!< [17..9] afe_gain_tab25                                                    */
      __IOM uint32_t AFE_GAIN_TAB26 : 9;        /*!< [26..18] afe_gain_tab26                                                   */
    } AGC_TAB_CFG8_b;
  } ;
  
  union {
    __IOM uint32_t AGC_TAB_CFG9;                /*!< (@ 0x000001D0) AGC_TAB_CFG9                                               */
    
    struct {
      __IOM uint32_t AFE_GAIN_TAB27 : 9;        /*!< [8..0] afe_gain_tab27                                                     */
      __IOM uint32_t AFE_GAIN_TAB28 : 9;        /*!< [17..9] afe_gain_tab28                                                    */
      __IOM uint32_t AFE_GAIN_TAB29 : 9;        /*!< [26..18] afe_gain_tab29                                                   */
    } AGC_TAB_CFG9_b;
  } ;
  
  union {
    __IOM uint32_t AGC_TAB_CFG10;               /*!< (@ 0x000001D4) AGC_TAB_CFG10                                              */
    
    struct {
      __IOM uint32_t AFE_GAIN_TAB30 : 9;        /*!< [8..0] afe_gain_tab30                                                     */
      __IOM uint32_t AFE_GAIN_TAB31 : 9;        /*!< [17..9] afe_gain_tab31                                                    */
    } AGC_TAB_CFG10_b;
  } ;
  
  union {
    __IOM uint32_t GAD_CFG0;                    /*!< (@ 0x000001D8) GAD_CFG0                                                   */
  ...
  union {
    __IOM uint32_t GAD_CFG1;                    /*!< (@ 0x000001DC) GAD_CFG1                                                   */
  ...
  union {
    __IOM uint32_t GAD_CFG2;                    /*!< (@ 0x000001E0) GAD_CFG2                                                   */
    
    struct {
      __IOM uint32_t GAD_REF    : 16;           /*!< [15..0] gad_ref                                                           */
      __IOM uint32_t GAD_RMS_FLT_ALPH : 3;      /*!< [18..16] gad_rms_flt_alph                                                 */
    } GAD_CFG2_b;
  } ;
  
  union {
    __IOM uint32_t GAD_STATUS0;                 /*!< (@ 0x000001E4) GAD_STATUS0                                                */
  ...
  union {
    __IOM uint32_t GAD_STATUS1;                 /*!< (@ 0x000001E8) GAD_STATUS1                                                */
  ...
  union {
    __IOM uint32_t DC_RM_CFG;                   /*!< (@ 0x000001EC) DC_RM_CFG                                                  */
  ...
  union {
    __IOM uint32_t TONE_RM_CFG0;                /*!< (@ 0x000001F0) TONE_RM_CFG0                                               */
    
    struct {
      __IOM uint32_t TONE_RM_ENABLE : 8;        /*!< [7..0] tone_rm_enable                                                     */
      __IOM uint32_t TONE_RM2_ENABLE : 8;       /*!< [15..8] tone_rm2_enable                                                   */
      __IOM uint32_t TONE_RM_LSHFT : 8;         /*!< [23..16] tone_rm_lshft                                                    */
      __IOM uint32_t TONE_RM2_LSHFT : 8;        /*!< [31..24] tone_rm2_lshft                                                   */
    } TONE_RM_CFG0_b;
  } ;
  
  union {
    __IOM uint32_t TONE_RM_A1[4];                /*!< (@ 0x000001F4) TONE_RM_CFG1                                               */
    
    struct {
      __IOM uint32_t TONE_RM_A10 : 16;          /*!< [15..0] tone_rm_a10                                                       */
      __IOM uint32_t TONE_RM_A11 : 16;          /*!< [31..16] tone_rm_a11                                                      */
    } TONE_RM_A1_b[4];
  } ;
  
  union {
    __IOM uint32_t TONE_RM_B1[4];                /*!< (@ 0x00000204) TONE_RM_CFG5                                               */
    
    struct {
      __IOM uint32_t TONE_RM_B10 : 16;          /*!< [15..0] tone_rm_b10                                                       */
      __IOM uint32_t TONE_RM_B11 : 16;          /*!< [31..16] tone_rm_b11                                                      */
    } TONE_RM_B1_b[4];
  } ;
  
  union {
    __IOM uint32_t TONE_RM_B2[4];                /*!< (@ 0x00000214) TONE_RM_CFG9                                               */
    
    struct {
      __IOM uint32_t TONE_RM_B20 : 16;          /*!< [15..0] tone_rm_b20                                                       */
      __IOM uint32_t TONE_RM_B21 : 16;          /*!< [31..16] tone_rm_b21                                                      */
    } TONE_RM_B2_b[4];
  } ;
  
  union {
    __IOM uint32_t TONE_RM2_A1[4];               /*!< (@ 0x00000224) TONE_RM_CFG13                                              */
    
    struct {
      __IOM uint32_t TONE_RM2_A10 : 16;         /*!< [15..0] tone_rm2_a10                                                      */
      __IOM uint32_t TONE_RM2_A11 : 16;         /*!< [31..16] tone_rm2_a11                                                     */
    } TONE_RM2_A1_b[4];
  } ;
  
  union {
    __IOM uint32_t TONE_RM2_B1[4];               /*!< (@ 0x00000234) TONE_RM_CFG17                                              */
    
    struct {
      __IOM uint32_t TONE_RM2_B10 : 16;         /*!< [15..0] tone_rm2_b10                                                      */
      __IOM uint32_t TONE_RM2_B11 : 16;         /*!< [31..16] tone_rm2_b11                                                     */
    } TONE_RM2_B1_b[4];
  } ;
 
  union {
    __IOM uint32_t TONE_RM2_B2[4];               /*!< (@ 0x00000244) TONE_RM_CFG21                                              */
    
    struct {
      __IOM uint32_t TONE_RM2_B20 : 16;         /*!< [15..0] tone_rm2_b20                                                      */
      __IOM uint32_t TONE_RM2_B21 : 16;         /*!< [31..16] tone_rm2_b21                                                     */
    } TONE_RM2_B2_b[4];
  } ;
  
  union {
    __IOM uint32_t PULSE_RM_CFG0;               /*!< (@ 0x00000248) PULSE_RM_CFG0                                              */
    
    struct {
      __IOM uint32_t PR_ENABLE  : 1;            /*!< [0..0] pr_enable                                                          */
      __IOM uint32_t PR_LOCK_RMS_ENABLE : 1;    /*!< [1..1] pr_lock_rms_enable                                                 */
      __IOM uint32_t PR_SEG_LEN_OPT : 3;        /*!< [4..2] pr_seg_len_opt                                                     */
      __IOM uint32_t PR_SEG_NUM : 3;            /*!< [7..5] pr_seg_num                                                         */
      __IOM uint32_t PR_PULSE_RMS_THR : 6;      /*!< [13..8] pr_pulse_rms_thr                                                  */
    } PULSE_RM_CFG0_b;
  } ;
  
  union {
    __IOM uint32_t PULSE_DET_CFG0;              /*!< (@ 0x00000258) PULSE_DET_CFG0                                             */
  ...
  union {
    __IOM uint32_t PULSE_DET_RES;               /*!< (@ 0x0000025C) PULSE_DET_RES                                              */
  ...
  union {
    __IOM uint32_t FSK_TX_CFG0;                 /*!< (@ 0x00000260) FSK_TX_CFG0                                                */
    
    struct {
      __IOM uint32_t FSK_BIT_PERIOD : 24;       /*!< [23..0] fsk_bit_period                                                    */
      __IOM uint32_t FSK_TX_ENABLE : 1;         /*!< [24..24] fsk_tx_enable                                                    */
      __IOM uint32_t FSK_STOP_NEXT_PHASE : 1;   /*!< [25..25] fsk_stop_next_phase                                              */
    } FSK_TX_CFG0_b;
  } ;

  union {
    __IOM uint32_t FSK_TX_CFG1;                 /*!< (@ 0x00000264) FSK_TX_CFG1                                                */
  ...
  union {
    __IOM uint32_t FSK_TX_CFG2;                 /*!< (@ 0x00000268) FSK_TX_CFG2                                                */
    
    struct {
      __IOM uint32_t FSK_INI_PHASE : 32;        /*!< [31..0] fsk_ini_phase                                                     */
    } FSK_TX_CFG2_b;
  } ;
  
  union {
    __IOM uint32_t TONE_NOTCH_TAB[16];             /*!< (@ 0x0000026C) tone_notch_tab0                                            */
    
    struct {
      __IOM uint32_t TONE_NOTCH_TAB0 : 32;      /*!< [31..0] tone_notch_tab0                                                   */
    } TONE_NOTCH_TAB_b[16];
  } ;
} BPLC_Type;                                    /*!< Size = 672 (0x2a0)                                                        */
...
/* ================                                            BPLC AFE                                       ================ */
/* =========================================================================================================================== */
typedef struct { /* bplc_afe_regs */
  union {
    __IOM uint32_t HPLCTOPCR0_ALL ;                 /*0x0 HPLC Top Controll Register 0 */
    struct {
      ...
      __IOM uint32_t              : 5;           /*[23:19] Reserved */
      __IOM uint32_t AD_RCK_OUT_DATA : 5;           /*[28:24] RCK OUTPUT CODE */
      __IOM uint32_t RCK_CAL_START : 1;           /*[29] RC Calibration Start */
      __IOM uint32_t              : 2;           /*[31:30] Reserved */
    } HPLCTOPCR0_b;
  } ;
  union {
    ...
    struct {
      ...
      __IOM uint32_t AD_TS_MSB : 5;           /*[6:2] The MSB data, in the integer range 0бл31 */
      __IOM uint32_t AD_TS_EOC : 1;           /*[7] End-of-conversion signal */
      __IOM uint32_t AD_TS_LSB : 8;           /*[15:8] The LSB data (optional), in the integer range 0бл2 */
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t RG_TX_VCM1V_ADJ : 4;           /*[11:8] TX VGA2 VCM TRIM:0000min,бн.1111max */
      __IOM uint32_t RG_TX_VCM0V5_ADJ : 4;           /*[15:12] TX LPF VCM TRIM:0000min,бн.1111max */
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t RG_RX_VCM1V_ADJ : 5;           /*[12:8] RX DRIVER VCM TRIM:0000min,бн.1111max */
      __IOM uint32_t CFG_LVS_0STG_BW : 3;           /*[15:13] CFG_LVS_0STG_BW */
      __IOM uint32_t RG_RX_LPF_TUNNING : 5;           /*[20:16] Register Control for 1st LPF bandwidth 00000min,11111max */
      __IOM uint32_t              : 3;           /*[23:21] Reserved */
      __IOM uint32_t RG_RX_VCM0V5_ADJ : 5;           /*[28:24] RX LPF VCM TRIM:0000min,бн.1111max */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } RXCR1_b;
  } ;
  union {
    ...
    struct {
      ...
      __IOM uint32_t RG_DC_TIA_VCM_ADJ : 5;           /*[15:11] tia vcm  option 00000minбн..11111max */
      __IOM uint32_t              : 16;           /*[31:16] Reserved */
    } ADDACR0_b;
  } ;
  union {
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t RG_ADC_BUF_VCM_ADJ : 5;           /*[15:11] adc buf vcm  option 00000minбн..11111max */
      __IOM uint32_t RG_ADC_BUF_D_ADJ : 4;           /*[19:16] adc buf driver option 0000minбн..1111max */
      __IOM uint32_t              : 4;           /*[23:20] Reserved */
      __IOM uint32_t RG_ADC_VREF_ADJ : 5;           /*[28:24] adc ref  option 00000minбн..11111max */
      __IOM uint32_t              : 3;           /*[31:29] Reserved */
    } ADDACR2_b;
  } ;
} BPLC_AFE_Type; 
...
typedef struct {                                /*!< (@ 0x40030000) CPM Structure                                              */
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t DA_CLK_TREE_DIG_EN  : 1;   /*!< [3..3] DA_CLK_TREE_DIG_EN                                                 */
      __IOM uint32_t RG_OSC_LDO18_EN : 1;       /*!< [4..4] RG_OSC_LDO18_EN                                                    */
      ...
      __IOM uint32_t IPS_CLK    : 4;            /*!< [19..16] IPS_CLK                                                          */
      __IOM uint32_t DA_CLK_TREE_ADC_EN    : 1; /*!< [20..20] DA_CLK_TREE_ADC_EN                                               */
      __IOM uint32_t DA_CLK_TREE_SX_EN    : 1;  /*!< [21..21] DA_CLK_TREE_SX_EN                                                */
      __IM  uint32_t            : 2;            /*!< [23..22] reserved                                                         */
      __IOM uint32_t HRF_CLK_DIV : 3;           /*!< [26..24] HRF_CLK_DIV                                                      */
      __IOM uint32_t CLKSWDONE  : 1;            /*!< [27..27] CLKSWDONE                                                        */
      __IOM uint32_t EXT_CLK_MUX    : 1;        /*!< [28..28] EXT_CLK_MUX                                                      */
      __IOM uint32_t EXT_CLKSWDONE  : 1;        /*!< [29..29] EXT_CLKSWDONE                                                    */
  ...
  union {
    ...
    struct {
      ...
      __IM  uint32_t                  : 1;      /*!< [5..5] reserved                                                           */
      __IOM uint32_t RG_OSC_LDO_VSEL  : 2;      /*!< [7..6] RG_OSC_LDO_VSEL                                                    */
      ...
      __IM  uint32_t            : 1;            /*!< [29..29] reserved                                                         */
      __IOM uint32_t TEST       : 2;            /*!< [31..30] ADDRESS4TEST                                                     */
    } OSCCR_b;
  } ;

  union {
    __IOM uint32_t MSCR;                        /*!< (@ 0x00000008) MSCR                                                       */
    
    struct {
      __IOM uint32_t IPS_CLK_EN : 30;           /*!< [29..0] IPS_CLK_EN                                                        */
      __IOM uint32_t TEST       : 2;            /*!< [31..30] ADDRESS8TEST                                                     */
    } MSCR_b;
  } ;
  
  union {
    __IOM uint32_t MSCRSTOP;                    /*!< (@ 0x0000000C) MSCRSTOP                                                   */
    
    struct {
      __IOM uint32_t IPS_CLK_STOP_EN : 30;      /*!< [29..0] IPS_CLK_STOP_EN                                                   */
      __IOM uint32_t TEST       : 2;            /*!< [31..30] ADDRESSCTEST                                                     */
    } MSCRSTOP_b;
  } ;

  union {
    __IOM uint32_t MISCCR;                       /*!< (@ 0x00000010) MISCCR                                                    */
    
    struct {
      __IOM uint32_t EoscBuffStable : 15;       /*!< [14..0] EoscBuffStable                                                    */
      __IM  uint32_t                  : 1;      /*!< [15..15] reserved                                                         */
      __IOM uint32_t PLL_POSTDIV2 : 3;          /*!< [18..16] PLL_POSTDIV2                                                     */
      __IM  uint32_t            : 11;           /*!< [29..19] reserved                                                         */
      __IOM uint32_t TEST       : 2;            /*!< [31..30] ADDRESS10TEST                                                    */
    } MISCCR_b;
  } ;
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t PLL_DSMPD  : 1;            /*!< [25..25] PLL_DSMPD                                                        */
      ...
      __IOM uint32_t TEST       : 2;            /*!< [31..30] ADDRESS14TEST                                                    */      
    } PLL_CONFIG0_b;
  } ;
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t PLL_BYPASS : 1;            /*!< [28..28] PLL_BYPASS                                                       */
      __IOM uint32_t PLL_LOCK   : 1;            /*!< [29..29] PLL_LOCK                                                         */
      __IOM uint32_t TEST       : 2;            /*!< [31..30] ADDRESS18TEST                                                    */
    } PLL_CONFIG1_b;
  } ;
  ...
  union {
    ...
    struct {
      __IOM uint32_t AHB_CLK_EN : 30;           /*!< [29..0] AHB_CLK_EN                                                        */
      __IOM uint32_t TEST       : 2;            /*!< [31..30] ADDRESS1CTEST                                                    */
    } AHBMSCR_b;
  } ;
  ...
  union {
    ...
    struct {
      __IOM uint32_t AHB_CLK_STOP_EN : 30;      /*!< [29..0] AHB_CLK_STOP_EN                                                   */
      __IOM uint32_t TEST       : 2;            /*!< [31..30] ADDRESS20TEST                                                    */
    } AHBMSCRSTOP_b;
  } ;
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t RG_AVDD18_EN : 1;          /*!< [6..6] RG_AVDD18_EN                                                       */
      __IM  uint32_t            : 1;            /*!< [7..7] reserved                                                           */
      ...
      __IOM uint32_t RG_AVDD18_TR : 2;          /*!< [21..20] RG_RF1V8_TR                                                      */
      __IM  uint32_t            : 8;            /*!< [29..22] reserved                                                         */
      __IOM uint32_t TEST       : 2;            /*!< [31..30] ADDRESS24TEST                                                    */
    } PMUCR_b;
  } ;
  ...
  union {
    ...
    struct {
      ...
      __IM  uint32_t            : 7;            /*!< [7..1] reserved                                                           */
      __IOM uint32_t VBATDET_DOUT : 8;          /*!< [15..8] VPINDET_DOUT                                                      */
      __IM  uint32_t            : 14;           /*!< [29..16] reserved                                                         */
      __IOM uint32_t TEST       : 2;            /*!< [31..30] ADDRESS28Test                                                    */
    } VBATDETCR_b;
  } ;
  ...
  union {
    ...
    struct {
      ...
      __IM  uint32_t            : 6;            /*!< [29..24] reserved                                                         */
      __IOM uint32_t TEST       : 2;            /*!< [31..30] ADDRESS2CTest                                                    */
    } VDETCR_b;
  } ;
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t EXT_CLK_EN : 1;            /*!< [7..7] EXT_CLK_EN                                                         */
      __IOM uint32_t PSRAM_CLK_EN : 1;          /*!< [8..8] PSRAM_CLK_EN                                                       */
      __IM uint32_t                : 1;         /*!< [9..9] reserved                                                           */
      __IOM uint32_t LVD_CLK_EN : 1;            /*!< [10..10] LVD_CLK_EN                                                       */
      __IOM uint32_t EXT_CLK_DIV : 4;           /*!< [14..11] TS_CLK_DIV                                                       */
      __IM uint32_t                : 1;         /*!< [15..15] reserved                                                         */
      __IOM uint32_t TS_CLK_DIV : 12;           /*!< [27..16] TS_CLK_DIV                                                       */
      __IOM uint32_t ATRITH_CLK_DIV : 2;        /*!< [29..28] ATRITH_CLK_DIV                                                   */
      __IOM uint32_t TEST       : 2;            /*!< [31..30] ADDRESS30TEST                                                    */
    } MISCCLKCR_b;
  } ;
  ...
  union {
    ...
    struct {
      ...
      __IM uint32_t                : 1;         /*!< [9..9] reserved                                                           */
      __IOM uint32_t LVD_CLK_EN : 1;            /*!< [10..10] LVD_CLK_EN                                                       */
      __IM  uint32_t            : 19;           /*!< [29..11] reserved                                                         */
      __IOM uint32_t TEST       : 2;            /*!< [31..30] ADDRESS34TEST                                                    */
    } MISCCLKCRSTOP_b;
  } ;
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t BatVolToggleDis : 1;       /*!< [16..16] BatVolToggleDis                                                  */
      __IM  uint32_t            : 7;            /*!< [23..17] reserved                                                         */
      ...
      __IOM uint32_t TEST       : 2;            /*!< [31..30] ADDRESS38TEST                                                    */
    } BATVDCFGR_b;
  } ;
  ...
  union {
    ...
    struct {
      __IOM uint32_t PinVolDetLValue : 5;       /*!< [4..0] PinVolDetLValue                                                    */
      __IM  uint32_t            : 3;            /*!< [7..5] reserved                                                           */
      __IOM uint32_t PinVolDetHValue : 5;       /*!< [12..8] PinVolDetHValue                                                   */
      __IM  uint32_t            : 3;            /*!< [15..13] reserved                                                         */
      __IOM uint32_t LVD_CLK_DIV : 8;           /*!< [23..16] LVD_CLK_DIV                                                      */
      ...
      __IOM uint32_t PinVolToggleDis : 1;       /*!< [28..28] PinVolToggleDis                                                  */
      __IM  uint32_t            : 1;            /*!< [29..29] reserved                                                         */
      __IOM uint32_t TEST       : 2;            /*!< [31..30] ADDRESS3CTEST                                                    */
    } PINVDCFGR_b;
  } ;
  
  union {
    __IOM uint32_t OSCCR1;                      /*!< (@ 0x00000040) OSCCR1                                                     */
    
    struct {
      __IOM uint32_t RG_OSC_RESERVED : 16;      /*!< [15..0] RG_OSC_RESERVED                                                   */
      __IM  uint32_t            : 14;           /*!< [29..16] reserved                                                         */
      __IOM uint32_t TEST       : 2;            /*!< [31..30] ADDRESS40TEST                                                    */
    } OSCCR1_b;
  } ;
...
typedef struct {                                /*!< (@ 0x40A00000) PWM0 Structure                                             */
  ...
  union {
    ...
    struct {
      __IOM uint32_t CNR        : 32;           /*!< [31..0] PWM Counter/Timer Loaded Value                                    */
    } PCNR0_b;
  } ;
  ...
  union {
    ...
    struct {
      __IOM uint32_t CMR        : 32;           /*!< [31..0] PWM Comparator Register                                           */
    } PCMR0_b;
  } ;
  ...
  union {
    ...
    struct {
      __IOM uint32_t CTR        : 32;           /*!< [31..0] PWM Timer value                                                   */
    } PTR0_b;
  } ;
...
typedef struct {                                /*!< (@ 0x40140000) EPORT0 Structure                                           */
  __IOM uint8_t   EPIER;                        /*!< (@ 0x00000000) EPORT Port Rising and level Interrupt Enable Register      */
  ...
  __IOM uint8_t   EPFR;                         /*!< (@ 0x00000005) EPORT Rising and level Flag Register                       */
  ...
  __IOM  uint8_t   EPIER1;                      /*!< (@ 0x0000000F) EPORT Fall Edge Interrupt Enable Register                  */
  __IOM uint8_t   EPLFR;                        /*!< (@ 0x0000000F) EPORT Fall Edge Flag Register                              */
...
#define DFE_EXT_BASE                0x40110000UL
#define HRF_AFE_BASE                0x401f0000UL
...
#define EFUSE1024_BASE              0x40060000UL    // Triming info
#define EFUSE64_BASE                0x40050000UL    // Wafer ID
#define TRIMING_OFFSET              37
...
#define DFE_EXT                     ((dfe_ext_Type*)           DFE_EXT_BASE)
#define HRF_AFE                     ((HRF_AFE_Type*)           HRF_AFE_BASE)
...
#define BPLC_BBP_CONTROL_ADC_CLK_EN_Pos   (10UL)                    /*!< BPLC BBP_CONTROL: ADC_CLK_EN (Bit 10)                 */
#define BPLC_BBP_CONTROL_ADC_CLK_EN_Msk   (0x400UL)                 /*!< BPLC BBP_CONTROL: ADC_CLK_EN (Bitfield-Mask: 0x01)    */
#define BPLC_BBP_CONTROL_DAC_CLK_EN_Pos   (9UL)                     /*!< BPLC BBP_CONTROL: DAC_CLK_EN (Bit 9)                  */
#define BPLC_BBP_CONTROL_DAC_CLK_EN_Msk   (0x200UL)                 /*!< BPLC BBP_CONTROL: DAC_CLK_EN (Bitfield-Mask: 0x01)    */
...
#define BPLC_BBP_STATUS_FSK_PHASE_UPDATE_FLAG_Pos (23UL)            /*!< BPLC BBP_STATUS: FSK_PHASE_UPDATE_FLAG (Bit 23)       */
#define BPLC_BBP_STATUS_FSK_PHASE_UPDATE_FLAG_Msk (0x800000UL)      /*!< BPLC BBP_STATUS: FSK_PHASE_UPDATE_FLAG (Bitfield-Mask: 0x01) */
...
/* ======================================================  BBP_INT_EN  ======================================================= */
#define BPLC_BBP_INT_EN_FSK_PHASE_UPDATE_INT_EN_Pos (23UL)          /*!< BPLC BBP_INT_EN: FSK_PHASE_UPDATE_INT_EN (Bit 23)     */
#define BPLC_BBP_INT_EN_FSK_PHASE_UPDATE_INT_EN_Msk (0x800000UL)    /*!< BPLC BBP_INT_EN: FSK_PHASE_UPDATE_INT_EN (Bitfield-Mask: 0x01) */
...
/* ====================================================  TONE_MASK_TAB0  ===================================================== */
#define BPLC_TONE_MASK_TAB0_TONE_MASK_TAB0_Pos (0UL)                /*!< BPLC TONE_MASK_TAB0: TONE_MASK_TAB0 (Bit 0)           */
#define BPLC_TONE_MASK_TAB0_TONE_MASK_TAB0_Msk (0xffffffffUL)       /*!< BPLC TONE_MASK_TAB0: TONE_MASK_TAB0 (Bitfield-Mask: 0xffffffff) */
/* ====================================================  TONE_MASK_TAB1  ===================================================== */
#define BPLC_TONE_MASK_TAB1_TONE_MASK_TAB1_Pos (0UL)                /*!< BPLC TONE_MASK_TAB1: TONE_MASK_TAB1 (Bit 0)           */
#define BPLC_TONE_MASK_TAB1_TONE_MASK_TAB1_Msk (0xffffffffUL)       /*!< BPLC TONE_MASK_TAB1: TONE_MASK_TAB1 (Bitfield-Mask: 0xffffffff) */
/* ====================================================  TONE_MASK_TAB2  ===================================================== */
#define BPLC_TONE_MASK_TAB2_TONE_MASK_TAB2_Pos (0UL)                /*!< BPLC TONE_MASK_TAB2: TONE_MASK_TAB2 (Bit 0)           */
#define BPLC_TONE_MASK_TAB2_TONE_MASK_TAB2_Msk (0xffffffffUL)       /*!< BPLC TONE_MASK_TAB2: TONE_MASK_TAB2 (Bitfield-Mask: 0xffffffff) */
/* ====================================================  TONE_MASK_TAB3  ===================================================== */
#define BPLC_TONE_MASK_TAB3_TONE_MASK_TAB3_Pos (0UL)                /*!< BPLC TONE_MASK_TAB3: TONE_MASK_TAB3 (Bit 0)           */
#define BPLC_TONE_MASK_TAB3_TONE_MASK_TAB3_Msk (0xffffffffUL)       /*!< BPLC TONE_MASK_TAB3: TONE_MASK_TAB3 (Bitfield-Mask: 0xffffffff) */
/* ====================================================  TONE_MASK_TAB4  ===================================================== */
#define BPLC_TONE_MASK_TAB4_TONE_MASK_TAB4_Pos (0UL)                /*!< BPLC TONE_MASK_TAB4: TONE_MASK_TAB4 (Bit 0)           */
#define BPLC_TONE_MASK_TAB4_TONE_MASK_TAB4_Msk (0xffffffffUL)       /*!< BPLC TONE_MASK_TAB4: TONE_MASK_TAB4 (Bitfield-Mask: 0xffffffff) */
/* ====================================================  TONE_MASK_TAB5  ===================================================== */
#define BPLC_TONE_MASK_TAB5_TONE_MASK_TAB5_Pos (0UL)                /*!< BPLC TONE_MASK_TAB5: TONE_MASK_TAB5 (Bit 0)           */
#define BPLC_TONE_MASK_TAB5_TONE_MASK_TAB5_Msk (0xffffffffUL)       /*!< BPLC TONE_MASK_TAB5: TONE_MASK_TAB5 (Bitfield-Mask: 0xffffffff) */
/* ====================================================  TONE_MASK_TAB6  ===================================================== */
#define BPLC_TONE_MASK_TAB6_TONE_MASK_TAB6_Pos (0UL)                /*!< BPLC TONE_MASK_TAB6: TONE_MASK_TAB6 (Bit 0)           */
#define BPLC_TONE_MASK_TAB6_TONE_MASK_TAB6_Msk (0xffffffffUL)       /*!< BPLC TONE_MASK_TAB6: TONE_MASK_TAB6 (Bitfield-Mask: 0xffffffff) */
/* ====================================================  TONE_MASK_TAB7  ===================================================== */
#define BPLC_TONE_MASK_TAB7_TONE_MASK_TAB7_Pos (0UL)                /*!< BPLC TONE_MASK_TAB7: TONE_MASK_TAB7 (Bit 0)           */
#define BPLC_TONE_MASK_TAB7_TONE_MASK_TAB7_Msk (0xffffffffUL)       /*!< BPLC TONE_MASK_TAB7: TONE_MASK_TAB7 (Bitfield-Mask: 0xffffffff) */
/* ====================================================  TONE_MASK_TAB8  ===================================================== */
#define BPLC_TONE_MASK_TAB8_TONE_MASK_TAB8_Pos (0UL)                /*!< BPLC TONE_MASK_TAB8: TONE_MASK_TAB8 (Bit 0)           */
#define BPLC_TONE_MASK_TAB8_TONE_MASK_TAB8_Msk (0xffffffffUL)       /*!< BPLC TONE_MASK_TAB8: TONE_MASK_TAB8 (Bitfield-Mask: 0xffffffff) */
/* ====================================================  TONE_MASK_TAB9  ===================================================== */
#define BPLC_TONE_MASK_TAB9_TONE_MASK_TAB9_Pos (0UL)                /*!< BPLC TONE_MASK_TAB9: TONE_MASK_TAB9 (Bit 0)           */
#define BPLC_TONE_MASK_TAB9_TONE_MASK_TAB9_Msk (0xffffffffUL)       /*!< BPLC TONE_MASK_TAB9: TONE_MASK_TAB9 (Bitfield-Mask: 0xffffffff) */
/* ====================================================  TONE_MASK_TAB10  ==================================================== */
#define BPLC_TONE_MASK_TAB10_TONE_MASK_TAB10_Pos (0UL)              /*!< BPLC TONE_MASK_TAB10: TONE_MASK_TAB10 (Bit 0)         */
#define BPLC_TONE_MASK_TAB10_TONE_MASK_TAB10_Msk (0xffffffffUL)     /*!< BPLC TONE_MASK_TAB10: TONE_MASK_TAB10 (Bitfield-Mask: 0xffffffff) */
/* ====================================================  TONE_MASK_TAB11  ==================================================== */
#define BPLC_TONE_MASK_TAB11_TONE_MASK_TAB11_Pos (0UL)              /*!< BPLC TONE_MASK_TAB11: TONE_MASK_TAB11 (Bit 0)         */
#define BPLC_TONE_MASK_TAB11_TONE_MASK_TAB11_Msk (0xffffffffUL)     /*!< BPLC TONE_MASK_TAB11: TONE_MASK_TAB11 (Bitfield-Mask: 0xffffffff) */
/* ====================================================  TONE_MASK_TAB12  ==================================================== */
#define BPLC_TONE_MASK_TAB12_TONE_MASK_TAB12_Pos (0UL)              /*!< BPLC TONE_MASK_TAB12: TONE_MASK_TAB12 (Bit 0)         */
#define BPLC_TONE_MASK_TAB12_TONE_MASK_TAB12_Msk (0xffffffffUL)     /*!< BPLC TONE_MASK_TAB12: TONE_MASK_TAB12 (Bitfield-Mask: 0xffffffff) */
/* ====================================================  TONE_MASK_TAB13  ==================================================== */
#define BPLC_TONE_MASK_TAB13_TONE_MASK_TAB13_Pos (0UL)              /*!< BPLC TONE_MASK_TAB13: TONE_MASK_TAB13 (Bit 0)         */
#define BPLC_TONE_MASK_TAB13_TONE_MASK_TAB13_Msk (0xffffffffUL)     /*!< BPLC TONE_MASK_TAB13: TONE_MASK_TAB13 (Bitfield-Mask: 0xffffffff) */
/* ====================================================  TONE_MASK_TAB14  ==================================================== */
#define BPLC_TONE_MASK_TAB14_TONE_MASK_TAB14_Pos (0UL)              /*!< BPLC TONE_MASK_TAB14: TONE_MASK_TAB14 (Bit 0)         */
#define BPLC_TONE_MASK_TAB14_TONE_MASK_TAB14_Msk (0xffffffffUL)     /*!< BPLC TONE_MASK_TAB14: TONE_MASK_TAB14 (Bitfield-Mask: 0xffffffff) */
/* ====================================================  TONE_MASK_TAB15  ==================================================== */
#define BPLC_TONE_MASK_TAB15_TONE_MASK_TAB15_Pos (0UL)              /*!< BPLC TONE_MASK_TAB15: TONE_MASK_TAB15 (Bit 0)         */
#define BPLC_TONE_MASK_TAB15_TONE_MASK_TAB15_Msk (0xffffffffUL)     /*!< BPLC TONE_MASK_TAB15: TONE_MASK_TAB15 (Bitfield-Mask: 0xffffffff) */
/* ====================================================  FC_ADDR_OFFSET0  ==================================================== */
...
/* ======================================================  NBI_CONTROL  ====================================================== */
#define BPLC_NBI_CONTROL_NBI_IN_OPT_Pos   (24UL)                    /*!< BPLC NBI_CONTROL: NBI_IN_OPT (Bit 24)                 */
#define BPLC_NBI_CONTROL_NBI_IN_OPT_Msk   (0x1000000UL)             /*!< BPLC NBI_CONTROL: NBI_IN_OPT (Bitfield-Mask: 0x01)    */
...
/* ===================================================  NTB_MATCH_TARGET0  =================================================== */
#define BPLC_NTB_MATCH_TARGET0_NTB_MATCH_TARGET0_Pos (0UL)          /*!< BPLC NTB_MATCH_TARGET0: NTB_MATCH_TARGET0 (Bit 0)     */
#define BPLC_NTB_MATCH_TARGET0_NTB_MATCH_TARGET0_Msk (0xffffffffUL) /*!< BPLC NTB_MATCH_TARGET0: NTB_MATCH_TARGET0 (Bitfield-Mask: 0xffffffff) */
/* ===================================================  NTB_MATCH_TARGET1  =================================================== */
#define BPLC_NTB_MATCH_TARGET1_NTB_MATCH_TARGET1_Pos (0UL)          /*!< BPLC NTB_MATCH_TARGET1: NTB_MATCH_TARGET1 (Bit 0)     */
#define BPLC_NTB_MATCH_TARGET1_NTB_MATCH_TARGET1_Msk (0xffffffffUL) /*!< BPLC NTB_MATCH_TARGET1: NTB_MATCH_TARGET1 (Bitfield-Mask: 0xffffffff) */
/* ===================================================  NTB_MATCH_TARGET2  =================================================== */
#define BPLC_NTB_MATCH_TARGET2_NTB_MATCH_TARGET2_Pos (0UL)          /*!< BPLC NTB_MATCH_TARGET2: NTB_MATCH_TARGET2 (Bit 0)     */
#define BPLC_NTB_MATCH_TARGET2_NTB_MATCH_TARGET2_Msk (0xffffffffUL) /*!< BPLC NTB_MATCH_TARGET2: NTB_MATCH_TARGET2 (Bitfield-Mask: 0xffffffff) */
/* ===================================================  NTB_MATCH_TARGET3  =================================================== */
#define BPLC_NTB_MATCH_TARGET3_NTB_MATCH_TARGET3_Pos (0UL)          /*!< BPLC NTB_MATCH_TARGET3: NTB_MATCH_TARGET3 (Bit 0)     */
#define BPLC_NTB_MATCH_TARGET3_NTB_MATCH_TARGET3_Msk (0xffffffffUL) /*!< BPLC NTB_MATCH_TARGET3: NTB_MATCH_TARGET3 (Bitfield-Mask: 0xffffffff) */
/* ===================================================  NTB_MATCH_TARGET4  =================================================== */
#define BPLC_NTB_MATCH_TARGET4_NTB_MATCH_TARGET4_Pos (0UL)          /*!< BPLC NTB_MATCH_TARGET4: NTB_MATCH_TARGET4 (Bit 0)     */
#define BPLC_NTB_MATCH_TARGET4_NTB_MATCH_TARGET4_Msk (0xffffffffUL) /*!< BPLC NTB_MATCH_TARGET4: NTB_MATCH_TARGET4 (Bitfield-Mask: 0xffffffff) */
/* ===================================================  NTB_MATCH_TARGET5  =================================================== */
#define BPLC_NTB_MATCH_TARGET5_NTB_MATCH_TARGET5_Pos (0UL)          /*!< BPLC NTB_MATCH_TARGET5: NTB_MATCH_TARGET5 (Bit 0)     */
#define BPLC_NTB_MATCH_TARGET5_NTB_MATCH_TARGET5_Msk (0xffffffffUL) /*!< BPLC NTB_MATCH_TARGET5: NTB_MATCH_TARGET5 (Bitfield-Mask: 0xffffffff) */
/* ===================================================  NTB_MATCH_TARGET6  =================================================== */
#define BPLC_NTB_MATCH_TARGET6_NTB_MATCH_TARGET6_Pos (0UL)          /*!< BPLC NTB_MATCH_TARGET6: NTB_MATCH_TARGET6 (Bit 0)     */
#define BPLC_NTB_MATCH_TARGET6_NTB_MATCH_TARGET6_Msk (0xffffffffUL) /*!< BPLC NTB_MATCH_TARGET6: NTB_MATCH_TARGET6 (Bitfield-Mask: 0xffffffff) */
/* ===================================================  NTB_MATCH_TARGET7  =================================================== */
#define BPLC_NTB_MATCH_TARGET7_NTB_MATCH_TARGET7_Pos (0UL)          /*!< BPLC NTB_MATCH_TARGET7: NTB_MATCH_TARGET7 (Bit 0)     */
#define BPLC_NTB_MATCH_TARGET7_NTB_MATCH_TARGET7_Msk (0xffffffffUL) /*!< BPLC NTB_MATCH_TARGET7: NTB_MATCH_TARGET7 (Bitfield-Mask: 0xffffffff) */
/* ===================================================  NTB_COUNTER_VALUE  =================================================== */
...
#define BPLC_AGC_CFG0_AGC_RMS_FLT_ALPH_Pos (12UL)                   /*!< BPLC AGC_CFG0: AGC_RMS_FLT_ALPH (Bit 12)              */
#define BPLC_AGC_CFG0_AGC_RMS_FLT_ALPH_Msk (0x7000UL)               /*!< BPLC AGC_CFG0: AGC_RMS_FLT_ALPH (Bitfield-Mask: 0x07) */
...
/* =========================================================  RSV0  ========================================================== */
#define BPLC_RSV0_RESERVED0_Pos           (0UL)                     /*!< BPLC RSV0: RESERVED0 (Bit 0)                          */
#define BPLC_RSV0_RESERVED0_Msk           (0xffffffffUL)            /*!< BPLC RSV0: RESERVED0 (Bitfield-Mask: 0xffffffff)      */
/* =====================================================  RX_BPF0_CFG0  ====================================================== */
...
#define BPLC_RX_BPF0_CFG0_RX_BYPASS_1ST_STAGE_Pos (30UL)            /*!< BPLC RX_BPF0_CFG0: RX_BYPASS_1ST_STAGE (Bit 30)       */
#define BPLC_RX_BPF0_CFG0_RX_BYPASS_1ST_STAGE_Msk (0x40000000UL)    /*!< BPLC RX_BPF0_CFG0: RX_BYPASS_1ST_STAGE (Bitfield-Mask: 0x01) */
...
/* =========================================================  RSV1  ========================================================== */
#define BPLC_RSV1_RESERVED1_Pos           (0UL)                     /*!< BPLC RSV1: RESERVED1 (Bit 0)                          */
#define BPLC_RSV1_RESERVED1_Msk           (0xffffffffUL)            /*!< BPLC RSV1: RESERVED1 (Bitfield-Mask: 0xffffffff)      */
/* =========================================================  RSV2  ========================================================== */
#define BPLC_RSV2_RESERVED2_Pos           (0UL)                     /*!< BPLC RSV2: RESERVED2 (Bit 0)                          */
#define BPLC_RSV2_RESERVED2_Msk           (0xffffffffUL)            /*!< BPLC RSV2: RESERVED2 (Bitfield-Mask: 0xffffffff)      */
/* =======================================================  RX_PARAM  ======================================================== */
...
/* =====================================================  AGC_TAB_CFG0  ====================================================== */
#define BPLC_AGC_TAB_CFG0_AFE_GAIN_TAB2_Pos (18UL)                  /*!< BPLC AGC_TAB_CFG0: AFE_GAIN_TAB2 (Bit 18)             */
#define BPLC_AGC_TAB_CFG0_AFE_GAIN_TAB2_Msk (0x7fc0000UL)           /*!< BPLC AGC_TAB_CFG0: AFE_GAIN_TAB2 (Bitfield-Mask: 0x1ff) */
#define BPLC_AGC_TAB_CFG0_AFE_GAIN_TAB1_Pos (9UL)                   /*!< BPLC AGC_TAB_CFG0: AFE_GAIN_TAB1 (Bit 9)              */
#define BPLC_AGC_TAB_CFG0_AFE_GAIN_TAB1_Msk (0x3fe00UL)             /*!< BPLC AGC_TAB_CFG0: AFE_GAIN_TAB1 (Bitfield-Mask: 0x1ff) */
#define BPLC_AGC_TAB_CFG0_AFE_GAIN_TAB0_Pos (0UL)                   /*!< BPLC AGC_TAB_CFG0: AFE_GAIN_TAB0 (Bit 0)              */
#define BPLC_AGC_TAB_CFG0_AFE_GAIN_TAB0_Msk (0x1ffUL)               /*!< BPLC AGC_TAB_CFG0: AFE_GAIN_TAB0 (Bitfield-Mask: 0x1ff) */
/* =====================================================  AGC_TAB_CFG1  ====================================================== */
#define BPLC_AGC_TAB_CFG1_AFE_GAIN_TAB5_Pos (18UL)                  /*!< BPLC AGC_TAB_CFG1: AFE_GAIN_TAB5 (Bit 18)             */
#define BPLC_AGC_TAB_CFG1_AFE_GAIN_TAB5_Msk (0x7fc0000UL)           /*!< BPLC AGC_TAB_CFG1: AFE_GAIN_TAB5 (Bitfield-Mask: 0x1ff) */
#define BPLC_AGC_TAB_CFG1_AFE_GAIN_TAB4_Pos (9UL)                   /*!< BPLC AGC_TAB_CFG1: AFE_GAIN_TAB4 (Bit 9)              */
#define BPLC_AGC_TAB_CFG1_AFE_GAIN_TAB4_Msk (0x3fe00UL)             /*!< BPLC AGC_TAB_CFG1: AFE_GAIN_TAB4 (Bitfield-Mask: 0x1ff) */
#define BPLC_AGC_TAB_CFG1_AFE_GAIN_TAB3_Pos (0UL)                   /*!< BPLC AGC_TAB_CFG1: AFE_GAIN_TAB3 (Bit 0)              */
#define BPLC_AGC_TAB_CFG1_AFE_GAIN_TAB3_Msk (0x1ffUL)               /*!< BPLC AGC_TAB_CFG1: AFE_GAIN_TAB3 (Bitfield-Mask: 0x1ff) */
/* =====================================================  AGC_TAB_CFG2  ====================================================== */
#define BPLC_AGC_TAB_CFG2_AFE_GAIN_TAB8_Pos (18UL)                  /*!< BPLC AGC_TAB_CFG2: AFE_GAIN_TAB8 (Bit 18)             */
#define BPLC_AGC_TAB_CFG2_AFE_GAIN_TAB8_Msk (0x7fc0000UL)           /*!< BPLC AGC_TAB_CFG2: AFE_GAIN_TAB8 (Bitfield-Mask: 0x1ff) */
#define BPLC_AGC_TAB_CFG2_AFE_GAIN_TAB7_Pos (9UL)                   /*!< BPLC AGC_TAB_CFG2: AFE_GAIN_TAB7 (Bit 9)              */
#define BPLC_AGC_TAB_CFG2_AFE_GAIN_TAB7_Msk (0x3fe00UL)             /*!< BPLC AGC_TAB_CFG2: AFE_GAIN_TAB7 (Bitfield-Mask: 0x1ff) */
#define BPLC_AGC_TAB_CFG2_AFE_GAIN_TAB6_Pos (0UL)                   /*!< BPLC AGC_TAB_CFG2: AFE_GAIN_TAB6 (Bit 0)              */
#define BPLC_AGC_TAB_CFG2_AFE_GAIN_TAB6_Msk (0x1ffUL)               /*!< BPLC AGC_TAB_CFG2: AFE_GAIN_TAB6 (Bitfield-Mask: 0x1ff) */
/* =====================================================  AGC_TAB_CFG3  ====================================================== */
#define BPLC_AGC_TAB_CFG3_AFE_GAIN_TAB11_Pos (18UL)                 /*!< BPLC AGC_TAB_CFG3: AFE_GAIN_TAB11 (Bit 18)            */
#define BPLC_AGC_TAB_CFG3_AFE_GAIN_TAB11_Msk (0x7fc0000UL)          /*!< BPLC AGC_TAB_CFG3: AFE_GAIN_TAB11 (Bitfield-Mask: 0x1ff) */
#define BPLC_AGC_TAB_CFG3_AFE_GAIN_TAB10_Pos (9UL)                  /*!< BPLC AGC_TAB_CFG3: AFE_GAIN_TAB10 (Bit 9)             */
#define BPLC_AGC_TAB_CFG3_AFE_GAIN_TAB10_Msk (0x3fe00UL)            /*!< BPLC AGC_TAB_CFG3: AFE_GAIN_TAB10 (Bitfield-Mask: 0x1ff) */
#define BPLC_AGC_TAB_CFG3_AFE_GAIN_TAB9_Pos (0UL)                   /*!< BPLC AGC_TAB_CFG3: AFE_GAIN_TAB9 (Bit 0)              */
#define BPLC_AGC_TAB_CFG3_AFE_GAIN_TAB9_Msk (0x1ffUL)               /*!< BPLC AGC_TAB_CFG3: AFE_GAIN_TAB9 (Bitfield-Mask: 0x1ff) */
/* =====================================================  AGC_TAB_CFG4  ====================================================== */
#define BPLC_AGC_TAB_CFG4_AFE_GAIN_TAB14_Pos (18UL)                 /*!< BPLC AGC_TAB_CFG4: AFE_GAIN_TAB14 (Bit 18)            */
#define BPLC_AGC_TAB_CFG4_AFE_GAIN_TAB14_Msk (0x7fc0000UL)          /*!< BPLC AGC_TAB_CFG4: AFE_GAIN_TAB14 (Bitfield-Mask: 0x1ff) */
#define BPLC_AGC_TAB_CFG4_AFE_GAIN_TAB13_Pos (9UL)                  /*!< BPLC AGC_TAB_CFG4: AFE_GAIN_TAB13 (Bit 9)             */
#define BPLC_AGC_TAB_CFG4_AFE_GAIN_TAB13_Msk (0x3fe00UL)            /*!< BPLC AGC_TAB_CFG4: AFE_GAIN_TAB13 (Bitfield-Mask: 0x1ff) */
#define BPLC_AGC_TAB_CFG4_AFE_GAIN_TAB12_Pos (0UL)                  /*!< BPLC AGC_TAB_CFG4: AFE_GAIN_TAB12 (Bit 0)             */
#define BPLC_AGC_TAB_CFG4_AFE_GAIN_TAB12_Msk (0x1ffUL)              /*!< BPLC AGC_TAB_CFG4: AFE_GAIN_TAB12 (Bitfield-Mask: 0x1ff) */
/* =====================================================  AGC_TAB_CFG5  ====================================================== */
#define BPLC_AGC_TAB_CFG5_AFE_GAIN_TAB17_Pos (18UL)                 /*!< BPLC AGC_TAB_CFG5: AFE_GAIN_TAB17 (Bit 18)            */
#define BPLC_AGC_TAB_CFG5_AFE_GAIN_TAB17_Msk (0x7fc0000UL)          /*!< BPLC AGC_TAB_CFG5: AFE_GAIN_TAB17 (Bitfield-Mask: 0x1ff) */
#define BPLC_AGC_TAB_CFG5_AFE_GAIN_TAB16_Pos (9UL)                  /*!< BPLC AGC_TAB_CFG5: AFE_GAIN_TAB16 (Bit 9)             */
#define BPLC_AGC_TAB_CFG5_AFE_GAIN_TAB16_Msk (0x3fe00UL)            /*!< BPLC AGC_TAB_CFG5: AFE_GAIN_TAB16 (Bitfield-Mask: 0x1ff) */
#define BPLC_AGC_TAB_CFG5_AFE_GAIN_TAB15_Pos (0UL)                  /*!< BPLC AGC_TAB_CFG5: AFE_GAIN_TAB15 (Bit 0)             */
#define BPLC_AGC_TAB_CFG5_AFE_GAIN_TAB15_Msk (0x1ffUL)              /*!< BPLC AGC_TAB_CFG5: AFE_GAIN_TAB15 (Bitfield-Mask: 0x1ff) */
/* =====================================================  AGC_TAB_CFG6  ====================================================== */
#define BPLC_AGC_TAB_CFG6_AFE_GAIN_TAB20_Pos (18UL)                 /*!< BPLC AGC_TAB_CFG6: AFE_GAIN_TAB20 (Bit 18)            */
#define BPLC_AGC_TAB_CFG6_AFE_GAIN_TAB20_Msk (0x7fc0000UL)          /*!< BPLC AGC_TAB_CFG6: AFE_GAIN_TAB20 (Bitfield-Mask: 0x1ff) */
#define BPLC_AGC_TAB_CFG6_AFE_GAIN_TAB19_Pos (9UL)                  /*!< BPLC AGC_TAB_CFG6: AFE_GAIN_TAB19 (Bit 9)             */
#define BPLC_AGC_TAB_CFG6_AFE_GAIN_TAB19_Msk (0x3fe00UL)            /*!< BPLC AGC_TAB_CFG6: AFE_GAIN_TAB19 (Bitfield-Mask: 0x1ff) */
#define BPLC_AGC_TAB_CFG6_AFE_GAIN_TAB18_Pos (0UL)                  /*!< BPLC AGC_TAB_CFG6: AFE_GAIN_TAB18 (Bit 0)             */
#define BPLC_AGC_TAB_CFG6_AFE_GAIN_TAB18_Msk (0x1ffUL)              /*!< BPLC AGC_TAB_CFG6: AFE_GAIN_TAB18 (Bitfield-Mask: 0x1ff) */
/* =====================================================  AGC_TAB_CFG7  ====================================================== */
#define BPLC_AGC_TAB_CFG7_AFE_GAIN_TAB23_Pos (18UL)                 /*!< BPLC AGC_TAB_CFG7: AFE_GAIN_TAB23 (Bit 18)            */
#define BPLC_AGC_TAB_CFG7_AFE_GAIN_TAB23_Msk (0x7fc0000UL)          /*!< BPLC AGC_TAB_CFG7: AFE_GAIN_TAB23 (Bitfield-Mask: 0x1ff) */
#define BPLC_AGC_TAB_CFG7_AFE_GAIN_TAB22_Pos (9UL)                  /*!< BPLC AGC_TAB_CFG7: AFE_GAIN_TAB22 (Bit 9)             */
#define BPLC_AGC_TAB_CFG7_AFE_GAIN_TAB22_Msk (0x3fe00UL)            /*!< BPLC AGC_TAB_CFG7: AFE_GAIN_TAB22 (Bitfield-Mask: 0x1ff) */
#define BPLC_AGC_TAB_CFG7_AFE_GAIN_TAB21_Pos (0UL)                  /*!< BPLC AGC_TAB_CFG7: AFE_GAIN_TAB21 (Bit 0)             */
#define BPLC_AGC_TAB_CFG7_AFE_GAIN_TAB21_Msk (0x1ffUL)              /*!< BPLC AGC_TAB_CFG7: AFE_GAIN_TAB21 (Bitfield-Mask: 0x1ff) */
/* =====================================================  AGC_TAB_CFG8  ====================================================== */
#define BPLC_AGC_TAB_CFG8_AFE_GAIN_TAB26_Pos (18UL)                 /*!< BPLC AGC_TAB_CFG8: AFE_GAIN_TAB26 (Bit 18)            */
#define BPLC_AGC_TAB_CFG8_AFE_GAIN_TAB26_Msk (0x7fc0000UL)          /*!< BPLC AGC_TAB_CFG8: AFE_GAIN_TAB26 (Bitfield-Mask: 0x1ff) */
#define BPLC_AGC_TAB_CFG8_AFE_GAIN_TAB25_Pos (9UL)                  /*!< BPLC AGC_TAB_CFG8: AFE_GAIN_TAB25 (Bit 9)             */
#define BPLC_AGC_TAB_CFG8_AFE_GAIN_TAB25_Msk (0x3fe00UL)            /*!< BPLC AGC_TAB_CFG8: AFE_GAIN_TAB25 (Bitfield-Mask: 0x1ff) */
#define BPLC_AGC_TAB_CFG8_AFE_GAIN_TAB24_Pos (0UL)                  /*!< BPLC AGC_TAB_CFG8: AFE_GAIN_TAB24 (Bit 0)             */
#define BPLC_AGC_TAB_CFG8_AFE_GAIN_TAB24_Msk (0x1ffUL)              /*!< BPLC AGC_TAB_CFG8: AFE_GAIN_TAB24 (Bitfield-Mask: 0x1ff) */
/* =====================================================  AGC_TAB_CFG9  ====================================================== */
#define BPLC_AGC_TAB_CFG9_AFE_GAIN_TAB29_Pos (18UL)                 /*!< BPLC AGC_TAB_CFG9: AFE_GAIN_TAB29 (Bit 18)            */
#define BPLC_AGC_TAB_CFG9_AFE_GAIN_TAB29_Msk (0x7fc0000UL)          /*!< BPLC AGC_TAB_CFG9: AFE_GAIN_TAB29 (Bitfield-Mask: 0x1ff) */
#define BPLC_AGC_TAB_CFG9_AFE_GAIN_TAB28_Pos (9UL)                  /*!< BPLC AGC_TAB_CFG9: AFE_GAIN_TAB28 (Bit 9)             */
#define BPLC_AGC_TAB_CFG9_AFE_GAIN_TAB28_Msk (0x3fe00UL)            /*!< BPLC AGC_TAB_CFG9: AFE_GAIN_TAB28 (Bitfield-Mask: 0x1ff) */
#define BPLC_AGC_TAB_CFG9_AFE_GAIN_TAB27_Pos (0UL)                  /*!< BPLC AGC_TAB_CFG9: AFE_GAIN_TAB27 (Bit 0)             */
#define BPLC_AGC_TAB_CFG9_AFE_GAIN_TAB27_Msk (0x1ffUL)              /*!< BPLC AGC_TAB_CFG9: AFE_GAIN_TAB27 (Bitfield-Mask: 0x1ff) */
/* =====================================================  AGC_TAB_CFG10  ===================================================== */
#define BPLC_AGC_TAB_CFG10_AFE_GAIN_TAB31_Pos (9UL)                 /*!< BPLC AGC_TAB_CFG10: AFE_GAIN_TAB31 (Bit 9)            */
#define BPLC_AGC_TAB_CFG10_AFE_GAIN_TAB31_Msk (0x3fe00UL)           /*!< BPLC AGC_TAB_CFG10: AFE_GAIN_TAB31 (Bitfield-Mask: 0x1ff) */
#define BPLC_AGC_TAB_CFG10_AFE_GAIN_TAB30_Pos (0UL)                 /*!< BPLC AGC_TAB_CFG10: AFE_GAIN_TAB30 (Bit 0)            */
#define BPLC_AGC_TAB_CFG10_AFE_GAIN_TAB30_Msk (0x1ffUL)             /*!< BPLC AGC_TAB_CFG10: AFE_GAIN_TAB30 (Bitfield-Mask: 0x1ff) */
/* =======================================================  GAD_CFG0  ======================================================== */
...
/* =======================================================  GAD_CFG2  ======================================================== */
#define BPLC_GAD_CFG2_GAD_RMS_FLT_ALPH_Pos (16UL)                   /*!< BPLC GAD_CFG2: GAD_RMS_FLT_ALPH (Bit 16)              */
#define BPLC_GAD_CFG2_GAD_RMS_FLT_ALPH_Msk (0x70000UL)              /*!< BPLC GAD_CFG2: GAD_RMS_FLT_ALPH (Bitfield-Mask: 0x07) */
...
/* =====================================================  TONE_RM_CFG0  ====================================================== */
#define BPLC_TONE_RM_CFG0_TONE_RM2_LSHFT_Pos (24UL)                 /*!< BPLC TONE_RM_CFG0: TONE_RM2_LSHFT (Bit 24)            */
#define BPLC_TONE_RM_CFG0_TONE_RM2_LSHFT_Msk (0xff000000UL)         /*!< BPLC TONE_RM_CFG0: TONE_RM2_LSHFT (Bitfield-Mask: 0xff) */
...
#define BPLC_TONE_RM_CFG0_TONE_RM2_ENABLE_Pos (8UL)                 /*!< BPLC TONE_RM_CFG0: TONE_RM2_ENABLE (Bit 8)            */
#define BPLC_TONE_RM_CFG0_TONE_RM2_ENABLE_Msk (0xff00UL)            /*!< BPLC TONE_RM_CFG0: TONE_RM2_ENABLE (Bitfield-Mask: 0xff) */
...
/* =====================================================  TONE_RM_CFG1  ====================================================== */
#define BPLC_TONE_RM_CFG1_TONE_RM_A11_Pos (16UL)                    /*!< BPLC TONE_RM_CFG1: TONE_RM_A11 (Bit 16)               */
#define BPLC_TONE_RM_CFG1_TONE_RM_A11_Msk (0xffff0000UL)            /*!< BPLC TONE_RM_CFG1: TONE_RM_A11 (Bitfield-Mask: 0xffff) */
#define BPLC_TONE_RM_CFG1_TONE_RM_A10_Pos (0UL)                     /*!< BPLC TONE_RM_CFG1: TONE_RM_A10 (Bit 0)                */
#define BPLC_TONE_RM_CFG1_TONE_RM_A10_Msk (0xffffUL)                /*!< BPLC TONE_RM_CFG1: TONE_RM_A10 (Bitfield-Mask: 0xffff) */
/* =====================================================  TONE_RM_CFG2  ====================================================== */
#define BPLC_TONE_RM_CFG2_TONE_RM_A13_Pos (16UL)                    /*!< BPLC TONE_RM_CFG2: TONE_RM_A13 (Bit 16)               */
#define BPLC_TONE_RM_CFG2_TONE_RM_A13_Msk (0xffff0000UL)            /*!< BPLC TONE_RM_CFG2: TONE_RM_A13 (Bitfield-Mask: 0xffff) */
#define BPLC_TONE_RM_CFG2_TONE_RM_A12_Pos (0UL)                     /*!< BPLC TONE_RM_CFG2: TONE_RM_A12 (Bit 0)                */
#define BPLC_TONE_RM_CFG2_TONE_RM_A12_Msk (0xffffUL)                /*!< BPLC TONE_RM_CFG2: TONE_RM_A12 (Bitfield-Mask: 0xffff) */
/* =====================================================  TONE_RM_CFG3  ====================================================== */
#define BPLC_TONE_RM_CFG3_TONE_RM_A15_Pos (16UL)                    /*!< BPLC TONE_RM_CFG3: TONE_RM_A15 (Bit 16)               */
#define BPLC_TONE_RM_CFG3_TONE_RM_A15_Msk (0xffff0000UL)            /*!< BPLC TONE_RM_CFG3: TONE_RM_A15 (Bitfield-Mask: 0xffff) */
#define BPLC_TONE_RM_CFG3_TONE_RM_A14_Pos (0UL)                     /*!< BPLC TONE_RM_CFG3: TONE_RM_A14 (Bit 0)                */
#define BPLC_TONE_RM_CFG3_TONE_RM_A14_Msk (0xffffUL)                /*!< BPLC TONE_RM_CFG3: TONE_RM_A14 (Bitfield-Mask: 0xffff) */
/* =====================================================  TONE_RM_CFG4  ====================================================== */
#define BPLC_TONE_RM_CFG4_TONE_RM_A17_Pos (16UL)                    /*!< BPLC TONE_RM_CFG4: TONE_RM_A17 (Bit 16)               */
#define BPLC_TONE_RM_CFG4_TONE_RM_A17_Msk (0xffff0000UL)            /*!< BPLC TONE_RM_CFG4: TONE_RM_A17 (Bitfield-Mask: 0xffff) */
#define BPLC_TONE_RM_CFG4_TONE_RM_A16_Pos (0UL)                     /*!< BPLC TONE_RM_CFG4: TONE_RM_A16 (Bit 0)                */
#define BPLC_TONE_RM_CFG4_TONE_RM_A16_Msk (0xffffUL)                /*!< BPLC TONE_RM_CFG4: TONE_RM_A16 (Bitfield-Mask: 0xffff) */
/* =====================================================  TONE_RM_CFG5  ====================================================== */
#define BPLC_TONE_RM_CFG5_TONE_RM_B11_Pos (16UL)                    /*!< BPLC TONE_RM_CFG5: TONE_RM_B11 (Bit 16)               */
#define BPLC_TONE_RM_CFG5_TONE_RM_B11_Msk (0xffff0000UL)            /*!< BPLC TONE_RM_CFG5: TONE_RM_B11 (Bitfield-Mask: 0xffff) */
#define BPLC_TONE_RM_CFG5_TONE_RM_B10_Pos (0UL)                     /*!< BPLC TONE_RM_CFG5: TONE_RM_B10 (Bit 0)                */
#define BPLC_TONE_RM_CFG5_TONE_RM_B10_Msk (0xffffUL)                /*!< BPLC TONE_RM_CFG5: TONE_RM_B10 (Bitfield-Mask: 0xffff) */
/* =====================================================  TONE_RM_CFG6  ====================================================== */
#define BPLC_TONE_RM_CFG6_TONE_RM_B13_Pos (16UL)                    /*!< BPLC TONE_RM_CFG6: TONE_RM_B13 (Bit 16)               */
#define BPLC_TONE_RM_CFG6_TONE_RM_B13_Msk (0xffff0000UL)            /*!< BPLC TONE_RM_CFG6: TONE_RM_B13 (Bitfield-Mask: 0xffff) */
#define BPLC_TONE_RM_CFG6_TONE_RM_B12_Pos (0UL)                     /*!< BPLC TONE_RM_CFG6: TONE_RM_B12 (Bit 0)                */
#define BPLC_TONE_RM_CFG6_TONE_RM_B12_Msk (0xffffUL)                /*!< BPLC TONE_RM_CFG6: TONE_RM_B12 (Bitfield-Mask: 0xffff) */
/* =====================================================  TONE_RM_CFG7  ====================================================== */
#define BPLC_TONE_RM_CFG7_TONE_RM_B15_Pos (16UL)                    /*!< BPLC TONE_RM_CFG7: TONE_RM_B15 (Bit 16)               */
#define BPLC_TONE_RM_CFG7_TONE_RM_B15_Msk (0xffff0000UL)            /*!< BPLC TONE_RM_CFG7: TONE_RM_B15 (Bitfield-Mask: 0xffff) */
#define BPLC_TONE_RM_CFG7_TONE_RM_B14_Pos (0UL)                     /*!< BPLC TONE_RM_CFG7: TONE_RM_B14 (Bit 0)                */
#define BPLC_TONE_RM_CFG7_TONE_RM_B14_Msk (0xffffUL)                /*!< BPLC TONE_RM_CFG7: TONE_RM_B14 (Bitfield-Mask: 0xffff) */
/* =====================================================  TONE_RM_CFG8  ====================================================== */
#define BPLC_TONE_RM_CFG8_TONE_RM_B17_Pos (16UL)                    /*!< BPLC TONE_RM_CFG8: TONE_RM_B17 (Bit 16)               */
#define BPLC_TONE_RM_CFG8_TONE_RM_B17_Msk (0xffff0000UL)            /*!< BPLC TONE_RM_CFG8: TONE_RM_B17 (Bitfield-Mask: 0xffff) */
#define BPLC_TONE_RM_CFG8_TONE_RM_B16_Pos (0UL)                     /*!< BPLC TONE_RM_CFG8: TONE_RM_B16 (Bit 0)                */
#define BPLC_TONE_RM_CFG8_TONE_RM_B16_Msk (0xffffUL)                /*!< BPLC TONE_RM_CFG8: TONE_RM_B16 (Bitfield-Mask: 0xffff) */
/* =====================================================  TONE_RM_CFG9  ====================================================== */
#define BPLC_TONE_RM_CFG9_TONE_RM_B21_Pos (16UL)                    /*!< BPLC TONE_RM_CFG9: TONE_RM_B21 (Bit 16)               */
#define BPLC_TONE_RM_CFG9_TONE_RM_B21_Msk (0xffff0000UL)            /*!< BPLC TONE_RM_CFG9: TONE_RM_B21 (Bitfield-Mask: 0xffff) */
#define BPLC_TONE_RM_CFG9_TONE_RM_B20_Pos (0UL)                     /*!< BPLC TONE_RM_CFG9: TONE_RM_B20 (Bit 0)                */
#define BPLC_TONE_RM_CFG9_TONE_RM_B20_Msk (0xffffUL)                /*!< BPLC TONE_RM_CFG9: TONE_RM_B20 (Bitfield-Mask: 0xffff) */
/* =====================================================  TONE_RM_CFG10  ===================================================== */
#define BPLC_TONE_RM_CFG10_TONE_RM_B23_Pos (16UL)                   /*!< BPLC TONE_RM_CFG10: TONE_RM_B23 (Bit 16)              */
#define BPLC_TONE_RM_CFG10_TONE_RM_B23_Msk (0xffff0000UL)           /*!< BPLC TONE_RM_CFG10: TONE_RM_B23 (Bitfield-Mask: 0xffff) */
#define BPLC_TONE_RM_CFG10_TONE_RM_B22_Pos (0UL)                    /*!< BPLC TONE_RM_CFG10: TONE_RM_B22 (Bit 0)               */
#define BPLC_TONE_RM_CFG10_TONE_RM_B22_Msk (0xffffUL)               /*!< BPLC TONE_RM_CFG10: TONE_RM_B22 (Bitfield-Mask: 0xffff) */
/* =====================================================  TONE_RM_CFG11  ===================================================== */
#define BPLC_TONE_RM_CFG11_TONE_RM_B25_Pos (16UL)                   /*!< BPLC TONE_RM_CFG11: TONE_RM_B25 (Bit 16)              */
#define BPLC_TONE_RM_CFG11_TONE_RM_B25_Msk (0xffff0000UL)           /*!< BPLC TONE_RM_CFG11: TONE_RM_B25 (Bitfield-Mask: 0xffff) */
#define BPLC_TONE_RM_CFG11_TONE_RM_B24_Pos (0UL)                    /*!< BPLC TONE_RM_CFG11: TONE_RM_B24 (Bit 0)               */
#define BPLC_TONE_RM_CFG11_TONE_RM_B24_Msk (0xffffUL)               /*!< BPLC TONE_RM_CFG11: TONE_RM_B24 (Bitfield-Mask: 0xffff) */
/* =====================================================  TONE_RM_CFG12  ===================================================== */
#define BPLC_TONE_RM_CFG12_TONE_RM_B27_Pos (16UL)                   /*!< BPLC TONE_RM_CFG12: TONE_RM_B27 (Bit 16)              */
#define BPLC_TONE_RM_CFG12_TONE_RM_B27_Msk (0xffff0000UL)           /*!< BPLC TONE_RM_CFG12: TONE_RM_B27 (Bitfield-Mask: 0xffff) */
#define BPLC_TONE_RM_CFG12_TONE_RM_B26_Pos (0UL)                    /*!< BPLC TONE_RM_CFG12: TONE_RM_B26 (Bit 0)               */
#define BPLC_TONE_RM_CFG12_TONE_RM_B26_Msk (0xffffUL)               /*!< BPLC TONE_RM_CFG12: TONE_RM_B26 (Bitfield-Mask: 0xffff) */
/* =====================================================  TONE_RM_CFG13  ===================================================== */
#define BPLC_TONE_RM_CFG13_TONE_RM2_A11_Pos (16UL)                  /*!< BPLC TONE_RM_CFG13: TONE_RM2_A11 (Bit 16)             */
#define BPLC_TONE_RM_CFG13_TONE_RM2_A11_Msk (0xffff0000UL)          /*!< BPLC TONE_RM_CFG13: TONE_RM2_A11 (Bitfield-Mask: 0xffff) */
#define BPLC_TONE_RM_CFG13_TONE_RM2_A10_Pos (0UL)                   /*!< BPLC TONE_RM_CFG13: TONE_RM2_A10 (Bit 0)              */
#define BPLC_TONE_RM_CFG13_TONE_RM2_A10_Msk (0xffffUL)              /*!< BPLC TONE_RM_CFG13: TONE_RM2_A10 (Bitfield-Mask: 0xffff) */
/* =====================================================  TONE_RM_CFG14  ===================================================== */
#define BPLC_TONE_RM_CFG14_TONE_RM2_A13_Pos (16UL)                  /*!< BPLC TONE_RM_CFG14: TONE_RM2_A13 (Bit 16)             */
#define BPLC_TONE_RM_CFG14_TONE_RM2_A13_Msk (0xffff0000UL)          /*!< BPLC TONE_RM_CFG14: TONE_RM2_A13 (Bitfield-Mask: 0xffff) */
#define BPLC_TONE_RM_CFG14_TONE_RM2_A12_Pos (0UL)                   /*!< BPLC TONE_RM_CFG14: TONE_RM2_A12 (Bit 0)              */
#define BPLC_TONE_RM_CFG14_TONE_RM2_A12_Msk (0xffffUL)              /*!< BPLC TONE_RM_CFG14: TONE_RM2_A12 (Bitfield-Mask: 0xffff) */
/* =====================================================  TONE_RM_CFG15  ===================================================== */
#define BPLC_TONE_RM_CFG15_TONE_RM2_A15_Pos (16UL)                  /*!< BPLC TONE_RM_CFG15: TONE_RM2_A15 (Bit 16)             */
#define BPLC_TONE_RM_CFG15_TONE_RM2_A15_Msk (0xffff0000UL)          /*!< BPLC TONE_RM_CFG15: TONE_RM2_A15 (Bitfield-Mask: 0xffff) */
#define BPLC_TONE_RM_CFG15_TONE_RM2_A14_Pos (0UL)                   /*!< BPLC TONE_RM_CFG15: TONE_RM2_A14 (Bit 0)              */
#define BPLC_TONE_RM_CFG15_TONE_RM2_A14_Msk (0xffffUL)              /*!< BPLC TONE_RM_CFG15: TONE_RM2_A14 (Bitfield-Mask: 0xffff) */
/* =====================================================  TONE_RM_CFG16  ===================================================== */
#define BPLC_TONE_RM_CFG16_TONE_RM2_A17_Pos (16UL)                  /*!< BPLC TONE_RM_CFG16: TONE_RM2_A17 (Bit 16)             */
#define BPLC_TONE_RM_CFG16_TONE_RM2_A17_Msk (0xffff0000UL)          /*!< BPLC TONE_RM_CFG16: TONE_RM2_A17 (Bitfield-Mask: 0xffff) */
#define BPLC_TONE_RM_CFG16_TONE_RM2_A16_Pos (0UL)                   /*!< BPLC TONE_RM_CFG16: TONE_RM2_A16 (Bit 0)              */
#define BPLC_TONE_RM_CFG16_TONE_RM2_A16_Msk (0xffffUL)              /*!< BPLC TONE_RM_CFG16: TONE_RM2_A16 (Bitfield-Mask: 0xffff) */
/* =====================================================  TONE_RM_CFG17  ===================================================== */
#define BPLC_TONE_RM_CFG17_TONE_RM2_B11_Pos (16UL)                  /*!< BPLC TONE_RM_CFG17: TONE_RM2_B11 (Bit 16)             */
#define BPLC_TONE_RM_CFG17_TONE_RM2_B11_Msk (0xffff0000UL)          /*!< BPLC TONE_RM_CFG17: TONE_RM2_B11 (Bitfield-Mask: 0xffff) */
#define BPLC_TONE_RM_CFG17_TONE_RM2_B10_Pos (0UL)                   /*!< BPLC TONE_RM_CFG17: TONE_RM2_B10 (Bit 0)              */
#define BPLC_TONE_RM_CFG17_TONE_RM2_B10_Msk (0xffffUL)              /*!< BPLC TONE_RM_CFG17: TONE_RM2_B10 (Bitfield-Mask: 0xffff) */
/* =====================================================  TONE_RM_CFG18  ===================================================== */
#define BPLC_TONE_RM_CFG18_TONE_RM2_B13_Pos (16UL)                  /*!< BPLC TONE_RM_CFG18: TONE_RM2_B13 (Bit 16)             */
#define BPLC_TONE_RM_CFG18_TONE_RM2_B13_Msk (0xffff0000UL)          /*!< BPLC TONE_RM_CFG18: TONE_RM2_B13 (Bitfield-Mask: 0xffff) */
#define BPLC_TONE_RM_CFG18_TONE_RM2_B12_Pos (0UL)                   /*!< BPLC TONE_RM_CFG18: TONE_RM2_B12 (Bit 0)              */
#define BPLC_TONE_RM_CFG18_TONE_RM2_B12_Msk (0xffffUL)              /*!< BPLC TONE_RM_CFG18: TONE_RM2_B12 (Bitfield-Mask: 0xffff) */
/* =====================================================  TONE_RM_CFG19  ===================================================== */
#define BPLC_TONE_RM_CFG19_TONE_RM2_B15_Pos (16UL)                  /*!< BPLC TONE_RM_CFG19: TONE_RM2_B15 (Bit 16)             */
#define BPLC_TONE_RM_CFG19_TONE_RM2_B15_Msk (0xffff0000UL)          /*!< BPLC TONE_RM_CFG19: TONE_RM2_B15 (Bitfield-Mask: 0xffff) */
#define BPLC_TONE_RM_CFG19_TONE_RM2_B14_Pos (0UL)                   /*!< BPLC TONE_RM_CFG19: TONE_RM2_B14 (Bit 0)              */
#define BPLC_TONE_RM_CFG19_TONE_RM2_B14_Msk (0xffffUL)              /*!< BPLC TONE_RM_CFG19: TONE_RM2_B14 (Bitfield-Mask: 0xffff) */
/* =====================================================  TONE_RM_CFG20  ===================================================== */
#define BPLC_TONE_RM_CFG20_TONE_RM2_B17_Pos (16UL)                  /*!< BPLC TONE_RM_CFG20: TONE_RM2_B17 (Bit 16)             */
#define BPLC_TONE_RM_CFG20_TONE_RM2_B17_Msk (0xffff0000UL)          /*!< BPLC TONE_RM_CFG20: TONE_RM2_B17 (Bitfield-Mask: 0xffff) */
#define BPLC_TONE_RM_CFG20_TONE_RM2_B16_Pos (0UL)                   /*!< BPLC TONE_RM_CFG20: TONE_RM2_B16 (Bit 0)              */
#define BPLC_TONE_RM_CFG20_TONE_RM2_B16_Msk (0xffffUL)              /*!< BPLC TONE_RM_CFG20: TONE_RM2_B16 (Bitfield-Mask: 0xffff) */
/* =====================================================  TONE_RM_CFG21  ===================================================== */
#define BPLC_TONE_RM_CFG21_TONE_RM2_B21_Pos (16UL)                  /*!< BPLC TONE_RM_CFG21: TONE_RM2_B21 (Bit 16)             */
#define BPLC_TONE_RM_CFG21_TONE_RM2_B21_Msk (0xffff0000UL)          /*!< BPLC TONE_RM_CFG21: TONE_RM2_B21 (Bitfield-Mask: 0xffff) */
#define BPLC_TONE_RM_CFG21_TONE_RM2_B20_Pos (0UL)                   /*!< BPLC TONE_RM_CFG21: TONE_RM2_B20 (Bit 0)              */
#define BPLC_TONE_RM_CFG21_TONE_RM2_B20_Msk (0xffffUL)              /*!< BPLC TONE_RM_CFG21: TONE_RM2_B20 (Bitfield-Mask: 0xffff) */
/* =====================================================  TONE_RM_CFG22  ===================================================== */
#define BPLC_TONE_RM_CFG22_TONE_RM2_B23_Pos (16UL)                  /*!< BPLC TONE_RM_CFG22: TONE_RM2_B23 (Bit 16)             */
#define BPLC_TONE_RM_CFG22_TONE_RM2_B23_Msk (0xffff0000UL)          /*!< BPLC TONE_RM_CFG22: TONE_RM2_B23 (Bitfield-Mask: 0xffff) */
#define BPLC_TONE_RM_CFG22_TONE_RM2_B22_Pos (0UL)                   /*!< BPLC TONE_RM_CFG22: TONE_RM2_B22 (Bit 0)              */
#define BPLC_TONE_RM_CFG22_TONE_RM2_B22_Msk (0xffffUL)              /*!< BPLC TONE_RM_CFG22: TONE_RM2_B22 (Bitfield-Mask: 0xffff) */
/* =====================================================  TONE_RM_CFG23  ===================================================== */
#define BPLC_TONE_RM_CFG23_TONE_RM2_B25_Pos (16UL)                  /*!< BPLC TONE_RM_CFG23: TONE_RM2_B25 (Bit 16)             */
#define BPLC_TONE_RM_CFG23_TONE_RM2_B25_Msk (0xffff0000UL)          /*!< BPLC TONE_RM_CFG23: TONE_RM2_B25 (Bitfield-Mask: 0xffff) */
#define BPLC_TONE_RM_CFG23_TONE_RM2_B24_Pos (0UL)                   /*!< BPLC TONE_RM_CFG23: TONE_RM2_B24 (Bit 0)              */
#define BPLC_TONE_RM_CFG23_TONE_RM2_B24_Msk (0xffffUL)              /*!< BPLC TONE_RM_CFG23: TONE_RM2_B24 (Bitfield-Mask: 0xffff) */
/* =====================================================  TONE_RM_CFG24  ===================================================== */
#define BPLC_TONE_RM_CFG24_TONE_RM2_B27_Pos (16UL)                  /*!< BPLC TONE_RM_CFG24: TONE_RM2_B27 (Bit 16)             */
#define BPLC_TONE_RM_CFG24_TONE_RM2_B27_Msk (0xffff0000UL)          /*!< BPLC TONE_RM_CFG24: TONE_RM2_B27 (Bitfield-Mask: 0xffff) */
#define BPLC_TONE_RM_CFG24_TONE_RM2_B26_Pos (0UL)                   /*!< BPLC TONE_RM_CFG24: TONE_RM2_B26 (Bit 0)              */
#define BPLC_TONE_RM_CFG24_TONE_RM2_B26_Msk (0xffffUL)              /*!< BPLC TONE_RM_CFG24: TONE_RM2_B26 (Bitfield-Mask: 0xffff) */
/* =====================================================  PULSE_RM_CFG0  ===================================================== */
#define BPLC_PULSE_RM_CFG0_PR_PULSE_RMS_THR_Pos (8UL)               /*!< BPLC PULSE_RM_CFG0: PR_PULSE_RMS_THR (Bit 8)          */
#define BPLC_PULSE_RM_CFG0_PR_PULSE_RMS_THR_Msk (0x3f00UL)          /*!< BPLC PULSE_RM_CFG0: PR_PULSE_RMS_THR (Bitfield-Mask: 0x3f) */
#define BPLC_PULSE_RM_CFG0_PR_SEG_NUM_Pos (5UL)                     /*!< BPLC PULSE_RM_CFG0: PR_SEG_NUM (Bit 5)                */
#define BPLC_PULSE_RM_CFG0_PR_SEG_NUM_Msk (0xe0UL)                  /*!< BPLC PULSE_RM_CFG0: PR_SEG_NUM (Bitfield-Mask: 0x07)  */
#define BPLC_PULSE_RM_CFG0_PR_SEG_LEN_OPT_Pos (2UL)                 /*!< BPLC PULSE_RM_CFG0: PR_SEG_LEN_OPT (Bit 2)            */
#define BPLC_PULSE_RM_CFG0_PR_SEG_LEN_OPT_Msk (0x1cUL)              /*!< BPLC PULSE_RM_CFG0: PR_SEG_LEN_OPT (Bitfield-Mask: 0x07) */
#define BPLC_PULSE_RM_CFG0_PR_LOCK_RMS_ENABLE_Pos (1UL)             /*!< BPLC PULSE_RM_CFG0: PR_LOCK_RMS_ENABLE (Bit 1)        */
#define BPLC_PULSE_RM_CFG0_PR_LOCK_RMS_ENABLE_Msk (0x2UL)           /*!< BPLC PULSE_RM_CFG0: PR_LOCK_RMS_ENABLE (Bitfield-Mask: 0x01) */
#define BPLC_PULSE_RM_CFG0_PR_ENABLE_Pos  (0UL)                     /*!< BPLC PULSE_RM_CFG0: PR_ENABLE (Bit 0)                 */
#define BPLC_PULSE_RM_CFG0_PR_ENABLE_Msk  (0x1UL)                   /*!< BPLC PULSE_RM_CFG0: PR_ENABLE (Bitfield-Mask: 0x01)   */
/* ====================================================  PULSE_DET_CFG0  ===================================================== */
...
/* ======================================================  FSK_TX_CFG0  ====================================================== */
#define BPLC_FSK_TX_CFG0_FSK_STOP_NEXT_PHASE_Pos (25UL)             /*!< BPLC FSK_TX_CFG0: FSK_STOP_NEXT_PHASE (Bit 25)        */
#define BPLC_FSK_TX_CFG0_FSK_STOP_NEXT_PHASE_Msk (0x2000000UL)      /*!< BPLC FSK_TX_CFG0: FSK_STOP_NEXT_PHASE (Bitfield-Mask: 0x01) */
#define BPLC_FSK_TX_CFG0_FSK_TX_ENABLE_Pos (24UL)                   /*!< BPLC FSK_TX_CFG0: FSK_TX_ENABLE (Bit 24)              */
#define BPLC_FSK_TX_CFG0_FSK_TX_ENABLE_Msk (0x1000000UL)            /*!< BPLC FSK_TX_CFG0: FSK_TX_ENABLE (Bitfield-Mask: 0x01) */
#define BPLC_FSK_TX_CFG0_FSK_BIT_PERIOD_Pos (0UL)                   /*!< BPLC FSK_TX_CFG0: FSK_BIT_PERIOD (Bit 0)              */
#define BPLC_FSK_TX_CFG0_FSK_BIT_PERIOD_Msk (0xffffffUL)            /*!< BPLC FSK_TX_CFG0: FSK_BIT_PERIOD (Bitfield-Mask: 0xffffff) */
/* ======================================================  FSK_TX_CFG1  ====================================================== */
#define BPLC_FSK_TX_CFG1_FSK_NEXT_PHASE_STEP_Pos (0UL)              /*!< BPLC FSK_TX_CFG1: FSK_NEXT_PHASE_STEP (Bit 0)         */
#define BPLC_FSK_TX_CFG1_FSK_NEXT_PHASE_STEP_Msk (0xffffffffUL)     /*!< BPLC FSK_TX_CFG1: FSK_NEXT_PHASE_STEP (Bitfield-Mask: 0xffffffff) */
/* ======================================================  FSK_TX_CFG2  ====================================================== */
#define BPLC_FSK_TX_CFG2_FSK_INI_PHASE_Pos (0UL)                    /*!< BPLC FSK_TX_CFG2: FSK_INI_PHASE (Bit 0)               */
#define BPLC_FSK_TX_CFG2_FSK_INI_PHASE_Msk (0xffffffffUL)           /*!< BPLC FSK_TX_CFG2: FSK_INI_PHASE (Bitfield-Mask: 0xffffffff) */
/* ====================================================  TONE_NOTCH_TAB0  ==================================================== */
#define BPLC_TONE_NOTCH_TAB0_TONE_NOTCH_TAB0_Pos (0UL)              /*!< BPLC TONE_NOTCH_TAB0: TONE_NOTCH_TAB0 (Bit 0)         */
#define BPLC_TONE_NOTCH_TAB0_TONE_NOTCH_TAB0_Msk (0xffffffffUL)     /*!< BPLC TONE_NOTCH_TAB0: TONE_NOTCH_TAB0 (Bitfield-Mask: 0xffffffff) */
/* ====================================================  TONE_NOTCH_TAB1  ==================================================== */
#define BPLC_TONE_NOTCH_TAB1_TONE_NOTCH_TAB1_Pos (0UL)              /*!< BPLC TONE_NOTCH_TAB1: TONE_NOTCH_TAB1 (Bit 0)         */
#define BPLC_TONE_NOTCH_TAB1_TONE_NOTCH_TAB1_Msk (0xffffffffUL)     /*!< BPLC TONE_NOTCH_TAB1: TONE_NOTCH_TAB1 (Bitfield-Mask: 0xffffffff) */
/* ====================================================  TONE_NOTCH_TAB2  ==================================================== */
#define BPLC_TONE_NOTCH_TAB2_TONE_NOTCH_TAB2_Pos (0UL)              /*!< BPLC TONE_NOTCH_TAB2: TONE_NOTCH_TAB2 (Bit 0)         */
#define BPLC_TONE_NOTCH_TAB2_TONE_NOTCH_TAB2_Msk (0xffffffffUL)     /*!< BPLC TONE_NOTCH_TAB2: TONE_NOTCH_TAB2 (Bitfield-Mask: 0xffffffff) */
/* ====================================================  TONE_NOTCH_TAB3  ==================================================== */
#define BPLC_TONE_NOTCH_TAB3_TONE_NOTCH_TAB3_Pos (0UL)              /*!< BPLC TONE_NOTCH_TAB3: TONE_NOTCH_TAB3 (Bit 0)         */
#define BPLC_TONE_NOTCH_TAB3_TONE_NOTCH_TAB3_Msk (0xffffffffUL)     /*!< BPLC TONE_NOTCH_TAB3: TONE_NOTCH_TAB3 (Bitfield-Mask: 0xffffffff) */
/* ====================================================  TONE_NOTCH_TAB4  ==================================================== */
#define BPLC_TONE_NOTCH_TAB4_TONE_NOTCH_TAB4_Pos (0UL)              /*!< BPLC TONE_NOTCH_TAB4: TONE_NOTCH_TAB4 (Bit 0)         */
#define BPLC_TONE_NOTCH_TAB4_TONE_NOTCH_TAB4_Msk (0xffffffffUL)     /*!< BPLC TONE_NOTCH_TAB4: TONE_NOTCH_TAB4 (Bitfield-Mask: 0xffffffff) */
/* ====================================================  TONE_NOTCH_TAB5  ==================================================== */
#define BPLC_TONE_NOTCH_TAB5_TONE_NOTCH_TAB5_Pos (0UL)              /*!< BPLC TONE_NOTCH_TAB5: TONE_NOTCH_TAB5 (Bit 0)         */
#define BPLC_TONE_NOTCH_TAB5_TONE_NOTCH_TAB5_Msk (0xffffffffUL)     /*!< BPLC TONE_NOTCH_TAB5: TONE_NOTCH_TAB5 (Bitfield-Mask: 0xffffffff) */
/* ====================================================  TONE_NOTCH_TAB6  ==================================================== */
#define BPLC_TONE_NOTCH_TAB6_TONE_NOTCH_TAB6_Pos (0UL)              /*!< BPLC TONE_NOTCH_TAB6: TONE_NOTCH_TAB6 (Bit 0)         */
#define BPLC_TONE_NOTCH_TAB6_TONE_NOTCH_TAB6_Msk (0xffffffffUL)     /*!< BPLC TONE_NOTCH_TAB6: TONE_NOTCH_TAB6 (Bitfield-Mask: 0xffffffff) */
/* ====================================================  TONE_NOTCH_TAB7  ==================================================== */
#define BPLC_TONE_NOTCH_TAB7_TONE_NOTCH_TAB7_Pos (0UL)              /*!< BPLC TONE_NOTCH_TAB7: TONE_NOTCH_TAB7 (Bit 0)         */
#define BPLC_TONE_NOTCH_TAB7_TONE_NOTCH_TAB7_Msk (0xffffffffUL)     /*!< BPLC TONE_NOTCH_TAB7: TONE_NOTCH_TAB7 (Bitfield-Mask: 0xffffffff) */
/* ====================================================  TONE_NOTCH_TAB8  ==================================================== */
#define BPLC_TONE_NOTCH_TAB8_TONE_NOTCH_TAB8_Pos (0UL)              /*!< BPLC TONE_NOTCH_TAB8: TONE_NOTCH_TAB8 (Bit 0)         */
#define BPLC_TONE_NOTCH_TAB8_TONE_NOTCH_TAB8_Msk (0xffffffffUL)     /*!< BPLC TONE_NOTCH_TAB8: TONE_NOTCH_TAB8 (Bitfield-Mask: 0xffffffff) */
/* ====================================================  TONE_NOTCH_TAB9  ==================================================== */
#define BPLC_TONE_NOTCH_TAB9_TONE_NOTCH_TAB9_Pos (0UL)              /*!< BPLC TONE_NOTCH_TAB9: TONE_NOTCH_TAB9 (Bit 0)         */
#define BPLC_TONE_NOTCH_TAB9_TONE_NOTCH_TAB9_Msk (0xffffffffUL)     /*!< BPLC TONE_NOTCH_TAB9: TONE_NOTCH_TAB9 (Bitfield-Mask: 0xffffffff) */
/* ===================================================  TONE_NOTCH_TAB10  ==================================================== */
#define BPLC_TONE_NOTCH_TAB10_TONE_NOTCH_TAB10_Pos (0UL)            /*!< BPLC TONE_NOTCH_TAB10: TONE_NOTCH_TAB10 (Bit 0)       */
#define BPLC_TONE_NOTCH_TAB10_TONE_NOTCH_TAB10_Msk (0xffffffffUL)   /*!< BPLC TONE_NOTCH_TAB10: TONE_NOTCH_TAB10 (Bitfield-Mask: 0xffffffff) */
/* ===================================================  TONE_NOTCH_TAB11  ==================================================== */
#define BPLC_TONE_NOTCH_TAB11_TONE_NOTCH_TAB11_Pos (0UL)            /*!< BPLC TONE_NOTCH_TAB11: TONE_NOTCH_TAB11 (Bit 0)       */
#define BPLC_TONE_NOTCH_TAB11_TONE_NOTCH_TAB11_Msk (0xffffffffUL)   /*!< BPLC TONE_NOTCH_TAB11: TONE_NOTCH_TAB11 (Bitfield-Mask: 0xffffffff) */
/* ===================================================  TONE_NOTCH_TAB12  ==================================================== */
#define BPLC_TONE_NOTCH_TAB12_TONE_NOTCH_TAB12_Pos (0UL)            /*!< BPLC TONE_NOTCH_TAB12: TONE_NOTCH_TAB12 (Bit 0)       */
#define BPLC_TONE_NOTCH_TAB12_TONE_NOTCH_TAB12_Msk (0xffffffffUL)   /*!< BPLC TONE_NOTCH_TAB12: TONE_NOTCH_TAB12 (Bitfield-Mask: 0xffffffff) */
/* ===================================================  TONE_NOTCH_TAB13  ==================================================== */
#define BPLC_TONE_NOTCH_TAB13_TONE_NOTCH_TAB13_Pos (0UL)            /*!< BPLC TONE_NOTCH_TAB13: TONE_NOTCH_TAB13 (Bit 0)       */
#define BPLC_TONE_NOTCH_TAB13_TONE_NOTCH_TAB13_Msk (0xffffffffUL)   /*!< BPLC TONE_NOTCH_TAB13: TONE_NOTCH_TAB13 (Bitfield-Mask: 0xffffffff) */
/* ===================================================  TONE_NOTCH_TAB14  ==================================================== */
#define BPLC_TONE_NOTCH_TAB14_TONE_NOTCH_TAB14_Pos (0UL)            /*!< BPLC TONE_NOTCH_TAB14: TONE_NOTCH_TAB14 (Bit 0)       */
#define BPLC_TONE_NOTCH_TAB14_TONE_NOTCH_TAB14_Msk (0xffffffffUL)   /*!< BPLC TONE_NOTCH_TAB14: TONE_NOTCH_TAB14 (Bitfield-Mask: 0xffffffff) */
/* ===================================================  TONE_NOTCH_TAB15  ==================================================== */
#define BPLC_TONE_NOTCH_TAB15_TONE_NOTCH_TAB15_Pos (0UL)            /*!< BPLC TONE_NOTCH_TAB15: TONE_NOTCH_TAB15 (Bit 0)       */
#define BPLC_TONE_NOTCH_TAB15_TONE_NOTCH_TAB15_Msk (0xffffffffUL)   /*!< BPLC TONE_NOTCH_TAB15: TONE_NOTCH_TAB15 (Bitfield-Mask: 0xffffffff) */
/* ========================================================  CUR_SFO  ======================================================== */
#define BPLC_CUR_SFO_CUR_SFO_Pos          (0UL)                     /*!< BPLC CUR_SFO: CUR_SFO (Bit 0)                         */
#define BPLC_CUR_SFO_CUR_SFO_Msk          (0xffffUL)                /*!< BPLC CUR_SFO: CUR_SFO (Bitfield-Mask: 0xffff)         */
...
#define CPM_BATVDCFGR_BatVolToggleDis_Pos (16UL)                    /*!< CPM BATVDCFGR: BatVolToggleDis (Bit 16)               */
#define CPM_BATVDCFGR_BatVolToggleDis_Msk (0x10000UL)               /*!< CPM BATVDCFGR: BatVolToggleDis (Bitfield-Mask: 0x01)  */
...
#define CPM_PINVDCFGR_PinVolDetLValue_Msk (0x1fUL)                  /*!< CPM PINVDCFGR: PinVolDetLValue (Bitfield-Mask: 0x1f)  */
#define CPM_PINVDCFGR_PinVolDetHValue_Pos (8UL)                     /*!< CPM PINVDCFGR: PinVolDetHValue (Bit 8)                */
#define CPM_PINVDCFGR_PinVolDetHValue_Msk (0x1f00UL)                /*!< CPM PINVDCFGR: PinVolDetHValue (Bitfield-Mask: 0x1f)  */
#define CPM_PINVDCFGR_LVD_CLK_DIV_Pos     (16UL)                    /*!< CPM PINVDCFGR: LVD_CLK_DIV     (Bit 16)               */
#define CPM_PINVDCFGR_LVD_CLK_DIV_Msk     (0x00ff0000UL)            /*!< CPM PINVDCFGR: LVD_CLK_DIV     (Bitfield-Mask: 0xff)  */
...
#define CPM_PINVDCFGR_PinVolToggleDis_Pos (28UL)                    /*!< CPM PINVDCFGR: PinVolToggleDis (Bit 28)               */
#define CPM_PINVDCFGR_PinVolToggleDis_Msk (0x10000000UL)            /*!< CPM PINVDCFGR: PinVolToggleDis (Bitfield-Mask: 0x01)  */

...
extern const u16 HRF_PB_SIZE_ARRAY[6];
...
void HRF_SetReceiveCallback(Hrf_ReceiveCallback cb_recv, PhrCallback cb_fch, RxOverFlowCallback cb_overflow);
...
u16 HRFrameLen(u8 phr,int psdu,u8 option);
//获取当前的NTB值
